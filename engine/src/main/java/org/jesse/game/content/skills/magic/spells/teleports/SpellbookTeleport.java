...
import org.jesse.game.content.skills.magic.spells.TeleportSpell;
...
public enum SpellbookTeleport implements TeleportSpell, Teleport {
	...
	public void execute(final Player player, final int optionId, final String option) {
		...
		if (structId != -1) {
			final org.jesse.game.model.ui.testinterfaces.advancedsettings.Setting setting = org.jesse.game.model.ui.testinterfaces.advancedsettings.Settings.findSettingByStructId(structId);
			if (optionId == 10) {
