...
import org.jesse.game.content.boss.abyssalsire.WeakReferenceHelper.exists
import org.jesse.game.content.boss.abyssalsire.WeakReferenceHelper.invoke
import org.jesse.game.content.boss.abyssalsire.poisonfumes.AbyssalSirePoisonFumes
import org.jesse.game.content.boss.abyssalsire.respiratorysystems.AbyssalSireRespiratorySystems
import org.jesse.game.content.boss.abyssalsire.spawns.AbyssalSireSpawns
import org.jesse.game.content.boss.abyssalsire.tentacles.AbyssalSireTentacleWalls
import org.jesse.game.content.boss.abyssalsire.tentacles.AbyssalSireTentacles
...
internal class AbyssalSire(
    ...
    override fun processNPC() {
        ...
        when (phase) {
            ...
            AbyssalSirePhase.AWAKE -> {
                ...
                if (hitpoints < maxHitpoints && WorldThread.getCurrentCycle() % 5 == 0L) {
    ...
    private fun explodeTeleport(player: Player) {
        ...
        val teleport: Teleport = object : Teleport {
            ...
            override fun destination(): Location {
                return destination
            }
