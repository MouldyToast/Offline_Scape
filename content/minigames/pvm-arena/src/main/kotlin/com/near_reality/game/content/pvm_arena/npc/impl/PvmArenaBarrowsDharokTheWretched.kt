...
import com.zenyte.game.content.minigame.barrows.wights.DharokTheWretched
...
/**
 * Represents the Dharok the Wretched npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaBarrowsDharokTheWretched(override val config: PvmArenaNpc.SpawnConfig):
    DharokTheWretched(DHAROK_THE_WRETCHED, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaNpc
{
    init {
