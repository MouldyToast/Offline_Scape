...
public final class FlowerPokerManager {
    ...
    public static FlowerPokerAreas getAvailableArea() {
    ...
    public void request(Player o) {
        ...
        if (player.getBankPin().requiresVerification(player, () -> request(player))) return;
...
//        }
    ...
    public void openFPScreen() {
        ...
        // If the account has a PIN & Required unlocking; STOP HERE
        if (player.getBankPin().requiresVerification(player, this::openFPScreen)) return;
        inInterface = true;
    ...
    public void accept(final int stage) {
        ...
        // If the account has a PIN & Required unlocking; STOP HERE
        if (player.getBankPin().requiresVerification(player, () -> accept(stage))) return;
    ...
    public void closeStake(final FlowerPokerStatus stage) {
        ...
        if (!started && !stage.equals(FlowerPokerStatus.SUCCESS)) {
            ...
            FlowerPokerAreas availableArea = getAvailableArea();
...
//            }
    ...
    public void startGame() {
        ...
        // If the account has a PIN & Required unlocking; STOP HERE
        if (player.getBankPin().requiresVerification(player, this::startGame)) return;
