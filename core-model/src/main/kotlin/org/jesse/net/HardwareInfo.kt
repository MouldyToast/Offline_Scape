...
data class HardwareInfo(
    ...
    /**
     * Computes a unique hash code based on the hardware specifications of the system.
     *
     * This method combines values from various hardware-related properties,
     * such as CPU features, operating system ID, logical processors, physical memory,
     * graphic card details, and other factors, to generate a hash that uniquely identifies
     * the hardware configuration.
     *
     * @return An integer representing the computed hash of the hardware configuration.
     */
    fun getHardwareHash(): Int {
        var result = cpuFeatures.contentHashCode()
            result = 31 * result + osId
            result = 31 * result + logicalProcessors
            result = 31 * result + physicalMemory
