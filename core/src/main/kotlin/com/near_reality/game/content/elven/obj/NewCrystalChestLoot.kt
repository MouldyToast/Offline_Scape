...
enum class NewCrystalChestLoot(
    ...
    WRATH_RUNES(LootRarity.COMMON, min = 50, max = 100, loot = arrayOf(Item(ItemId.WRATH_RUNE))),
    RUNE_KNIVES(LootRarity.COMMON, min = 100, max = 150, loot = arrayOf(Item(ItemId.RUNE_KNIFE))),
    RUNE_ARROWS(LootRarity.COMMON, min = 100, max = 150, loot = arrayOf(Item(ItemId.RUNE_ARROW))),
    ...
    COOKED_KARAMBWAN(LootRarity.COMMON, min = 75, max = 100, loot = arrayOf(Item(ItemId.COOKED_KARAMBWAN).toNote())),
    SWORDFISH(LootRarity.COMMON, min = 50, max = 75, loot = arrayOf(Item(ItemId.SWORDFISH).toNote())),
    MONKFISH(LootRarity.COMMON, min= 30, max = 50, loot = arrayOf(Item(ItemId.MONKFISH).toNote())),
    SHARK(LootRarity.COMMON, min = 20, max = 40, loot = arrayOf(Item(ItemId.SHARK).toNote())),

    IRON_ORE(LootRarity.COMMON, min = 50, max = 100, loot = arrayOf(Item(ItemId.IRON_ORE).toNote())),
    COAL(LootRarity.COMMON, min = 100, max = 200, loot = arrayOf(Item(ItemId.COAL).toNote())),

    BABY_DRAGON_BONES(LootRarity.COMMON, min = 50, max = 75, loot = arrayOf(Item(ItemId.BABYDRAGON_BONES).toNote())),
    BIG_BONES(LootRarity.COMMON, min = 100, max = 150, loot = arrayOf(Item(ItemId.BIG_BONES).toNote())),

    BRONZE_BARS(LootRarity.COMMON, min = 50, max = 100, loot = arrayOf(Item(ItemId.BRONZE_BAR).toNote())),
    ...
    MITHRIL_BARS(LootRarity.COMMON, min = 25, max = 70, loot = arrayOf(Item(ItemId.MITHRIL_BAR).toNote())),
    ADAMANT_BARS(LootRarity.COMMON, min = 25, max = 50, loot = arrayOf(Item(ItemId.ADAMANTITE_BAR).toNote())),
    RUNITE_BARS(LootRarity.COMMON, min = 15, max = 30, loot = arrayOf(Item(ItemId.RUNITE_BAR).toNote())),

    SARA_BREWS(LootRarity.RARE, min = 10, max = 20, loot = arrayOf(Item(ItemId.SARADOMIN_BREW4).toNote())),
    SUPER_RESTORES(LootRarity.RARE, min = 10, max = 20, loot = arrayOf(Item(ItemId.SUPER_RESTORE4).toNote())),
    SANFEW(LootRarity.RARE, min = 10, max = 20, loot = arrayOf(Item(ItemId.SANFEW_SERUM4).toNote())),

    DRAGON_BONES(LootRarity.RARE, min = 50, max = 75, loot = arrayOf(Item(ItemId.DRAGON_BONES).toNote())),
    ...
    AMMY_OF_FURY(LootRarity.SUPER_RARE, Item(ItemId.AMULET_OF_FURY)),
    DIAMOND_BOLTS_E(LootRarity.SUPER_RARE, Item(ItemId.DIAMOND_BOLTS_E), min = 20, max = 50),
    RUBY_BOLTS_E(LootRarity.SUPER_RARE, Item(ItemId.RUBY_BOLTS_E), min = 20, max = 50),

    CRYSTAL_SHARDS(LootRarity.ALWAYS, Item(ItemId.CRYSTAL_SHARD), min = 3, max = 5, enhancedOnly = true),
    CRYSTAL_SHARDS_MORE(LootRarity.COMMON, Item(ItemId.CRYSTAL_SHARD), min = 10, max = 30, enhancedOnly = true),

    DRAGONSTONE_BOLTS_E(LootRarity.SUPER_RARE, Item(ItemId.DRAGONSTONE_BOLTS_E), min = 20, max = 50, enhancedOnly = true),

    DRAGONSTONE_HELM(LootRarity.SUPER_RARE, Item(ItemId.DRAGONSTONE_FULL_HELM), enhancedOnly = true),
    DRAGONSTONE_PLATE(LootRarity.SUPER_RARE, Item(ItemId.DRAGONSTONE_PLATEBODY), enhancedOnly = true),
    DRAGONSTONE_LEGS(LootRarity.SUPER_RARE, Item(ItemId.DRAGONSTONE_PLATELEGS), enhancedOnly = true),
    DRAGONSTONE_BOOTS(LootRarity.SUPER_RARE, Item(ItemId.DRAGONSTONE_BOOTS), enhancedOnly = true),
    DRAGONSTONE_GLOVES(LootRarity.SUPER_RARE, Item(ItemId.DRAGONSTONE_GAUNTLETS), enhancedOnly = true),
