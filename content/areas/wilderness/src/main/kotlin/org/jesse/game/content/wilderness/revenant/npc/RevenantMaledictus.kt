    ...
    CombatScript
{
        ...
        sortedDamageDealerMap.forEachIndexed { index, (damager, _) ->
            ...
            if (index < 3) {
                if (damager.equipment?.getId(EquipmentSlot.AMULET) == AMULET_OF_AVARICE) {
                    org.jesse.game.content.wilderness.revenant.ForinthrySurge.activate(damager)
                }
            }
    ...
    companion object {
        ...
        private val logger = NearRealityLogger.getLogger(RevenantMaledictus::class.java)
        ...
        fun spawn() {
            ...
            val dungeon = GlobalAreaManager.getArea(org.jesse.game.content.wilderness.revenant.area.ForinthryDungeon::class.java)
