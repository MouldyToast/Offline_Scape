...
import org.jesse.scripts.npc.drops.table.DropTables
...
data class NPCDropsContext(
    ...
    fun rollStaticDukeTableAndDrop(player: Player, type: DropTableType, location: Location = npc.middleLocation offset Pair(0, -4)) =
        rollStaticTable(player, type).onEach { drop -> drop.rollAndDrop(npc, player, location) }
