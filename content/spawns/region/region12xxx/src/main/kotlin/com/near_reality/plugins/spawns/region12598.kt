...
class Region12598 : NPCSpawnsScript() {

    init {
        SARADOMINIST_RECRUITER(3141, 3472, 0, SOUTH, 0)
        ZAMORAKIAN_RECRUITER(3143, 3470, 0, SOUTH, 0)
        ...
        6708(3180, 3474, 0, SOUTH, 10)
        CLERK_10759(3181, 3471, 0, SOUTH, 0)
        ABIGAILA(3185, 3516, 0, SOUTH, 0)
        EMBLEM_TRADER(3163, 3504, 0, SOUTH, 0)
        PERDU(3166, 3504, 0, SOUTH, 0)

        6708(3193, 3489, 0, SOUTH, 10)
        RELOBO_BLINYO_LOGS(3152, 3489, 0, WEST, 0)
        BOB_BARTER_HERBS(3156, 3481, 0, EAST, 0)
        HOFUTHAND_WEAPONS_AND_ARMOUR(3156, 3498, 0, SOUTH, 0)
        BANKER_1633(3163, 3489, 0, WEST, 0)
        6528(3163, 3490, 0, WEST, 0)
        GRAND_EXCHANGE_CLERK_2149(3164, 3488, 0, SOUTH, 0)
        GRAND_EXCHANGE_CLERK(3165, 3488, 0, SOUTH, 0)
        BRUGSEN_BURSEN(3165, 3477, 0, NORTH, 0)
        GRAND_EXCHANGE_CLERK_2150(3165, 3491, 0, NORTH, 0)
