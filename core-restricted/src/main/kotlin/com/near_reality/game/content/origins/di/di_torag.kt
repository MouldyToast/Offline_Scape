...
class DiToragDroptable : NPCDropTableScript() {
    ...
    init {
        ...
        buildTable {
            Main(denominator = 512) {
                ...
                // the 12
                TORAGS_HELM quantity 1 rarity 2
                TORAGS_PLATEBODY quantity 1 rarity 2
                TORAGS_PLATELEGS quantity 1 rarity 2
                TORAGS_HAMMERS quantity 1 rarity 2
