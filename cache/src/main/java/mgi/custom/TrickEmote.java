...
public class TrickEmote {
    ...
    private void packAnimationBase(@NotNull final AnimationBase base, final int[] anims) throws IOException {
        for (int anim : anims) {
            ...
            final AnimationDefinitions definitions = new AnimationDefinitions(anim, new ByteBuffer(FileUtils.readFileToByteArray(file)), AnimationDefinitions.AnimFormat.PRE_OPCODE_CHANGE);
    ...
    public boolean equals(final Object o) {
        ...
        if (this$transformedModels == null ? other$transformedModels != null : !this$transformedModels.equals(other$transformedModels))
            return false;
        ...
        if (this$transformedAnimations == null ? other$transformedAnimations != null : !this$transformedAnimations.equals(other$transformedAnimations))
            return false;
