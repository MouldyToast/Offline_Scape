...
public enum PocketData {
    ...
    GNOME(75, 75, 198.5, CoinPouch.GNOME, false, 5, 1, 1, new String[]{"What do you think you're doing?"}, new ImmutableItem[]{
            new ImmutableItem(CoinPouch.GNOME.getItemId(), 1, 1, 105),
            new ImmutableItem(557, 1, 1, 8),
            new ImmutableItem(444, 1, 1, 6),
            new ImmutableItem(569, 1, 1, 5),
            new ImmutableItem(2150, 1, 1, 2),
            new ImmutableItem(2162, 1, 1, 2),
            new ImmutableItem(ClueItem.MEDIUM.getScrollBox(), 1, 1, 1)
    }, "Gnome", "Gnome woman"),
    ...
    private List<Item> generateLootItems(final ImmutableItem item, final boolean doubleLoot, final int baseMultiplier) {
        ...
        if (isPouch && doubleLoot) {
            ...
            rewards.add(new Item(ItemId.COINS_995, org.jesse.plugins.item.CoinPouch.getCoinAmount(pouch, 1)));
        }
        return rewards;
    }
