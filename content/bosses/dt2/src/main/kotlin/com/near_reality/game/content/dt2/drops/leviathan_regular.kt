...
import com.zenyte.game.item.ItemId.SCARRED_TABLET
...
class LeviathanRegularDroptable : NPCDropTableScript() {
    ...
    init {
        ...
        appendDrop(DisplayedDrop(ItemId.LILVIATHAN, 1, 1, 2000.00))
