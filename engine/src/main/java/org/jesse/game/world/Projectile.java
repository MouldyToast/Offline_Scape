...
public final class Projectile {
	...
	@JsonCreator
	public Projectile(
			@JsonProperty("graphicsId") final int graphicsId,
			@JsonProperty("startHeight") final int startHeight,
			@JsonProperty("endHeight") final int endHeight,
			@JsonProperty("delay") final int delay,
			@JsonProperty("angle") final int angle,
			@JsonProperty("duration") final int duration,
			@JsonProperty("distanceOffset") final int distanceOffset,
	...
	@NotNull
	public Projectile withGraphic(Graphics id) {
		return new Projectile(id.getId(), startHeight, endHeight, delay, angle, duration, distanceOffset, multiplier);
	}

    @NotNull
    public Projectile withGraphic(int id) {
        return new Projectile(id, startHeight, endHeight, delay, angle, duration, distanceOffset, multiplier);
    }
}
