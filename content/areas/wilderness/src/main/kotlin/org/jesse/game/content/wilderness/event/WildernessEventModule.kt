...
import org.jesse.game.content.wilderness.event.WildernessEventManager.State
import org.jesse.game.content.wilderness.event.WildernessEventManager.randomEventState
import org.jesse.game.content.wilderness.event.WildernessEventManager.scheduleEvent
import org.jesse.game.content.wilderness.event.WildernessEventManager.scheduleNextRandomEvent
import org.jesse.game.content.wilderness.event.WildernessEventManager.standaloneEventsWithState
import org.jesse.game.content.wilderness.event.WildernessEventManager.startEvent
...
import org.jesse.game.world.entity.player.dialogue.*
...
object WildernessEventModule {
    ...
    private fun registerCommands() {
        Command(PlayerPrivilege.PLAYER, arrayOf("wevent", "gano")) { player, _ ->
