...
import org.jesse.game.world.spawnFloorItem
...
internal abstract class TheatreRoom(
    ...
    fun start(player: Player) {
        ...
        started = true
        startTick = WorldThread.getCurrentCycle()
    ...
    open fun onComplete() {
        ...
        timeTook = WorldThread.getCurrentCycle() - startTick
    ...
    override fun sendDeath(player: Player, source: Entity?): Boolean {
        if(completed) {
            ...
            player.deathMechanics.checkHardcoreIronManDeath()
            return true
