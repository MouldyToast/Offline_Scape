...
public class SettingStructs {
    ...
    public static final int MAX_HIT_HITSPLATS_STRUCT_ID = 346;
    ...
    public static final int SHIFT_CLICK_TO_DROP_ITEMS_STRUCT_ID = 1104; // Was: 2772
    ...
    public static final int MAX_HIT_HITSPLATS_THRESHOLD_STRUCT_ID = 347;
    ...
    public static final int AMMO_PICKING_BEHAVIOUR_STRUCT_ID = 4447;
    public static final int RUNE_PICKING_BEHAVIOUR_STRUCT_ID = 4448;
