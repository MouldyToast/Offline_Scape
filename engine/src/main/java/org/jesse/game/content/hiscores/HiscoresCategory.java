package org.jesse.game.content.hiscores;
...
import static org.jesse.game.content.hiscores.HiscoresCategoryEntry.*;

public enum HiscoresCategory {
    SKILLING(10323, (player, value) -> !player.getPrivilege().inherits(PlayerPrivilege.ADMINISTRATOR) && value[0] >= 30L, OVERALL, ATTACK, STRENGTH, DEFENCE, HITPOINTS, RANGED, MAGIC, PRAYER, RUNECRAFTING, AGILITY, HERBLORE,
        THIEVING, CRAFTING, FLETCHING, SLAYER, MINING, SMITHING, FISHING, COOKING, FIREMAKING, WOODCUTTING, FARMING, HUNTER),
    BOSSES(10324, (player, value) -> !player.getPrivilege().inherits(PlayerPrivilege.ADMINISTRATOR) && value[0] >= 25L,
        ...
        CORPOREAL_BEAST, CRAZY_ARCHAEOLOGIST, DAGANNOTH_PRIME, DAGANNOTH_REX, DAGANNOTH_SUPREME, GANODERMIC_BEAST, GENERAL_GRAARDOR, GIANT_MOLE,
    ...
    RAIDS(10325, (player, value) -> !player.getPrivilege().inherits(PlayerPrivilege.ADMINISTRATOR) && value[0] >= 10L, CHAMBERS_OF_XERIC, CHAMBERS_OF_XERIC_CM),
    PVP(10326, (player, value) -> !player.getPrivilege().inherits(PlayerPrivilege.ADMINISTRATOR) && value[0] > 0L, WILDERNESS),
    ;
