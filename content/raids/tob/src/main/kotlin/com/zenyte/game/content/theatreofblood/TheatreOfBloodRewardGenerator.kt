...
internal object TheatreOfBloodRewardGenerator {
    ...
    private fun rollRewardsForContributingPlayers(
        ...
        for (player in contributingPlayers) {
            ...
            playerRewardsMap.add(player, listOf(Item(995, goldReward)))
        }
    }
...
/* after:  20% chance to hit, ~0.8% per point */
private val uniqueRollTableNormal = StandaloneDropTableBuilder {
    limit = 24
    static {
        AVERNIC_DEFENDER_HILT quantity 1 rarity 8
        GHRAZI_RAPIER quantity 1 rarity 3
        SANGUINESTI_STAFF_UNCHARGED quantity 1 rarity 3
        JUSTICIAR_FACEGUARD quantity 1 rarity 3
        JUSTICIAR_CHESTGUARD quantity 1 rarity 3
        JUSTICIAR_LEGGUARDS quantity 1 rarity 3
        SCYTHE_OF_VITUR_UNCHARGED quantity 1 rarity 1
    }
}.staticTable

/* before: 36% chance to hit, 0.58% per point, scythe effective 4% drop rate, too high */
/* after: 30% chance to hit, 4.76% per point, scythe effective 2% drop rate */
private val uniqueRollTableHard = StandaloneDropTableBuilder {
    limit = 21
    static {
        AVERNIC_DEFENDER_HILT quantity 1 rarity 3
        GHRAZI_RAPIER quantity 1 rarity 3
        SANGUINESTI_STAFF_UNCHARGED quantity 1 rarity 3
        JUSTICIAR_FACEGUARD quantity 1 rarity 3
        JUSTICIAR_CHESTGUARD quantity 1 rarity 3
        JUSTICIAR_LEGGUARDS quantity 1 rarity 3
        SCYTHE_OF_VITUR_UNCHARGED quantity 1 rarity 1
        HOLY_ORNAMENT_KIT quantity 1 rarity 1
        SANGUINE_ORNAMENT_KIT quantity 1 rarity 1
    }
}.staticTable
