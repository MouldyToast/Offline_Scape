...
private const val EMBLEM_RATE: Int = 275
private const val TOTEM_RATE: Int = 375
private const val STATUE_RATE: Int = 475
private const val MEDALLION_RATE: Int = 575
private const val EFFIGY_RATE: Int = 675
private const val RELIC_RATE: Int = 775
private const val CRYSTAL_RATE: Int = 250
private const val AMULET_RATE: Int = 925
...
class RevenantDemonProcessor : DropProcessor() {
    ...
    override fun ids(): IntArray {
        return intArrayOf(NpcId.REVENANT_DEMON)
    }
