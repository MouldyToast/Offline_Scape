...
import org.jesse.plugins.item.GemBag;
...
public class GemOnGemBagItemAction implements ItemOnItemAction {
    private static final int GEM_BAG_ID = org.jesse.game.model.item.containers.GemBag.GEM_BAG.getId();
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        ...
        final org.jesse.game.model.item.containers.GemBag bag = player.getGemBag();
