...
public class PatchyNPC extends NPCPlugin implements ItemOnNPCAction {
    ...
    private enum SewableClothing {
        ...
        WHITE_BANDANA_EYEPATCH(ItemId.RIGHT_EYE_PATCH, ItemId.PIRATE_BANDANA, ItemId.BANDANA_EYEPATCH_WHITE),
        RED_BANDANA_EYEPATCH(ItemId.RIGHT_EYE_PATCH, ItemId.PIRATE_BANDANA_7124, ItemId.BANDANA_EYEPATCH_RED),
        BLUE_BANDANA_EYEPATCH(ItemId.RIGHT_EYE_PATCH, ItemId.PIRATE_BANDANA_7130, ItemId.BANDANA_EYEPATCH_BLUE),
        BROWN_BANDANA_EYEPATCH(ItemId.RIGHT_EYE_PATCH, ItemId.PIRATE_BANDANA_7136, ItemId.BANDANA_EYEPATCH_BROWN),
