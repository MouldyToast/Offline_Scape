...
import com.zenyte.plugins.dialogue.followers.BabyMoleD;
import com.zenyte.plugins.dialogue.followers.BaronD;
import com.zenyte.plugins.dialogue.followers.ButchD;
import com.zenyte.plugins.dialogue.followers.CallistoCubD;
import com.zenyte.plugins.dialogue.followers.HellpuppyD;
import com.zenyte.plugins.dialogue.followers.IkkleHydraD;
import com.zenyte.plugins.dialogue.followers.JalNibRekD;
import com.zenyte.plugins.dialogue.followers.KalphitePrincessD;
import com.zenyte.plugins.dialogue.followers.LilBloatD;
import com.zenyte.plugins.dialogue.followers.LilMaidenD;
import com.zenyte.plugins.dialogue.followers.LilNyloD;
import com.zenyte.plugins.dialogue.followers.LilSotD;
import com.zenyte.plugins.dialogue.followers.LilViathanD;
import com.zenyte.plugins.dialogue.followers.LilXarpD;
import com.zenyte.plugins.dialogue.followers.LilZikD;
import com.zenyte.plugins.dialogue.followers.MidnightD;
import com.zenyte.plugins.dialogue.followers.MuphinD;
import com.zenyte.plugins.dialogue.followers.NexlingD;
import com.zenyte.plugins.dialogue.followers.NoonD;
import com.zenyte.plugins.dialogue.followers.OlmletD;
import com.zenyte.plugins.dialogue.followers.PetChaosElementalD;
import com.zenyte.plugins.dialogue.followers.PetDagannothPrimeD;
import com.zenyte.plugins.dialogue.followers.PetDagannothRexD;
import com.zenyte.plugins.dialogue.followers.PetDagannothSupremeD;
import com.zenyte.plugins.dialogue.followers.PetDarkCoreD;
import com.zenyte.plugins.dialogue.followers.PetGeneralGraardorD;
import com.zenyte.plugins.dialogue.followers.PetKrakenD;
import com.zenyte.plugins.dialogue.followers.PetKreeArraD;
import com.zenyte.plugins.dialogue.followers.PetKrilTsutsarothD;
import com.zenyte.plugins.dialogue.followers.PetPenanceQueenD;
import com.zenyte.plugins.dialogue.followers.PetSmokeDevilD;
import com.zenyte.plugins.dialogue.followers.PetSnakelingD;
import com.zenyte.plugins.dialogue.followers.PetZilyanaD;
import com.zenyte.plugins.dialogue.followers.PhoenixD;
import com.zenyte.plugins.dialogue.followers.PrinceBlackDragonD;
import com.zenyte.plugins.dialogue.followers.ScorpiasOffspringD;
import com.zenyte.plugins.dialogue.followers.SkotosD;
import com.zenyte.plugins.dialogue.followers.SmolHereditD;
import com.zenyte.plugins.dialogue.followers.TzRekJadD;
import com.zenyte.plugins.dialogue.followers.VenenatisSpiderlingD;
import com.zenyte.plugins.dialogue.followers.VetionD;
import com.zenyte.plugins.dialogue.followers.VorkiD;
import com.zenyte.plugins.dialogue.followers.WispD;
import com.zenyte.plugins.dialogue.followers.YoungllefD;
...
public enum BossPet implements Pet {
    ...
    LITTLE_PARASITE(ItemId.LITTLE_PARASITE, NpcId.LITTLE_PARASITE_8541),
    ...
    BARON(ItemId.BARON, 12155, 2500, BaronD.class,NpcId.DUKE_SUCELLUS),
    LILVIATHAN(ItemId.LILVIATHAN, NpcId.LILVIATHAN, LilViathanD.class),
    WISP(ItemId.WISP, NpcId.WISP, WispD.class),
    BUTCH(ItemId.BUTCH, NpcId.BUTCH, ButchD.class),
    ...
    LIL_ZIK(ItemId.LIL_ZIK, NpcId.LIL_ZIK_8337, 100, LilZikD.class),
    LIL_MAIDEN(ItemId.LIL_MAIDEN, NpcId.LIL_MAIDEN_10870, LilMaidenD.class),
    LIL_BLOAT(ItemId.LIL_BLOAT, NpcId.LIL_BLOAT_10871, LilBloatD.class),
    LIL_NYLO(ItemId.LIL_NYLO, NpcId.LIL_NYLO_10872, LilNyloD.class),
    LIL_SOT(ItemId.LIL_SOT, NpcId.LIL_SOT_10873, LilSotD.class),
    LIL_XARP(ItemId.LIL_XARP, NpcId.LIL_XARP_10874, LilXarpD.class),
    ...
    PET_JUNGLE_STRYKEWYRM(CustomItemId.PET_JUNGLE_STRYKEWYRM, NpcId.BABY_JUNGLE_STRYKEWYRM),
    PET_ICE_STRYKEWYRM(CustomItemId.PET_ICE_STRYKEWYRM, NpcId.BABY_ICE_STRYKEWYRM),
    PET_DESERT_STRYKEWYRM(CustomItemId.PET_DESERT_STRYKEWYRM, NpcId.BABY_DESERT_STRYKEWYRM),
    PET_SLASH_BASH(CustomItemId.PET_SLASH_BASH, NpcId.LIL_SLASH_BASH),
    PET_AGED_BARRELCHEST(CustomItemId.PET_BARRELCHEST, NpcId.BABY_AGED_BARRELCHEST),
    PET_POSTIE_PETE     (CustomItemId.PET_POSTIE_PETE,     NpcId.REMN_POSTIE_PETE),
    PET_IMP             (CustomItemId.PET_IMP,             NpcId.REMN_IMP),
    PET_TOUCAN          (CustomItemId.PET_TOUCAN,          NpcId.REMN_TOUCAN),
    PET_KING_PENGUIN    (CustomItemId.PET_KING_PENGUIN,    NpcId.REMN_KING_PENGUIN),
    PET_KKLIK           (CustomItemId.PET_KKLIK,           NpcId.REMN_KKLIK),
    PET_SHADOW_WARRIOR  (CustomItemId.PET_SHADOW_WARRIOR,  NpcId.REMN_SHADOW_WARRIOR),
    PET_SHADOW_ARCHER   (CustomItemId.PET_SHADOW_ARCHER,   NpcId.REMN_SHADOW_ARCHER),
    PET_SHADOW_WIZARD   (CustomItemId.PET_SHADOW_WIZARD,   NpcId.REMN_SHADOW_WIZARD),
    PET_HEALER_DEATH_SPAWN (CustomItemId.PET_HEALER_DEATH_SPAWN, NpcId.REMN_HEALER_DEATH_SPAWN),
    PET_HOLY_DEATH_SPAWN   (CustomItemId.PET_HOLY_DEATH_SPAWN,   NpcId.REMN_HOLY_DEATH_SPAWN),
    PET_SEREN           (CustomItemId.PET_SEREN,           NpcId.REMN_SEREN),
    PET_CORRUPT_BEAST   (CustomItemId.PET_CORRUPT_BEAST,   NpcId.REMN_CORRUPT_BEAST),
    PET_ROC             (CustomItemId.PET_ROC,             NpcId.REMN_ROC),
    PET_KRATOS          (CustomItemId.PET_KRATOS,          NpcId.REMN_KRATOS),
    PET_DARK_POSTIE_PETE   (CustomItemId.PET_DARK_POSTIE_PETE,   NpcId.REMN_DARK_POSTIE_PETE),
    PET_DARK_IMP           (CustomItemId.PET_DARK_IMP,           NpcId.REMN_DARK_IMP),
    PET_DARK_TOUCAN        (CustomItemId.PET_DARK_TOUCAN,        NpcId.REMN_DARK_TOUCAN),
    PET_DARK_KING_PENGUIN  (CustomItemId.PET_DARK_KING_PENGUIN,  NpcId.REMN_DARK_KING_PENGUIN),
    PET_DARK_KKLIK         (CustomItemId.PET_DARK_KKLIK,         NpcId.REMN_DARK_KKLIK),
    PET_DARK_SHADOW_WARRIOR(CustomItemId.PET_DARK_SHADOW_WARRIOR,NpcId.REMN_DARK_SHADOW_WARRIOR),
    PET_DARK_SHADOW_ARCHER (CustomItemId.PET_DARK_SHADOW_ARCHER, NpcId.REMN_DARK_SHADOW_ARCHER),
    PET_DARK_SHADOW_WIZARD (CustomItemId.PET_DARK_SHADOW_WIZARD, NpcId.REMN_DARK_SHADOW_WIZARD),
    PET_DARK_HEALER_DEATH_SPAWN (CustomItemId.PET_DARK_HEALER_DEATH_SPAWN, NpcId.REMN_DARK_HEALER_DEATH_SPAWN),
    PET_DARK_HOLY_DEATH_SPAWN   (CustomItemId.PET_DARK_HOLY_DEATH_SPAWN,   NpcId.REMN_DARK_HOLY_DEATH_SPAWN),
    PET_DARK_SEREN          (CustomItemId.PET_DARK_SEREN,          NpcId.REMN_DARK_SEREN),
    PET_DARK_CORRUPT_BEAST  (CustomItemId.PET_DARK_CORRUPT_BEAST,  NpcId.REMN_DARK_CORRUPT_BEAST),
    PET_DARK_ROC            (CustomItemId.PET_DARK_ROC,            NpcId.REMN_DARK_ROC),
    PET_DARK_KRATOS         (CustomItemId.PET_DARK_KRATOS,         NpcId.REMN_DARK_KRATOS),
    PET_CORRUPT_KRATOS      (CustomItemId.PET_FISSILE_KRATOS,      NpcId.REMN_FISSILE_KRATOS),
    PET_WILDY_IMP           (CustomItemId.PET_WILDY_IMP,           NpcId.LIL_WILDY_IMP),
    OFF_BALANCE_ELEMENTAL           (CustomItemId.OFF_BALANCE_ELEMENTAL,           NpcId.OFF_BALANCE_ELEMENTAL),
    BABY_WILD_MOLE(CustomItemId.PET_BABY_WILD_MOLE, NpcId.BABY_WILD_MOLE),
    ...
    static {
        ...
        //Araxxor
        metamorphosisMap.put(NpcId.NID_13683, NpcId.RAX_13684);
        metamorphosisMap.put(NpcId.RAX_13684, NpcId.NID_13683);

        // Theatre of Blood
        metamorphosisMap.put(NpcId.LIL_ZIK_8337, NpcId.LIL_MAIDEN_10870);
        metamorphosisMap.put(NpcId.LIL_MAIDEN_10870, NpcId.LIL_BLOAT_10871);
        metamorphosisMap.put(NpcId.LIL_BLOAT_10871, NpcId.LIL_NYLO_10872);
        metamorphosisMap.put(NpcId.LIL_NYLO_10872, NpcId.LIL_SOT_10873);
        metamorphosisMap.put(NpcId.LIL_SOT_10873, NpcId.LIL_XARP_10874);
        metamorphosisMap.put(NpcId.LIL_XARP_10874, NpcId.LIL_ZIK_8337);

        // The Nightmare
        metamorphosisMap.put(NpcId.LITTLE_NIGHTMARE_9399, NpcId.LITTLE_PARASITE_8541);
        metamorphosisMap.put(NpcId.LITTLE_PARASITE_8541, NpcId.LITTLE_NIGHTMARE_9399);
    }
    ...
    BossPet(final int itemId, final int petId, final Class<? extends Dialogue> dialogue) {
        this(itemId, petId, -1, dialogue, -1);
    }
