...
enum class NewCrystalChestLoot(
    ...
    COOKED_KARAMBWAN(LootRarity.COMMON, min = 75, max = 100, loot = arrayOf(Item(org.jesse.game.item.ids.COOKED_KARAMBWAN).toNote())),
    SWORDFISH(LootRarity.COMMON, min = 50, max = 75, loot = arrayOf(Item(org.jesse.game.item.ids.SWORDFISH).toNote())),
    MONKFISH(LootRarity.COMMON, min= 30, max = 50, loot = arrayOf(Item(org.jesse.game.item.ids.MONKFISH).toNote())),
    SHARK(LootRarity.COMMON, min = 20, max = 40, loot = arrayOf(Item(org.jesse.game.item.ids.SHARK).toNote())),

    IRON_ORE(LootRarity.COMMON, min = 50, max = 100, loot = arrayOf(Item(org.jesse.game.item.ids.IRON_ORE).toNote())),
    COAL(LootRarity.COMMON, min = 100, max = 200, loot = arrayOf(Item(org.jesse.game.item.ids.COAL).toNote())),

    BABY_DRAGON_BONES(LootRarity.COMMON, min = 50, max = 75, loot = arrayOf(Item(BABYDRAGON_BONES).toNote())),
    BIG_BONES(LootRarity.COMMON, min = 100, max = 150, loot = arrayOf(Item(org.jesse.game.item.ids.BIG_BONES).toNote())),
    ...
    DRAGON_BONES(LootRarity.RARE, min = 50, max = 75, loot = arrayOf(Item(org.jesse.game.item.ids.DRAGON_BONES).toNote())),

    DRAGON_SCIMITAR(LootRarity.RARE, Item(org.jesse.game.item.ids.DRAGON_SCIMITAR)),
    DRAGON_DAGGER(LootRarity.RARE, Item(org.jesse.game.item.ids.DRAGON_DAGGER)),
    ...
    RUBY_BOLTS_E(LootRarity.SUPER_RARE, Item(org.jesse.game.item.ids.RUBY_BOLTS_E), min = 20, max = 50),
    ...
    DRAGONSTONE_BOLTS_E(LootRarity.SUPER_RARE, Item(org.jesse.game.item.ids.DRAGONSTONE_BOLTS_E), min = 20, max = 50, enhancedOnly = true),
    ...
    DRAGONSTONE_BOOTS(LootRarity.SUPER_RARE, Item(org.jesse.game.item.ids.DRAGONSTONE_BOOTS), enhancedOnly = true),
    DRAGONSTONE_GLOVES(LootRarity.SUPER_RARE, Item(DRAGONSTONE_GAUNTLETS), enhancedOnly = true),

    ONYX(LootRarity.JACKPOT, Item(org.jesse.game.item.ids.ONYX), enhancedOnly = true)
    ;
