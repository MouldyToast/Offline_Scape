...
public abstract class Interface implements Plugin {
    ...
    public static final Logger logger = NearRealityLogger.getLogger(Interface.class);

    /**
     * A map of <Int, String> containing bitpacked componentId & slot combinations, attached to our defined names for
     * the components.
     */
    public final Int2ObjectMap<String> components = new Int2ObjectOpenHashMap<>();
    /**
     * A map of <Int, Handler> containing bitpacked componentId & slot combinations, attached to our defined handlers
     * for the components.
     */
    public final Int2ObjectMap<Handler> handlers = new Int2ObjectOpenHashMap<>();
    /**
     ...
     */
    public final DefaultClickHandler defaultClickHandler = getDefaultHandler();
     ...
     */
    public ObjectSet<String> getReverseKeyset() {
     ...
     */
    public Interface bind(final String name, final Handler handler) {
     ...
     * @return this object, to permit chaining.
     */
    public Interface bind(final String name, final BasicHandler handler) {
        final int id = getComponentBitpacked(name);
        handlers.put(id, handler);
        return this;
    }
     ...
     */
    public void put(final int componentId, final String name) {
    ...
    public String getOptionString(final int componentId, final int optionId) {
