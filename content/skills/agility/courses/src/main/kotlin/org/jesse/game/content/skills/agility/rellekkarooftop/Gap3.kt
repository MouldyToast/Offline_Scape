...
import org.jesse.game.obj.ids.GAP_14991
...
class Gap3 : AgilityCourseObstacle(RellekkaRooftopCourse::class.java, 5) {
    override fun getLevel(`object`: WorldObject?): Int {
        return 80
    }

    override fun getObjectIds(): IntArray {
        return intArrayOf(GAP_14991)
    }
    ...
    companion object {
        ...
        private val LOCATION1 = Location(2643, 3656, 3)
