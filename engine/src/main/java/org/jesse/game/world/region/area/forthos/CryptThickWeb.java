...
import org.jesse.game.content.boss.sarachnis.SarachnisInstance;
        ...
        if (option.equalsIgnoreCase("Enter-crypt")) {
            player.getDialogueManager().start(new Dialogue(player) {
                ...
                public void buildDialogue() {
                    options("<col=FF0000>You are about to enter a dangerous area.<br><col=DDFF00>There is a fee to instance this battle.",
                        new DialogueOption("Pay 25K and enter.", () -> enter.accept(player)),
                        new DialogueOption("Do not enter."));
                }
            });
        }
        else if (option.equalsIgnoreCase("Quick-enter")) enter.accept(player);
    }
