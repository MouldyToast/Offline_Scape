...
import org.jesse.game.content.gauntlet.hunllef.Hunllef;
import org.jesse.game.content.gauntlet.hunllef.HunllefType;
import org.jesse.game.content.gauntlet.item.actions.GauntletCrystalTeleport;
import org.jesse.game.content.gauntlet.npc.GauntletMonsterType;
import org.jesse.game.content.gauntlet.npc.GauntletNPC;
    ...
    private void generateInventory(Player player, GauntletType type) {
        ...
        switch(type) {
            ...
            case STANDARD_NO_PREP: {
                ...
                tempInventory.addItem(new Item(CRYSTAL_BOW_PERFECTED, 1, DegradableItem.getDefaultCharges(CRYSTAL_BOW_PERFECTED, 0)));
            ...
            case CORRUPTED_NO_PREP: {
                ...
                tempInventory.addItem(new Item(CORRUPTED_BOW_PERFECTED, 1, DegradableItem.getDefaultCharges(CORRUPTED_BOW_PERFECTED, 0)));
