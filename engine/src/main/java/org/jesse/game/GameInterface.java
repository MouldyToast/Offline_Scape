...
import static org.jesse.game.model.ui.InterfacePosition.*;
...
public enum GameInterface {
    ...
    PHANTOM_MUSPAH_SCOREBOARD(817),
    DUKE_SCOREBOARD(828),
    DUKE_GAZE(829, OVERLAY),
    WHISPERER_SCOREBOARD(830),
    LEVIATHAN_SCOREBOARD(831),
    VARDORVIS_SCOREBOARD(832),
    ENTANGLED_PUZZLE(833, OVERLAY),
    ...
    RAID_HELPER_OVERLAY(710, OVERLAY),
    ...
    MINIMIZED_ORBS(895, InterfacePosition.ORBS),
    ...
    WHISPERER_SANITY(834, UNKNOWN_OVERLAY),

    COLOSSEUM_SCOREBOARD(867),
    COLOSSEUM_REWARDS(246),
    COLOSSEUM_INTERMISSION(865),
    DIZANAS_QUIVER(592, SINGLE_TAB),

    ;

    @java.lang.SuppressWarnings("all")
    private static final Logger log = NearRealityLogger.getLogger(GameInterface.class);
