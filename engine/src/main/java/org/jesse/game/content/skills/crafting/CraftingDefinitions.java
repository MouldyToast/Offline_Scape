package org.jesse.game.content.skills.crafting;
...
public class CraftingDefinitions {
    ...
    public enum AmuletStringingData {
        UNSTRUNG_SYMBOL(new Item(1718), new Item(1714), BALL_OF_WOOL),
        UNSTRUNG_EMBLEM(new Item(ItemId.UNPOWERED_SYMBOL), new Item(ItemId.UNSTRUNG_EMBLEM), BALL_OF_WOOL),
        GOLD_AMULET(new Item(1692), new Item(1673), BALL_OF_WOOL),
        SAPPHIRE_AMULET(new Item(1694), new Item(1675), BALL_OF_WOOL),
        PRE_NATURE_AMULET(new Item(6041), new Item(1677), MAGIC_STRING),
        EMERALD_AMULET(new Item(1696), new Item(1677), BALL_OF_WOOL),
        RUBY_AMULET(new Item(1698), new Item(1679), BALL_OF_WOOL),
        DIAMOND_AMULET(new Item(1700), new Item(1681), BALL_OF_WOOL),
        DRAGONSTONE_AMULET(new Item(1702), new Item(1683), BALL_OF_WOOL),
        ONYX_AMULET(new Item(6581), new Item(6579), BALL_OF_WOOL),
        ZENYTE_AMULET(new Item(19541), new Item(19501), BALL_OF_WOOL),
        OPAL_AMULET(new Item(21108), new Item(21099), BALL_OF_WOOL),
        JADE_AMULET(new Item(21111), new Item(21102), BALL_OF_WOOL),
        TOPAZ_AMULET(new Item(21114), new Item(21105), BALL_OF_WOOL);
    ...
    public enum BattlestaffAttachingData {
        WATER_BATTLESTAFF(54, 100, new Graphics(1370), new Item(1395), new Item(571), BATTLESTAFF),
        EARTH_BATTLESTAFF(58, 112.5, new Graphics(1371), new Item(1399), new Item(575), BATTLESTAFF),
        FIRE_BATTLESTAFF(62, 125, new Graphics(1372), new Item(1393), new Item(569), BATTLESTAFF),
        AIR_BATTLESTAFF(66, 137.5, new Graphics(306), new Item(1397), new Item(573), BATTLESTAFF);
        private final Item product;
        private final Item[] materials;
    ...
    public enum GlassBlowingData {
        BEER_GLASS(1, 17.5, new Item(1919), MOLTEN_GLASS),
        CANDLE_LANTERN(4, 19, new Item(4527), MOLTEN_GLASS),
        OIL_LAMP(12, 25, new Item(4525), MOLTEN_GLASS),
        VIAL(33, 35, new Item(229), MOLTEN_GLASS),
        FISHBOWL(42, 42.5, new Item(6667), MOLTEN_GLASS),
        UNPOWERED_ORB(46, 52.5, new Item(567), MOLTEN_GLASS),
        LANTERN_LENS(49, 55, new Item(4542), MOLTEN_GLASS),
        EMPTY_LIGHT_ORB(87, 70, new Item(10980), MOLTEN_GLASS);
        private final Item product;
        private final Item material;
        private final int level;
        private final double xp;
    ...
    public enum PotteryFiringData {
        POT(1, 6.3, new Item(1931), new Item(1787)),
        PIE_DISH(7, 10, new Item(2313), new Item(1789)),
        BOWL(8, 15, new Item(1923), new Item(1791)),
        EMPTY_PLANT_POT(19, 17.5, new Item(5350), new Item(5352)),
        POT_LID(25, 37.5, new Item(4440), new Item(4438));
        private final Item product;
        private final Item material;
        private final int level;
        private final double xp;
    ...
    public enum PotteryShapingData {
        POT(1, 6.3, new Item(1787)),
        PIE_DISH(7, 15, new Item(1789)),
        BOWL(8, 18, new Item(1791)),
        EMPTY_PLANT_POT(19, 20, new Item(5352)),
        POT_LID(25, 40, new Item(4438));
        private final Item product;
        private final int level;
        private final double xp;
    ...
    public enum SpinningData {
        WOOL(1, 2.5, new Item(1759), new Item(1737)),
        BOW_STRING(10, 15, new Item(1777), new Item(1779)),
        CROSSBOW_STRING(10, 15, new Item(9438), new Item(9436), new Item(6043), new Item(6045), new Item(6047), new Item(6049), new Item(6051)),
        MAGIC_STRING(19, 30, new Item(6038), new Item(6051)),
        ROPE(30, 25, new Item(954), new Item(10814));
    ...
    public enum Leather {
        SOFT_LEATHER(1, 1, new Item(1739), new Item(1741), 124, 132, 140, 148),
        HARD_LEATHER(3, 28, new Item(1739), new Item(1743), 125, 133, 141, 149),
        SNAKESKIN_1(15, 45, new Item(7801), new Item(6289), 126, 134, 142, 150),
        SNAKESKIN_2(15, 45, new Item(6287), new Item(6289), 127, 135, 143, 151),
        GREEN_DHIDE(20, 57, new Item(1753), new Item(1745), 128, 136, 144, 152),
        BLUE_DHIDE(20, 66, new Item(1751), new Item(2505), 129, 137, 145, 153),
        RED_DHIDE(20, 73, new Item(1749), new Item(2507), 130, 138, 146, 154),
        BLACK_DHIDE(20, 79, new Item(1747), new Item(2509), 131, 139, 147, 155);
    ...
    public enum WeavingData {
        BASKET(36, 56, new Item(5376), new Item(5933, 6), "willow branches"),
        EMPTY_SACK(21, 38, new Item(5418), new Item(5931, 4), "jute fibres"),
        DRIFT_NET(26, 55, new Item(21652), new Item(5931, 2), "jute fibres"),
        STRIP_OF_CLOTH(10, 12, new Item(3224), new Item(1759, 4), "balls of wool");
        private final Item product;
        private final Item material;
        private final int level;
        private final double xp;
