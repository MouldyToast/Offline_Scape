...
final class Mimic extends NPC implements CombatScript {
    private static final Logger log = NearRealityLogger.getLogger(Mimic.class);
    ...
    private void iterateCollidingPlayers() {
        for (final Player player : instance.getPlayers()) {
            ...
            final boolean reset = lastTick != WorldThread.getCurrentCycle();
            ...
            temporaryAttributes.put("mimic last damage tick", WorldThread.getCurrentCycle() + 1);
