...
public final class ObjectDefinitions implements Definitions, Cloneable, TransmogrifiableType {
    ...
    int soundRelatedVar1;
    int soundRelatedVar2;
    ...
    public ObjectDefinitions(final int id) {
        this.id = id;
        setDefaults();
    }
    ...
    public ObjectDefinitions copy(int id) {
    ...
    public void decode(final ByteBuffer buffer, final int opcode) {
        decodeOpcode(this, buffer, opcode, false);
    }
    ...
    public ByteBuffer encode() {
        ...
        if (interactType == 0 && !projectileClip) {
            buffer.writeByte(17);
        }
        if (!projectileClip) {
            buffer.writeByte(18);
        ...
        if (ambientSoundId != -1) {
            ...
            buffer.writeByte(soundRelatedVar1);
            buffer.writeByte(soundRelatedVar2);
        }
        if (soundEffectIds != null && soundEffectIds.length != 0) {
            buffer.writeByte(79);
            buffer.writeShort(int5);
            buffer.writeShort(int6);
            buffer.writeByte(soundRelatedVar1);
            buffer.writeByte(soundRelatedVar2);
            buffer.writeByte(soundEffectIds.length);
            for (final int value : soundEffectIds) {
    ...
    public ObjectDefinitions(int id, String name, int varbit, int optionsInvisible, int[] models, int[] types, int[] transformedIds, int ambientSoundId, int varp, int supportItems, int[] soundEffectIds, int mapIconId, int sizeX, int interactType, boolean isRotated, int sizeY, boolean projectileClip, int anInt455, boolean nonFlatShading, int contouredGround, int int5, boolean modelClipped, int ambient, String[] options, int contrast, int int6, boolean isSolid, int animationId, int modelSizeX, int decorDisplacement, int modelSizeHeight, int modelSizeY, int[] modelColours, boolean clipped, short[] modelTexture, int mapSceneId, int[] replacementColours, int offsetX, short[] replacementTexture, int offsetHeight, int offsetY, boolean obstructsGround, int accessBlockFlag, int finalTransformation, Int2ObjectMap<Object> parameters) {
        this.id = id;
        this.name = name;
        this.varbit = varbit;
        ...
        this.soundRelatedVar1 = anInt455;
    ...
    public boolean isDeferAnimationStart() {
        return deferAnimationStart;
    }

    public void setDeferAnimationStart(boolean deferAnimationStart) {
        this.deferAnimationStart = deferAnimationStart;
    }
    ...
    public static class ObjectDefinitionsBuilder {
        ...
        public ObjectDefinitions.ObjectDefinitionsBuilder optionAt(final int index, final String option) {
    ...
    public ObjectDefinitions.ObjectDefinitionsBuilder toBuilder() {
        return new ObjectDefinitions.ObjectDefinitionsBuilder().id(this.id).name(this.name).varbit(this.varbit).optionsInvisible(this.optionsInvisible).models(this.models).types(this.types).transformedIds(this.transformedIds).ambientSoundId(this.ambientSoundId).varp(this.varp).supportItems(this.supportItems).anIntArray100(this.soundEffectIds).mapIconId(this.mapIconId).sizeX(this.sizeX).clipType(this.interactType).isRotated(this.isRotated).sizeY(this.sizeY).projectileClip(this.projectileClip).anInt455(this.soundRelatedVar1).nonFlatShading(this.nonFlatShading).contouredGround(this.contouredGround).anInt456(this.int5).modelClipped(this.modelClipped).ambient(this.ambient).options(this.options).contrast(this.contrast).anInt457(this.int6).hollow(this.isSolid).animationId(this.animationId).modelSizeX(this.modelSizeX).decorDisplacement(this.decorDisplacement).modelSizeHeight(this.modelSizeHeight).modelSizeY(this.modelSizeY).modelColours(this.modelColours).clipped(this.clipped).modelTexture(this.modelTexture).mapSceneId(this.mapSceneId).replacementColours(this.replacementColours).offsetX(this.offsetX).replacementTexture(this.replacementTexture).offsetHeight(this.offsetHeight).offsetY(this.offsetY).obstructsGround(this.obstructsGround).accessBlockFlag(this.accessBlockFlag).finalTransformation(this.finalTransformation).parameters(this.parameters);
    }

    @Override
    public String toString() {
        return "ObjectDefinitions(id=" + this.getId() + ", name=" + this.getName() + ", varbit=" + this.getVarbit() + ", optionsInvisible=" + this.getOptionsInvisible() + ", models=" + Arrays.toString(this.getModels()) + ", types=" + Arrays.toString(this.getTypes()) + ", transformedIds=" + Arrays.toString(this.getTransformedIds()) + ", ambientSoundId=" + this.getAmbientSoundId() + ", varp=" + this.getVarp() + ", supportItems=" + this.getSupportItems() + ", anIntArray100=" + Arrays.toString(this.getSoundEffectIds()) + ", mapIconId=" + this.getMapIconId() + ", sizeX=" + this.getSizeX() + ", clipType=" + this.getInteractType() + ", isRotated=" + this.isRotated() + ", sizeY=" + this.getSizeY() + ", projectileClip=" + this.isProjectileClip() + ", anInt455=" + this.getAnInt455() + ", nonFlatShading=" + this.isNonFlatShading() + ", contouredGround=" + this.getContouredGround() + ", anInt456=" + this.getInt5() + ", modelClipped=" + this.isModelClipped() + ", ambient=" + this.getAmbient() + ", options=" + Arrays.deepToString(this.getOptions()) + ", contrast=" + this.getContrast() + ", anInt457=" + this.getInt6() + ", hollow=" + this.isSolid() + ", animationId=" + this.getAnimationId() + ", modelSizeX=" + this.getModelSizeX() + ", decorDisplacement=" + this.getDecorDisplacement() + ", modelSizeHeight=" + this.getModelSizeHeight() + ", modelSizeY=" + this.getModelSizeY() + ", modelColours=" + Arrays.toString(this.getModelColours()) + ", clipped=" + this.isClipped() + ", modelTexture=" + Arrays.toString(this.getModelTexture()) + ", mapSceneId=" + this.getMapSceneId() + ", replacementColours=" + Arrays.toString(this.getReplacementColours()) + ", offsetX=" + this.getOffsetX() + ", replacementTexture=" + Arrays.toString(this.getReplacementTexture()) + ", offsetHeight=" + this.getOffsetHeight() + ", offsetY=" + this.getOffsetY() + ", obstructsGround=" + this.isObstructsGround() + ", accessBlockFlag=" + this.getAccessBlockFlag() + ", finalTransformation=" + this.getFinalTransformation() + ", parameters=" + this.getParameters() + ")";
    }
}
