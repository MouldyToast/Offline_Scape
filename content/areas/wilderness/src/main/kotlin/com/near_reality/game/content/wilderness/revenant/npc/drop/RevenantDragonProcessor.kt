...
private const val AMULET_RATE: Int = 750
private const val VIGGORAS_RATE: Int = 800
private const val CRAWS_RATE: Int = 800
private const val THAMMARONS_RATE: Int = 800
private const val PRIMAL_RATE: Int = 800

@Suppress("unused")
class RevenantDragonProcessor : DropProcessor() {
    ...
    override fun ids(): IntArray {
        return intArrayOf(NpcId.REVENANT_DRAGON)
    }
