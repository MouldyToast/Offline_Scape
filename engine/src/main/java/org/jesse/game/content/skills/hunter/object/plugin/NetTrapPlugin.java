...
import org.jesse.game.content.skills.hunter.actions.CheckPlacedTrap;
import org.jesse.game.content.skills.hunter.actions.CreateNetTrapAction;
import org.jesse.game.content.skills.hunter.actions.DismantlePlacedTrap;
import org.jesse.game.content.skills.hunter.node.*;
        ...
        case "Dismantle": 
            {
                ...
                final HunterTrap trap = HunterUtils.findTrap(type, pair.net(), null).orElseThrow(RuntimeException::new);
