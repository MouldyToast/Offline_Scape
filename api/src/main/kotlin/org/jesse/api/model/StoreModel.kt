...
import org.jesse.api.model.CreditPackageOrder.PaymentMethod
import org.jesse.api.model.CreditPackageOrder.Status
...
data class CreditPackageOrder(
    ...
    enum class PaymentMethod {
        ...
        COINBASE;
        companion object {
            @JvmStatic fun getValues() = entries.toTypedArray()
        }
    }
}
...
@Serializable
data class CreditStoreBundleItem(
    val bundle: Int,
    val itemId: Int,
    val amount: Int
)
