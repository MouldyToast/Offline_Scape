...
public class Mac extends NPCPlugin {
    ...
    private static final Item MAX_CAPE = new Item(ItemId.MAX_CAPE); // 13342

    private static final Item MAX_HOOD = new Item(ItemId.MAX_HOOD);
            ...
            public void handle(Player player, NPC npc) {
                ...
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        player("Hello.");
                        plain("The man glances at you and grunts something unintelligible.");
