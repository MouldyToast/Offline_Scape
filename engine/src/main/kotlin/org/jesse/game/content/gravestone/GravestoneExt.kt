...
package org.jesse.game.content.gravestone

import org.jesse.game.model.item.protectionValue
import org.jesse.game.GameInterface
import org.jesse.game.content.ItemRetrievalService
import org.jesse.game.content.skills.prayer.Prayer
import org.jesse.game.content.trouver.TrouverData
import org.jesse.game.format
...
object GravestoneExt {
    ...
    fun Player.calculateGravestoneItems(pvp: Boolean, bypassGravestone: Boolean = false): Pair<List<Item>, List<Item>> {
        ...
        var items = inventoryItems + equipmentItems
