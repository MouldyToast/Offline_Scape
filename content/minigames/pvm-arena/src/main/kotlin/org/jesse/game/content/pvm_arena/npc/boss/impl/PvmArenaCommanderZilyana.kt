...
import org.jesse.game.content.godwars.npcs.CommanderZilyana
...
/**
 * Represents the Commander Zilyana npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaCommanderZilyana(override val config: PvmArenaNpc.SpawnConfig) :
    CommanderZilyana(emptyArray<GodwarsBossMinion>(), COMMANDER_ZILYANA, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
