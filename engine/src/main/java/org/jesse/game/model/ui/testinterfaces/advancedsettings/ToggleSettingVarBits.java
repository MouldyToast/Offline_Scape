...
public enum ToggleSettingVarBits implements SettingStructResolvable {
    ...
    HITSPLAT_TINTING(HITSPLAT_TINTING_STRUCT_ID, HITSPLAT_TINTING_VARBIT_ID),
    MAX_HIT_HITSPLATS(MAX_HIT_HITSPLATS_STRUCT_ID, MAX_HIT_HITSPLATS_VARBIT_ID),
    SHOW_WIKI_ENTITY_LOOKUP(SHOW_WIKI_ENTITY_LOOKUP_STRUCT_ID, SHOW_WIKI_ENTITY_LOOKUP_VARBIT_ID),
    SHOW_DATA_ORBS(SHOW_DATA_ORBS_STRUCT_ID, SHOW_DATA_ORBS_VARBIT_ID),
    ...
    SCROLL_WHEEL_CAN_CHANGE_ZOOM_DISTANCE(SCROLL_WHEEL_CAN_CHANGE_ZOOM_DISTANCE_STRUCT_ID, SCROLL_WHEEL_CAN_CHANGE_ZOOM_DISTANCE_VARBIT_ID),
    HIDE_PRIVATE_CHAT_WHEN_THE_CHATBOX_IS_HIDDEN(HIDE_PRIVATE_CHAT_WHEN_THE_CHATBOX_IS_HIDDEN_STRUCT_ID, HIDE_PRIVATE_CHAT_WHEN_THE_CHATBOX_IS_HIDDEN_VARBIT_ID),
    ...
    FILTER_OUT_BOSS_KILLCOUNT_WITH_SPAMFILTER(FILTER_OUT_BOSS_KILLCOUNT_WITH_SPAMFILTER_STRUCT_ID, FILTER_OUT_BOSS_KILLCOUNT_WITH_SPAMFILTER_VARBIT_ID),
    DROP_ITEM_WARNING(DROP_ITEM_WARNING_STRUCT_ID, DROP_ITEM_WARNING_VARBIT_ID),
    CLICK_THROUGH_TRANSPARENT_CHATBOX(CLICK_THROUGH_TRANSPARENT_CHATBOX_STRUCT_ID, CLICK_THROUGH_TRANSPARENT_CHATBOX_VARBIT_ID),
    SHOW_THE_STORE_BUTTON_ON_MOBILE(SHOW_THE_STORE_BUTTON_ON_MOBILE_STRUCT_ID, SHOW_THE_STORE_BUTTON_ON_MOBILE_VARBIT_ID),
    SHOW_THE_STORE_BUTTON_ON_DESKTOP(SHOW_THE_STORE_BUTTON_ON_DESKTOP_STRUCT_ID, SHOW_THE_STORE_BUTTON_ON_DESKTOP_VARBIT_ID),
    MIDDLE_MOUSE_BUTTON_CONTROLS_THE_CAMERA(MIDDLE_MOUSE_BUTTON_CONTROLS_THE_CAMERA_STRUCT_ID, MIDDLE_MOUSE_BUTTON_CONTROLS_THE_CAMERA_VARBIT_ID),
    MOVE_FOLLOWER_OPTIONS_LOWER_DOWN(MOVE_FOLLOWER_OPTIONS_LOWER_DOWN_STRUCT_ID, MOVE_FOLLOWER_OPTIONS_LOWER_DOWN_VARBIT_ID),
    ...
    ESC_CLOSES_THE_CURRENT_INTERFACE(ESC_CLOSES_THE_CURRENT_INTERFACE_STRUCT_ID, ESC_CLOSES_THE_CURRENT_INTERFACE_VARBIT_ID, 1),
    ACCEPT_AID(ACCEPT_AID_STRUCT_ID, ACCEPT_AID_VARBIT_ID, 1),
    SHOW_WARNING_WHEN_CASTING_TELEPORT_TO_TARGET(SHOW_WARNING_WHEN_CASTING_TELEPORT_TO_TARGET_STRUCT_ID, SHOW_WARNING_WHEN_CASTING_TELEPORT_TO_TARGET_VARBIT_ID),
    SHOW_WARNING_WHEN_CASTING_DAREEYAK_TELEPORT(SHOW_WARNING_WHEN_CASTING_DAREEYAK_TELEPORT_STRUCT_ID, SHOW_WARNING_WHEN_CASTING_DAREEYAK_TELEPORT_VARBIT_ID),
    SHOW_WARNING_WHEN_CASTING_CARRALLANGAR_TELEPORT(SHOW_WARNING_WHEN_CASTING_CARRALLANGAR_TELEPORT_STRUCT_ID, SHOW_WARNING_WHEN_CASTING_CARRALLANGAR_TELEPORT_VARBIT_ID),
    SHOW_WARNING_WHEN_CASTING_ANNAKARL_TELEPORT(SHOW_WARNING_WHEN_CASTING_ANNAKARL_TELEPORT_STRUCT_ID, SHOW_WARNING_WHEN_CASTING_ANNAKARL_TELEPORT_VARBIT_ID),
    SHOW_WARNING_WHEN_CASTING_GHORROCK_TELEPORT(SHOW_WARNING_WHEN_CASTING_GHORROCK_TELEPORT_STRUCT_ID, SHOW_WARNING_WHEN_CASTING_GHORROCK_TELEPORT_VARBIT_ID),
    ...
    SHOW_WARNING_WHEN_USING_TABLET_ICE_PLATEAU(SHOW_WARNING_WHEN_USING_TABLET_ICE_PLATEAU_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_ICE_PLATEAU_VARBIT_ID),
    SHOW_WARNING_WHEN_USING_TABLET_CEMETERY(SHOW_WARNING_WHEN_USING_TABLET_CEMETERY_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_CEMETERY_VARBIT_ID),
    SHOW_WARNING_WHEN_USING_TABLET_WILDERNESS_CRABS(SHOW_WARNING_WHEN_USING_TABLET_WILDERNESS_CRABS_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_WILDERNESS_CRABS_VARBIT_ID),
    SHOW_WARNING_WHEN_USING_TABLET_DAREEYAK(SHOW_WARNING_WHEN_USING_TABLET_DAREEYAK_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_DAREEYAK_VARBIT_ID),
    SHOW_WARNING_WHEN_USING_TABLET_CARRALLANGAR(SHOW_WARNING_WHEN_USING_TABLET_CARRALLANGAR_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_CARRALLANGAR_VARBIT_ID),
    SHOW_WARNING_WHEN_USING_TABLET_ANNAKARL(SHOW_WARNING_WHEN_USING_TABLET_ANNAKARL_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_ANNAKARL_VARBIT_ID),
    SHOW_WARNING_WHEN_USING_TABLET_GHORROCK(SHOW_WARNING_WHEN_USING_TABLET_GHORROCK_STRUCT_ID, SHOW_WARNING_WHEN_USING_TABLET_GHORROCK_VARBIT_ID),
    ...
    FOOD_AND_POTIONS_CAN_FORM_SUPPLY_PILES_ON_DEATH(FOOD_AND_POTIONS_CAN_FORM_SUPPLY_PILES_ON_DEATH_STRUCT_ID, FOODPOTIONS_CAN_FORM_SUPPLY_PILES_ON_DEATH_VARBIT_ID),
    ...
    DATA_ORBS_REGENERATION_INDICATORS(DATA_ORBS_REGENERATION_INDICATORS_STRUCT_ID, DATA_ORBS_REGENERATION_INDICATORS_VARBIT_ID),
    ...
    FISHING_SPOT_INDICATORS_TOOLS_ONLY(FISHING_SPOT_INDICATORS_TOOLS_ONLY_STRUCT_ID, FISHING_SPOT_INDICATORS_TOOLS_ONLY_VARBIT_ID),
    FISHING_SPOT_INDICATORS_MOUSE_OVER_TOOLTIP(FISHING_SPOT_INDICATORS_MOUSE_OVER_TOOLTIP_STRUCT_ID, FISHING_SPOT_INDICATORS_MOUSE_OVER_TOOLTIP_VARBIT_ID),
    ...
    STAFF_OF_THE_DEAD_SPECIAL_DURATION(STAFF_OF_THE_DEAD_SPECIAL_DURATION_STRUCT_ID, STAFF_OF_THE_DEAD_SPECIAL_DURATION_VARBIT_ID),
    ...
    ANTIVENOM_AND_POISON_POTION_DURATIONS(ANTIVENOM_AND_POISON_POTION_DURATIONS_STRUCT_ID, ANTIVENOM_AND_POISON_POTION_DURATIONS_VARBIT_ID),
    ...
    SHOW_TOOLTIPS_FOR_MODIFIED_STAT_OVERLAYS(SHOW_TOOLTIPS_FOR_MODIFIED_STAT_OVERLAYS_STRUCT_ID, SHOW_TOOLTIPS_FOR_MODIFIED_STAT_OVERLAYS_VARBIT_ID),
    ...
    SHADOW_VEIL_ACTIVE_AND_DURATION(SHADOW_VEIL_ACTIVE_AND_DURATION_STRUCT_ID, SHADOW_VEIL_ACTIVE_AND_DURATION_VARBIT_ID),
    DEATH_CHARGE_ACTIVE_AND_DURATION(DEATH_CHARGE_ACTIVE_AND_DURATION_STRUCT_ID, DEATH_CHARGE_ACTIVE_AND_DURATION_VARBIT_ID),
    WARD_OF_ARCEUUS_ACTIVE_AND_DURATION(WARD_OF_ARCEUUS_ACTIVE_AND_DURATION_STRUCT_ID, WARD_OF_ARCEUUS_ACTIVE_AND_DURATION_VARBIT_ID),
    RESURRECTION_ACTIVE_AND_DURATION(RESURRECTION_ACTIVE_AND_DURATION_STRUCT_ID, RESURRECTION_ACTIVE_AND_DURATION_VARBIT_ID),
    COMBAT_ACHIEVEMENT_TASKS_FAILURE(COMBAT_ACHIEVEMENT_TASKS_FAILURE_STRUCT_ID, COMBAT_ACHIEVEMENT_TASKS_FAILURE_VARBIT_ID),
    COMBAT_ACHIEVEMENT_TASKS_COMPLETION_POPUP(COMBAT_ACHIEVEMENT_TASKS_COMPLETION_POPUP_STRUCT_ID, COMBAT_ACHIEVEMENT_TASKS_COMPLETION_POPUP_VARBIT_ID),
    COMBAT_ACHIEVEMENT_TASKS_REPEAT_COMPLETION(COMBAT_ACHIEVEMENT_TASKS_REPEAT_COMPLETION_STRUCT_ID, COMBAT_ACHIEVEMENT_TASKS_REPEAT_COMPLETION_VARBIT_ID),
    COMBAT_ACHIEVEMENT_TASKS_REPEAT_FAILURE(COMBAT_ACHIEVEMENT_TASKS_REPEAT_FAILURE_STRUCT_ID, COMBAT_ACHIEVEMENT_TASKS_REPEAT_FAILURE_VARBIT_ID),
    ...
    HIGHLIGHT_HOVERED_TILE_ALWAYS_ON_TOP(HIGHLIGHT_HOVERED_TILE_ALWAYS_ON_TOP_STRUCT_ID, HIGHLIGHT_HOVERED_TILE_ALWAYS_ON_TOP_VARBIT_ID),
    HIGHLIGHT_CURRENT_TILE_ALWAYS_ON_TOP(HIGHLIGHT_CURRENT_TILE_ALWAYS_ON_TOP_STRUCT_ID, HIGHLIGHT_CURRENT_TILE_ALWAYS_ON_TOP_VARBIT_ID),
    HIGHLIGHT_DESTINATION_TILE_ALWAYS_ON_TOP(HIGHLIGHT_DESTINATION_TILE_ALWAYS_ON_TOP_STRUCT_ID, HIGHLIGHT_DESTINATION_TILE_ALWAYS_ON_TOP_VARBIT_ID),
    ENABLE_MINIMAP_ZOOM(ENABLE_MINIMAP_ZOOM_STRUCT_ID, ENABLE_MINIMAP_ZOOM_VARBIT_ID),
    HIGHLIGHT_ENTITIES_ON_MOUSEOVER(HIGHLIGHT_ENTITIES_ON_MOUSEOVER_STRUCT_ID, HIGHLIGHT_ENTITIES_ON_MOUSEOVER_VARBIT_ID),
    HIGHLIGHT_AGILITY_SHORTCUTS_SHORTCUT_REQUIREMENTS(HIGHLIGHT_AGILITY_SHORTCUTS_SHORTCUT_REQUIREMENTS_STRUCT_ID, HIGHLIGHT_AGILITY_SHORTCUTS_SHORTCUT_REQUIREMENTS_VARBIT_ID),
    ...
    IRON_LOOT_RESTRICTION_INDICATOR(IRON_LOOT_RESTRICTION_INDICATOR_STRUCT_ID, IRON_LOOT_RESTRICTION_INDICATOR_VARBIT_ID),
    ...
    VIBRATE_WHEN_HOVERING_OVER_MINIMENU_ENTRIES(VIBRATE_WHEN_HOVERING_OVER_MINIMENU_ENTRIES_STRUCT_ID, VIBRATE_WHEN_HOVERING_OVER_MINIMENU_ENTRIES_VARBIT_ID),
    ...
    EXAMINE_PRICE_INFO_GRAND_EXCHANGE(EXAMINE_PRICE_INFO_GRAND_EXCHANGE_STRUCT_ID, EXAMINE_PRICE_INFO_GRAND_EXCHANGE_VARBIT_ID),
    ...
    SHOW_NUMBER_OF_OPTIONS_IN_MOUSEOVER_TOOLTIPS(SHOW_NUMBER_OF_OPTIONS_IN_MOUSEOVER_TOOLTIPS_STRUCT_ID, SHOW_NUMBER_OF_OPTIONS_IN_MOUSEOVER_TOOLTIPS_VARBIT_ID),
    DISABLE_QUEST_LIST_TEXT_SHADOWS(DISABLE_QUEST_LIST_TEXT_SHADOWS_STRUCT_ID, DISABLE_QUEST_LIST_TEXT_SHADOWS_VARBIT_ID),
    ...
    SHOW_ACTIVITY_ADVISER(SHOW_ACTIVITY_ADVISER_STRUCT_ID, SHOW_ACTIVITY_ADVISER_VARBIT_ID, 0),
    AMMO_PICKING_BEHAVIOUR(AMMO_PICKING_BEHAVIOUR_STRUCT_ID, AMMO_PICKING_BEHAVIOUR_VARBIT_ID, 1),
    RUNE_PICKING_BEHAVIOUR(RUNE_PICKING_BEHAVIOUR_STRUCT_ID, RUNE_PICKING_BEHAVIOUR_VARBIT_ID, 1),
    ;
