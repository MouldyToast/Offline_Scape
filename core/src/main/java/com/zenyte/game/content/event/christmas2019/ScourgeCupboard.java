...
public class ScourgeCupboard implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        ...
        switch (option) {
        case "Search": 
            if (player.getNumericTemporaryAttribute("Christmas scourge cupboard use delay").longValue() >= WorldThread.getCurrentCycle()) {
                return;
            }
        ...
        case "Open": 
            ...
            break;
        case "Close": 
            player.getTemporaryAttributes().put("Christmas scourge cupboard use delay", WorldThread.getCurrentCycle());
    ...
    private enum Cupboard {
        NORTH_WEST(46098, ChristmasConstants.NW_CUPBOARD_VAR) {
            ...
            public void search(final Player player) {
                ...
                player.getTemporaryAttributes().put("Christmas scourge cupboard use delay", WorldThread.getCurrentCycle() + 3);
