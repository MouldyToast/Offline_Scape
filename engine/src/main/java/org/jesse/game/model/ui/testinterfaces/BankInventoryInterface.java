...
import org.jesse.plugins.item.RunecraftingPouch;
import kotlin.Unit;
import mgi.utilities.CollectionUtils;

import static org.jesse.game.GameInterface.BANK_INVENTORY;
...
public class BankInventoryInterface extends Interface implements SwitchPlugin {
    ...
    protected void attach() {
        ...
        put(4, "Wear");
        put(6, "Empty Looting Bag");
        put(11, "Deposit Looting Bag Item");
    }
