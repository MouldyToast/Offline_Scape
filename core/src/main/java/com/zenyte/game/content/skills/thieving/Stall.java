...
public enum Stall {
	...
	// Home Thieving
	HOME_STALL_BAKER(COIN_STALL_BEGINNER, AFK_STALL_BAKER, 634),
	HOME_STALL_FUR(COIN_STALL_EASY, AFK_STALL_FUR, 634),
	HOME_STALL_SILVER(COIN_STALL_MEDIUM, AFK_STALL_SILVER, 634),
	HOME_STALL_MAGIC(COIN_STALL_HARD, AFK_STALL_MAGIC, 634),
	HOME_STALL_COIN(COIN_STALL_MASTER, AFK_STALL_COINS, 634),
	;
