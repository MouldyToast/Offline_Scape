...
import static org.jesse.game.model.ui.testinterfaces.advancedsettings.SettingsInterface.*;
...
public enum OtherVarBits {
    ...
    MAX_HIT_HITSPLATS_THRESHOLD(MAX_HIT_HITSPLATS_THRESHOLD_VARBIT_ID, 10),
