...
public class MinnowFishingSpot extends FishingSpot implements Spawnable {
    ...
    private static final Location[] westernPath = new Location[] {
        new Location(2612, 3443, 0),
        new Location(2611, 3443, 0),
        new Location(2610, 3443, 0),
        new Location(2609, 3443, 0),
        new Location(2609, 3444, 0),
        new Location(2610, 3444, 0),
        new Location(2611, 3444, 0),
        new Location(2612, 3444, 0)
    };
    private static final Location[] easternPath = new Location[] {
        new Location(2620, 3443, 0),
        new Location(2619, 3443, 0),
        new Location(2618, 3443, 0),
        new Location(2617, 3443, 0),
        new Location(2617, 3444, 0),
        new Location(2618, 3444, 0),
        new Location(2619, 3444, 0),
    ...
    public void processSpot() {
        if (!shark) {
            ...
            if (CharacterLoop.find(getLocation(), 1, Player.class, player -> !player.isDead() && player.getActionManager().getAction() instanceof Fishing).isEmpty()) {
                shark = false;
            }
        }
