...
public final class VorkathNPC extends NPC implements CombatScript {
    ...
    private static final Graphics acidProjectileSplashGfx = new Graphics(1472, 0, 124);
    private static final Projectile afterPoisonProjectile = new Projectile(1482, 100, 100, 0, 15, 0, 0, 3);
    private static final Graphics afterPoisonProjectileGfx = new Graphics(131, 0, 124);
    ...
    private static final Graphics dragonfireSplashGfx = new Graphics(157, 0, 124);
    ...
    private static final Graphics magicProjectileSplashGfx = new Graphics(1480, 0, 124);
    ...
    private static final Graphics pinkDragonfireProjectileSplashGfx = new Graphics(1473, 0, 124);
    ...
    private static final Graphics rangedProjectileSplashGfx = new Graphics(1478, 0, 124);
