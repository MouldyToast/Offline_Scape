...
public enum PerkWrapper {
    ...
    MASTER_SLAYER(MasterSlayerPerk.class, 30006),
    SLEIGHT_OF_HAND(SleightOfHandPerk.class, 30007),
    FILL_THE_BANK(FillTheBankPerk.class, 30008),
    LUMBERJACK(LumberjackPerk.class, 30009),
    LEPRECHAUNS_FRIEND(LeprechaunsFriendPerk.class, 30010),
    AUBURYS_APPRENTICE(AuburysApprenticePerk.class, 30011),
    WRATH_OF_ZAROS(WrathOfZaros.class, 30012),
    RIDDLE_IN_THE_TUNNELS(RiddleInTunnels.class, 30013),
    FERTILIZER(Fertilizer.class, 30014),
    BACKFIRE(Backfire.class, 30015),
