...
import org.jesse.game.content.tombsofamascut.npc.CrondisCrocodile;
import org.jesse.game.content.tombsofamascut.npc.PalmOfResourcefulness;
...
public class CrondisPuzzleEncounter extends TOARaidArea implements CycleProcessPlugin {
	...
	private final int CROCODILE_SPAWN_DELAY = 60;
	private int crocodileTicks = CROCODILE_SPAWN_DELAY;
	...
	@Override public void process() {
		if (EncounterStage.STARTED.equals(stage)) {
			...
			if (crocodileTicks-- <= 0) {
				crocodileTicks = CROCODILE_SPAWN_DELAY;
