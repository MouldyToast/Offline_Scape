...
object Cache2018Dump {
    ...
    private fun dumpEasterSh(cache2018: Cache, dumpPath: Path) {
        ...
        animationIdMap.forEach { (source, _) ->
            if (source <= 0)
                return@forEach
            ...
            val animDef = AnimationDefinitions(source, data, AnimationDefinitions.AnimFormat.PRE_OPCODE_CHANGE)
    ...
    private fun mapFrames(
        ...
        return ints?.map {
            ...
            if (frameData != null) {
                ...
                skeletonIdMap.getOrPut(frameMapId) { frameMapIdOnset++ }
