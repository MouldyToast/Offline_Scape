...
import com.zenyte.game.content.boss.wildernessbosses.spiders.venenatis.Venenatis
...
/**
 * Represents the Venenatis npc in the PvM Arena activity.
 *
 * TODO: override [Venenatis.MOVE_AREA], [Venenatis.MIDDLE], [Venenatis.WEB_AREA]
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaVenenatis(override val config: PvmArenaNpc.SpawnConfig) :
    Venenatis(VENENATIS_6610, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
