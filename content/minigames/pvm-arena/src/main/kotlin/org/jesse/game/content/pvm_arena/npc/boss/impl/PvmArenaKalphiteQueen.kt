...
/**
 * Represents the Kalphite queen npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaKalphiteQueen(override val config: PvmArenaNpc.SpawnConfig) :
    KalphiteQueen(KALPHITE_QUEEN_963, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
        hitBar = PvmArenaNpcHealthBar(this)
        setSinglePhaseOnly(true)
    }
