...
import org.jesse.game.obj.ids.TIGHTROPE_11406
import org.jesse.game.world.entity.Location
import org.jesse.game.world.entity.masks.RenderAnimation
import org.jesse.game.world.entity.player.Player
import org.jesse.game.world.`object`.WorldObject

class SecondTightRope : AgilityCourseObstacle(DraynorRooftopCourse::class.java, 3) {
    ...
    override fun getObjectIds(): IntArray {
        return intArrayOf(TIGHTROPE_11406)
    }
    ...
    companion object {
        ...
        private val START_LOC = Location(3091, 3276, 3)
    }
}
