...
public class Model extends Renderable {
	...
	public Model(Model[] var1, int var2) {
		...
		this.verticesX = new float[this.verticesCount]; // L: 118
		this.verticesY = new float[this.verticesCount]; // L: 119
		this.verticesZ = new float[this.verticesCount]; // L: 120
		...
		if (var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) { // L: 188
			...
			if (var3 == var1[var7][var9] && var3 == var1[var8][var9] && var3 == var1[var7][var10] && var3 == var1[var8][var10]) { // L: 193
				...
				if (var5) { // L: 195
					...
					var11.verticesY = new float[var11.verticesCount]; // L: 219
				} else {
					var11 = this; // L: 222
				}
				...
				if (var6 == 0) { // L: 224
					for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L: 225
						var13 = (int) (var2 + this.verticesX[var12]); // L: 226
						var14 = (int) (var4 + this.verticesZ[var12]); // L: 227
					...
					for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L: 239
						var13 = ((int) -this.verticesY[var12] << 16) / super.height; // L: 240
						if (var13 < var6) { // L: 241
							var14 = (int) (var2 + this.verticesX[var12]); // L: 242
							var15 = (int) (var4 + this.verticesZ[var12]); // L: 243
	...
	Model buildSharedModel(boolean var1, Model var2, byte[] var3) {
		...
		if (var2.verticesX == null || var2.verticesX.length < this.verticesCount) { // L: 273
			var2.verticesX = new float[this.verticesCount + 100]; // L: 274
			var2.verticesY = new float[this.verticesCount + 100]; // L: 275
			var2.verticesZ = new float[this.verticesCount + 100]; // L: 276
		}
	...
	void calculateBoundingBox(int var1) {
		if (this.xMidOffset == -1) { // L: 317
			...
			for (int var10 = 0; var10 < this.verticesCount; ++var10) { // L: 326
				int var11 = Rasterizer3D.method3927((int) this.verticesX[var10], (int) this.verticesZ[var10], var8, var9); // L: 327
				int var12 = (int) this.verticesY[var10]; // L: 328
				int var13 = Rasterizer3D.method3951((int) this.verticesX[var10], (int) this.verticesZ[var10], var8, var9); // L: 329
				if (var11 < var2) { // L: 330
					var2 = var11;
				}
	...
	public void calculateBoundsCylinder() {
		if (this.boundsType != 1) { // L: 354
			...
			for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 359
				int var2 = (int) this.verticesX[var1]; // L: 360
				int var3 = (int) this.verticesY[var1]; // L: 361
				int var4 = (int) this.verticesZ[var1]; // L: 362
	...
	void method4255() {
		if (this.boundsType != 2) { // L: 374
			...
			for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 377
				int var2 = (int) this.verticesX[var1]; // L: 378
				int var3 = (int) this.verticesY[var1]; // L: 379
				int var4 = (int) this.verticesZ[var1]; // L: 380
	...
	public void rotateY90Ccw() {
		for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 659
			int var2 = (int) this.verticesX[var1]; // L: 660
	...
	public void rotateY270Ccw() {
		for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 676
			int var2 = (int) this.verticesZ[var1]; // L: 677
	...
	public void rotateZ(int var1) {
		...
		for (int var4 = 0; var4 < this.verticesCount; ++var4) { // L: 687
			int var5 = var3 * ((int)this.verticesY[var4]) - var2 * ((int) this.verticesZ[var4]) >> 16; // L: 688
			this.verticesZ[var4] = var2 * ((int)this.verticesY[var4]) + var3 * ((int)this.verticesZ[var4]) >> 16; // L: 689
	...
	public void offsetBy(int var1, int var2, int var3) {
		for (int var4 = 0; var4 < this.verticesCount; ++var4) { // L: 696
			float[] var10000 = this.verticesX; // L: 697
			var10000[var4] += var1;
    ...
    public final void method4272(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        for (int var19 = 0; var19 < this.verticesCount; ++var19) { // L: 727
            int var20 = (int) this.verticesX[var19]; // L: 728
            int var21 = (int) this.verticesY[var19]; // L: 729
            int var22 = (int) this.verticesZ[var19]; // L: 730
            int var23;
            if (var3 != 0) { // L: 731
