...
class Region12108 : NPCSpawnsScript() {

    init {
        ABYSSAL_DEMON(3016, 4891, 0, SOUTH, 5)
        ABYSSAL_LEECH(3017, 4903, 0, SOUTH, 6)
        ABYSSAL_LEECH(3017, 4910, 0, SOUTH, 6)
        ABYSSAL_DEMON(3018, 4902, 0, SOUTH, 5)
        ...
        ABYSSAL_DEMON(3023, 4877, 0, SOUTH, 5)
        ABYSSAL_DEMON(3025, 4916, 0, SOUTH, 5)
        ABYSSAL_GUARDIAN(3027, 4914, 0, SOUTH, 6)
        ABYSSAL_DEMON(3029, 4899, 0, SOUTH, 5)
        ...
        ABYSSAL_DEMON(3035, 4883, 0, SOUTH, 5)
        ABYSSAL_DEMON(3036, 4905, 0, SOUTH, 5)
        ...
        ABYSSAL_DEMON(3046, 4874, 0, SOUTH, 5)
        ABYSSAL_DEMON(3046, 4887, 0, SOUTH, 5)
        ABYSSAL_DEMON(3048, 4917, 0, SOUTH, 5)
        ABYSSAL_LEECH(3050, 4873, 0, SOUTH, 6)
        ABYSSAL_GUARDIAN(3052, 4898, 0, SOUTH, 6)
        ABYSSAL_DEMON(3053, 4892, 0, SOUTH, 5)
        ABYSSAL_DEMON(3056, 4909, 0, SOUTH, 5)
        ABYSSAL_LEECH(3056, 4912, 0, SOUTH, 6)
        ABYSSAL_GUARDIAN(3057, 4908, 0, SOUTH, 6)
        ABYSSAL_LEECH(3061, 4880, 0, SOUTH, 6)
        ABYSSAL_DEMON(3061, 4882, 0, SOUTH, 5)
