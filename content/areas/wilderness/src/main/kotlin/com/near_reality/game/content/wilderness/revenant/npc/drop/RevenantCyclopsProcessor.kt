...
private const val EMBLEM_RATE: Int = 350
private const val TOTEM_RATE: Int = 450
private const val STATUE_RATE: Int = 550
private const val MEDALLION_RATE: Int = 650
private const val EFFIGY_RATE: Int = 750
private const val RELIC_RATE: Int = 850
private const val CRYSTAL_RATE: Int = 250
private const val AMULET_RATE: Int = 1000
private const val VIGGORAS_RATE: Int = 2700
private const val CRAWS_RATE: Int = 2700
private const val THAMMARONS_RATE: Int = 2700
private const val PRIMAL_RATE: Int = 2700


@Suppress("unused")
class RevenantCyclopsProcessor : DropProcessor() {
    ...
    override fun ids(): IntArray {
        return intArrayOf(NpcId.REVENANT_CYCLOPS)
    }
