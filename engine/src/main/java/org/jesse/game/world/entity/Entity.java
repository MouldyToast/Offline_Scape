...
import org.jesse.game.world.entity.masks.UpdateFlags;
...
public interface Entity extends Position, CharacterLoop, InteractableEntity {
    ...
    RouteEvent<?, ?> getRouteEvent();

    void setRouteEvent(final RouteEvent<?, ?> event);

    long getProtectionDelay();
    ...
    enum EntityType {
        ...
        PLAYER(Player.class),
        NPC(org.jesse.game.world.entity.npc.NPC.class),
        BOTH(Entity.class);
