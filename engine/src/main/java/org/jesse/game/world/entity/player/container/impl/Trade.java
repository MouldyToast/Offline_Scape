...
import org.jesse.game.world.entity.player.container.impl.TradeExtKt;
...
import static org.jesse.game.world.entity.player.container.impl.TradeStatus.*;
...
public class Trade {
    ...
    public void sendTradeRequest(final Player partner) {
        ...
        if (player.getBankPin().requiresVerification(player, () -> sendTradeRequest(player))) return;
