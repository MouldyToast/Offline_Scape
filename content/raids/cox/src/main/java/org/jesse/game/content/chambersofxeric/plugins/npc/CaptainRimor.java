...
import org.jesse.game.content.chambersofxeric.map.RaidPattern;
...
public class CaptainRimor extends NPCPlugin {
    ...
    public void handle() {
        ...
        bind("Claim-cape", (player, npc) -> {
            final int killcount = player.getNumericAttribute("chambersofxeric").intValue() +
                player.getNumericAttribute("challengechambersofxeric").intValue();
            if (killcount < 10) {
