...
import org.jesse.game.content.godwars.npcs.KrilTsutsaroth
...
/**
 * Represents the K'ril Tsutsaroth npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaKrillTsutsaroth(override val config: PvmArenaNpc.SpawnConfig) :
    KrilTsutsaroth(emptyArray<GodwarsBossMinion>(), KRIL_TSUTSAROTH, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
