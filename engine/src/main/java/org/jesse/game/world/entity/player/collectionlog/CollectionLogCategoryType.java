...
public enum CollectionLogCategoryType {
    ...
    ARAXXOR(4260, player -> get(player, "Araxxor")),
    ...
    DUKE_SUCELLUS(3967, player -> get(player, "Duke Sucellus")),
    ...
    THE_LEVAIATHAN(3968, player -> get(player, "The Leviathan")),
    ...
    VARDORVIS(3970, player -> get(player, "Vardorvis")),
    ...
    THE_WHISPERER(3969, player -> get(player, "The Whisperer")),
    ...
    ROOFTOP_AGILITY(-1),
    SHAYZIEN_ARMOUR(-1),
    SHOOTING_STARS(-1, PlayerAttributesKt::getShootingStarsMined),
    SKILLING_PETS(-1),
    SLAYER(-1),
    TZHAAR(-1),
    MISCELLANEOUS(-1),
    TORMENTED_DEMON(4240, player -> get(player, "Tormented demon"))
    ;
