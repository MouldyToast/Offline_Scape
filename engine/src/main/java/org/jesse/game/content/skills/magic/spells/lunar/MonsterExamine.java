...
public final class MonsterExamine extends Interface implements NPCSpell {
	...
	private static String getStats(final NPC npc) {
	...
	private static String getAggressiveStats(final NPC npc) {
		final NPCCombatDefinitions combat = npc.getCombatDefinitions();
		final StatDefinitions statDefs = combat.getStatDefinitions();
	...
	private static String getDefensiveStats(final NPC npc) {
		final NPCCombatDefinitions combat = npc.getCombatDefinitions();
		final StatDefinitions statDefs = combat.getStatDefinitions();
	...
	private static String getOtherAttributes(final NPC npc) {
		final NPCCombatDefinitions combat = npc.getCombatDefinitions();
