...
public class VorkathsHeadOnCape implements PairedItemOnItemPlugin {
    ...
    public ItemPair[] getMatchingPairs() {
        return new ItemPair[] {ItemPair.of(ItemId.VORKATHS_HEAD_21907, ItemId.RANGING_CAPE), ItemPair.of(ItemId.VORKATHS_HEAD_21907, ItemId.RANGING_CAPET), ItemPair.of(ItemId.VORKATHS_HEAD_21907, ItemId.MAX_CAPE)};
    }
}
