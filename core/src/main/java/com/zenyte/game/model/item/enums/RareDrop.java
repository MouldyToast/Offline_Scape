...
//    KRAKEN_TENTACLE(12004),
    ...
    BLUDGEON_CLAW(ItemId.BLUDGEON_CLAW),
    BLUDGEON_SPINE(ItemId.BLUDGEON_SPINE),
    BLUDGEON_AXON(ItemId.BLUDGEON_AXON),
...
//    DARK_BOW(11235),
    ...
    GWD_SOUL_CRYSTAL1(ItemId.BANDOS_BOW),
    GWD_SOUL_CRYSTAL2(ItemId.ARMADYL_BOW),
    GWD_SOUL_CRYSTAL3(ItemId.ZAMORAK_BOW),
    GWD_SOUL_CRYSTAL4(ItemId.SARADOMIN_BOW),
    ...
    SLAYER1(ItemId.SLAYER_LEFT_BONE),
    SLAYER2(SLAYER_RIGHT_BONE),
    SLAYER3(SLAYER_SHAFT),
    SLAYER4(SLAYER_BASE),
    // Araxxor
    ...
    OMEGAS(OMEGA_BOOTS),
    PRIMAL_FULL_HELM(ItemId.PRIMAL_FULL_HELM),
    PRIMAL_PLATEBODY(ItemId.PRIMAL_PLATEBODY),
    PRIMAL_PLATELEGS(ItemId.PRIMAL_PLATELEGS),
    PRIMAL_BOOTS(ItemId.PRIMAL_BOOTS),
    PRIMAL_GAUNTLETS(ItemId.PRIMAL_GAUNTLETS),
    PRIMAL_CHAINBODY(ItemId.PRIMAL_CHAINBODY),
    PRIMAL_SPEAR(ItemId.PRIMAL_SPEAR),
    PRIMAL_LONGSWORD(ItemId.PRIMAL_LONGSWORD),
    PRIMAL_MAUL(ItemId.PRIMAL_MAUL),
    PRIMAL_HATCHET(ItemId.PRIMAL_HATCHET),
    PRIMAL_DAGGER(ItemId.PRIMAL_DAGGER),
    PRIMAL_RAPIER(ItemId.PRIMAL_RAPIER),
    PRIMAL_WARHAMMER(ItemId.PRIMAL_WARHAMMER),
    PRIMAL_BATTLEAXE(ItemId.PRIMAL_BATTLEAXE),
    PRIMAL_KITESHIELD(ItemId.PRIMAL_KITESHIELD)
    ;
