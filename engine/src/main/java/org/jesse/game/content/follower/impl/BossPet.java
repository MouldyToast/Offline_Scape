...
import org.jesse.game.content.minigame.wintertodt.RewardCrate;
...
import org.jesse.plugins.dialogue.followers.AbyssalOrphanD;
import org.jesse.plugins.dialogue.followers.BabyMoleD;
import org.jesse.plugins.dialogue.followers.BaronD;
import org.jesse.plugins.dialogue.followers.ButchD;
import org.jesse.plugins.dialogue.followers.CallistoCubD;
import org.jesse.plugins.dialogue.followers.HellpuppyD;
import org.jesse.plugins.dialogue.followers.IkkleHydraD;
import org.jesse.plugins.dialogue.followers.JalNibRekD;
import org.jesse.plugins.dialogue.followers.KalphitePrincessD;
import org.jesse.plugins.dialogue.followers.LilBloatD;
import org.jesse.plugins.dialogue.followers.LilMaidenD;
import org.jesse.plugins.dialogue.followers.LilNyloD;
import org.jesse.plugins.dialogue.followers.LilSotD;
import org.jesse.plugins.dialogue.followers.LilViathanD;
import org.jesse.plugins.dialogue.followers.LilXarpD;
import org.jesse.plugins.dialogue.followers.LilZikD;
import org.jesse.plugins.dialogue.followers.MidnightD;
import org.jesse.plugins.dialogue.followers.MuphinD;
import org.jesse.plugins.dialogue.followers.NexlingD;
import org.jesse.plugins.dialogue.followers.NoonD;
import org.jesse.plugins.dialogue.followers.OlmletD;
import org.jesse.plugins.dialogue.followers.PetChaosElementalD;
import org.jesse.plugins.dialogue.followers.PetDagannothPrimeD;
import org.jesse.plugins.dialogue.followers.PetDagannothRexD;
import org.jesse.plugins.dialogue.followers.PetDagannothSupremeD;
import org.jesse.plugins.dialogue.followers.PetDarkCoreD;
import org.jesse.plugins.dialogue.followers.PetGeneralGraardorD;
import org.jesse.plugins.dialogue.followers.PetKrakenD;
import org.jesse.plugins.dialogue.followers.PetKreeArraD;
import org.jesse.plugins.dialogue.followers.PetKrilTsutsarothD;
import org.jesse.plugins.dialogue.followers.PetPenanceQueenD;
import org.jesse.plugins.dialogue.followers.PetSmokeDevilD;
import org.jesse.plugins.dialogue.followers.PetSnakelingD;
import org.jesse.plugins.dialogue.followers.PetZilyanaD;
import org.jesse.plugins.dialogue.followers.PhoenixD;
import org.jesse.plugins.dialogue.followers.PrinceBlackDragonD;
import org.jesse.plugins.dialogue.followers.ScorpiasOffspringD;
import org.jesse.plugins.dialogue.followers.SkotosD;
import org.jesse.plugins.dialogue.followers.SmolHereditD;
import org.jesse.plugins.dialogue.followers.TzRekJadD;
import org.jesse.plugins.dialogue.followers.VenenatisSpiderlingD;
import org.jesse.plugins.dialogue.followers.VetionD;
import org.jesse.plugins.dialogue.followers.VorkiD;
import org.jesse.plugins.dialogue.followers.WispD;
import org.jesse.plugins.dialogue.followers.YoungllefD;
...
public enum BossPet implements Pet {
    ...
    PET_REAVER(ItemId.BLOOD_TENTACLES, 10960, 300, null),
    ...
    PET_POSTIE_PETE     (ItemId.PET_POSTIE_PETE,     NpcId.REMN_POSTIE_PETE),
    PET_IMP             (ItemId.PET_IMP,             NpcId.REMN_IMP),
    PET_TOUCAN          (ItemId.PET_TOUCAN,          NpcId.REMN_TOUCAN),
    PET_KING_PENGUIN    (ItemId.PET_KING_PENGUIN,    NpcId.REMN_KING_PENGUIN),
    PET_KKLIK           (ItemId.PET_KKLIK,           NpcId.REMN_KKLIK),
    PET_SHADOW_WARRIOR  (ItemId.PET_SHADOW_WARRIOR,  NpcId.REMN_SHADOW_WARRIOR),
    PET_SHADOW_ARCHER   (ItemId.PET_SHADOW_ARCHER,   NpcId.REMN_SHADOW_ARCHER),
    PET_SHADOW_WIZARD   (ItemId.PET_SHADOW_WIZARD,   NpcId.REMN_SHADOW_WIZARD),
    PET_HEALER_DEATH_SPAWN (ItemId.PET_HEALER_DEATH_SPAWN, NpcId.REMN_HEALER_DEATH_SPAWN),
    PET_HOLY_DEATH_SPAWN   (ItemId.PET_HOLY_DEATH_SPAWN,   NpcId.REMN_HOLY_DEATH_SPAWN),
    PET_SEREN           (ItemId.PET_SEREN,           NpcId.REMN_SEREN),
    PET_CORRUPT_BEAST   (ItemId.PET_CORRUPT_BEAST,   NpcId.REMN_CORRUPT_BEAST),
    PET_ROC             (ItemId.PET_ROC,             NpcId.REMN_ROC),
    PET_KRATOS          (ItemId.PET_KRATOS,          NpcId.REMN_KRATOS),
    PET_DARK_POSTIE_PETE   (ItemId.PET_DARK_POSTIE_PETE,   NpcId.REMN_DARK_POSTIE_PETE),
    PET_DARK_IMP           (ItemId.PET_DARK_IMP,           NpcId.REMN_DARK_IMP),
    PET_DARK_TOUCAN        (ItemId.PET_DARK_TOUCAN,        NpcId.REMN_DARK_TOUCAN),
    PET_DARK_KING_PENGUIN  (ItemId.PET_DARK_KING_PENGUIN,  NpcId.REMN_DARK_KING_PENGUIN),
    PET_DARK_KKLIK         (ItemId.PET_DARK_KKLIK,         NpcId.REMN_DARK_KKLIK),
    PET_DARK_SHADOW_WARRIOR(ItemId.PET_DARK_SHADOW_WARRIOR,NpcId.REMN_DARK_SHADOW_WARRIOR),
    PET_DARK_SHADOW_ARCHER (ItemId.PET_DARK_SHADOW_ARCHER, NpcId.REMN_DARK_SHADOW_ARCHER),
    PET_DARK_SHADOW_WIZARD (ItemId.PET_DARK_SHADOW_WIZARD, NpcId.REMN_DARK_SHADOW_WIZARD),
    PET_DARK_HEALER_DEATH_SPAWN (ItemId.PET_DARK_HEALER_DEATH_SPAWN, NpcId.REMN_DARK_HEALER_DEATH_SPAWN),
    PET_DARK_HOLY_DEATH_SPAWN   (ItemId.PET_DARK_HOLY_DEATH_SPAWN,   NpcId.REMN_DARK_HOLY_DEATH_SPAWN),
    PET_DARK_SEREN          (ItemId.PET_DARK_SEREN,          NpcId.REMN_DARK_SEREN),
    PET_DARK_CORRUPT_BEAST  (ItemId.PET_DARK_CORRUPT_BEAST,  NpcId.REMN_DARK_CORRUPT_BEAST),
    PET_DARK_ROC            (ItemId.PET_DARK_ROC,            NpcId.REMN_DARK_ROC),
    PET_DARK_KRATOS         (ItemId.PET_DARK_KRATOS,         NpcId.REMN_DARK_KRATOS),
    PET_CORRUPT_KRATOS      (ItemId.PET_FISSILE_KRATOS,      NpcId.REMN_FISSILE_KRATOS),
