...
public class GrandExchange {
    ...
    public void openOffersInterface() {
        ...
        if (player.getBankPin().requiresVerification(player, this::openOffersInterface)) return;
        ...
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 7, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 7, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 8, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 8, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 9, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 9, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 10, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 10, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 11, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 11, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 12, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 12, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 13, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 13, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 14, 2, 2, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 14, 3, 4, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 23, 0, 0, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 24, 0, 3, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2, AccessMask.CLICK_OP3, AccessMask.CLICK_OP10);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 6, 0, 0, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 25, 0, 6, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 25, 7, 7, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 25, 8, 13, AccessMask.CLICK_OP1);
        player.getPacketDispatcher().sendComponentSettings(INTERFACE, 25, 14, 15, AccessMask.CLICK_OP1, AccessMask.CLICK_OP2);
    ...
    public boolean sell(Item item) {
        ...
        if (GameConstants.RESTRICTED_TRADE_ITEMS.contains(item.getId()) || item.getId() == 995 || item.getId() == 13224 || !item.getDefinitions().isGrandExchange()) {
    ...
    public void viewOffer(final int slot) {
        ...
        // If the account has a PIN & Required unlocking; STOP HERE
        if (player.getBankPin().requiresVerification(player, () -> viewOffer(slot))) return;
    ...
    public void createOffer() {
        ...
        if (type.equals(ExchangeType.BUYING)) {
            if (player.getInventory().getAmountOf(995) < total) {
                player.sendMessage("That offer costs " + StringFormatUtil.format(total) + " coins. You haven't got " +
                        "enough.");
                return;
            }
        ...
        final ExchangeOffer offer = new ExchangeOffer(player.getUsername(), player.getDbUsername(), new Item(item.getId(), quantity), price, slot, type);
        player.getPacketDispatcher().sendGrandExchangeOffer(offer);
        addOffer(offer);
    ...
    private void addOffer(final ExchangeOffer offer) {
        ...
        if(WORLD_PROFILE.isLogsDatabaseEnabled())
            GameLogger.log(Level.INFO, () -> new GameLogMessage.GrandExchangeOffer(Instant.Companion.now(), player.getDbUsername(), offer));
