...
import cloud.rsps.game.hiscores.HiscoreMode;
...
public enum GameMode implements IPrivilege {
	...
	REGULAR(Crown.NONE, Crown.REALIST_REGULAR, "regular", new int[] { 150, 80, 10, 5}, HiscoreMode.NORMAL),
	STANDARD_IRON_MAN(Crown.STANDARD_IRON_MAN, Crown.REALIST_STANDARD_IRON_MAN, "ironman", new int[] { 80, 20, 10, 5 }, HiscoreMode.IRONMAN),
	ULTIMATE_IRON_MAN(Crown.ULTIMATE_IRON_MAN, Crown.REALIST_ULTIMATE_IRON_MAN, "ultimate_ironman", new int[] { 80, 20, 10, 5 }, HiscoreMode.ULTIMATE_IRONMAN),
	HARDCORE_IRON_MAN(Crown.HARDCORE_IRON_MAN, Crown.REALIST_HARDCORE_IRON_MAN, "hardcore_ironman", new int[] { 80, 20, 10, 5 }, HiscoreMode.HARDCORE_IRONMAN),
	GROUP_IRON_MAN(Crown.GROUP_IRON_MAN,  Crown.NONE, "group_ironman", new int[] { 20, 20, 10, 5 }, HiscoreMode.IRONMAN),
	GROUP_HARDCORE_IRON_MAN(Crown.HARDCORE_GROUP_IRON_MAN,  Crown.NONE, "hardcore_group_ironman", new int[] { 20, 20, 10, 5 }, HiscoreMode.HARDCORE_IRONMAN),
	;
	...
	public HiscoreMode getHiscoreMode() {
		return hiscoreMode;
	}
