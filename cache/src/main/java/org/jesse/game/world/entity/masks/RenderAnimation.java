package org.jesse.game.world.entity.masks;
...
public final class RenderAnimation implements RenderType {
	...
	public RenderAnimation(
			@JsonProperty("stand") int stand,
			@JsonProperty("standTurn") int standTurn,
			@JsonProperty("walk") int walk,
			@JsonProperty("rotate180") int rotate180,
			@JsonProperty("rotate90") int rotate90,
			@JsonProperty("rotate270") int rotate270,
