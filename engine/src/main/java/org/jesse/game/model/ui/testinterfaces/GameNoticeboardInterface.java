...
public final class GameNoticeboardInterface extends Interface {
    ...
    private static final Logger logger = NearRealityLogger.getLogger(GameNoticeboardInterface.class);

    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("dd MMM yyyy");

    private static final PlayerPrivilege[] staffPrivileges = {
    ...
    public static void showStaffOnline(final Player player) {
        ...
        int count = 0;
        for (final PlayerPrivilege privilege : staffPrivileges) {
    ...
    protected void build() {
        ...
        bind("Game Settings", player -> {
            ...
            player.getInterfaceHandler().openGameTab(GameTab.SETTINGS_TAB);
