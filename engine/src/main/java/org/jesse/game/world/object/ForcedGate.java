...
import org.jesse.game.world.entity.pathfinding.events.npc.NPCTileEvent;
...
public class ForcedGate<T extends Entity> {
    ...
    public ForcedGate(@NotNull final T entity, @NotNull final WorldObject object) {
        ...
        final org.jesse.game.world.object.WorldObject nearbyDoor = Objects.requireNonNull(entity instanceof Player ? TemporaryDoubleDoor.getNearbyDoor((Player) entity, object) : TemporaryDoubleDoor.getNearbyDoor(object));
        final org.jesse.game.world.object.WorldObject doorA = new WorldObject(object.getX() == nearbyDoor.getX() ? (object.getY() < nearbyDoor.getY() ? object : nearbyDoor) : (object.getX() < nearbyDoor.getX() ? nearbyDoor : object));
        final org.jesse.game.world.object.WorldObject doorB = new WorldObject(doorA.getPositionHash() == object.getPositionHash() ? nearbyDoor : object);
        final org.jesse.game.world.object.WorldObject leftDoor = object.getRotation() == 0 || object.getRotation() == 3 ? doorB : doorA;
        final org.jesse.game.world.object.WorldObject rightDoor = leftDoor == doorA ? doorB : doorA;
    ...
    public void handle(final Optional<Predicate<T>> predicate) {
        final org.jesse.game.world.entity.pathfinding.events.RouteEvent<T, org.jesse.game.world.entity.pathfinding.strategy.TileStrategy> event = getEvent();
        if (event != null) {
    ...
    private void handleSub(final Optional<Predicate<T>> predicate) {
        final org.jesse.game.world.entity.pathfinding.strategy.TileStrategy strategy = new TileStrategy(startPosition);
        final java.lang.Runnable runnable = (Runnable) () -> {
            ...
            final org.jesse.game.world.object.WorldObject leftDoor = graphicalPair.getFirst();
            final org.jesse.game.world.object.WorldObject rightDoor = graphicalPair.getSecond();
