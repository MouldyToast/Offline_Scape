    ...
    CannonRestrictionPlugin
{
    override fun enter(player: Player?) {
        player?.sendDeveloperMessage("You have entered the Easter 2025 event area.")
    ...
    override fun leave(player: Player?, logout: Boolean) {
        player?.sendDeveloperMessage("You have left the Easter 2025 event area.")
        player?.resetViewDistance()
        player?.hpHud?.close()
    }

    override fun name(): String = "Easter 2025 Event Area"
