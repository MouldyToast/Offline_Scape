...
private const val AMULET_RATE: Int = 800
private const val VIGGORAS_RATE: Int = 900
private const val CRAWS_RATE: Int = 900
private const val THAMMARONS_RATE: Int = 900
private const val PRIMAL_RATE: Int = 900

@Suppress("unused")
class RevenantKnightProcessor : DropProcessor() {
    ...
    override fun ids(): IntArray {
        return intArrayOf(NpcId.REVENANT_KNIGHT)
    }
