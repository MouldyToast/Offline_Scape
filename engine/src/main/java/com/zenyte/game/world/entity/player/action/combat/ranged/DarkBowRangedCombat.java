...
public final class DarkBowRangedCombat extends RangedCombat {
    ...
    public DarkBowRangedCombat(final Entity target) {
        super(target);
    }
    ...
    public int processAfterMovement() {
        ...
        final DarkBowRangedCombat.Arrow arrow = Arrow.map.get(ammunitionDefinitions);
        assert arrow != null : "Arrow for the ammunition: " + ammunitionDefinitions + " isn't defined.";
