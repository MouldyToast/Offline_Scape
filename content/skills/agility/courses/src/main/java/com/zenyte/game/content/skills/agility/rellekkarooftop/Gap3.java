...
/**
 * @author Tommeh | 09/06/2019 | 15:35
...
public final class Gap3 extends AgilityCourseObstacle {
    ...
    private static final Location LOCATION1 = new Location(2643, 3656, 3);
    private static final SoundEffect EFFECT1 = new SoundEffect(1936);

    public Gap3() {
        super(RellekkaRooftopCourse.class, 5);
    }
    ...
    public int[] getObjectIds() {
        return new int[] {ObjectId.GAP_14991 };
    }
