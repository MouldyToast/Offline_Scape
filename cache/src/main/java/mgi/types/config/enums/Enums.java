...
public interface Enums {
    ...
    IntEnum DEPOSIT_BOX_EQUIPMENT_TAB_SLOT_MAP = EnumDefinitions.getIntEnum(2737);
    ...
    IntEnum ENCHANT_SIDEBAR_ENUM = EnumDefinitions.getIntEnum(5285);
    ...
    IntEnum HAIR_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(496);
    IntEnum FACIAL_HAIR_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(2630);
    IntEnum TORSO_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(5495);
    IntEnum SLEEVE_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(5496);
    IntEnum LEGGING_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(5497);
    IntEnum SHOE_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(5498);
    IntEnum HAND_STYLES_DB_POINTER = EnumDefinitions.getIntEnum(5499);
