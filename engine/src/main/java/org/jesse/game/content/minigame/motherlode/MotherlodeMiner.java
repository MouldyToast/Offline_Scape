...
import static org.jesse.game.content.skills.mining.actions.Mining.ROCKFALL_EXPLOSION;
import static org.jesse.game.content.skills.mining.actions.Mining.ROCKFALL_PROJECTILE;
                    ...
                    if (World.exists(rock)) {
                        ...
                        WorldTasksManager.schedule(() -> {
                            if (World.exists(rock)) {
                                ...
                                }, OreDefinitions.ROCKFALL.getTime());
                            }
                            findVein().ifPresent(vein -> {
                                setRouteEvent(new NPCObjectEvent(this, new ObjectStrategy(currentVein = vein)));
                                delay = 2;
