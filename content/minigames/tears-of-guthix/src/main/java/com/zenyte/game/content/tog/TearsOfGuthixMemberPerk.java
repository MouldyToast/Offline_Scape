...
public enum TearsOfGuthixMemberPerk {
    PREMIUM(MemberRank.TOPAZ, 10),
    EXPANSION(MemberRank.SAPPHIRE, 20),
    EXTREME(MemberRank.EMERALD, 25),
    RESPECTED(MemberRank.RUBY, 30),
    LEGENDARY(MemberRank.DIAMOND, 45),
    MYTHICAL(MemberRank.DRAGONSTONE, 55),
    UBER(MemberRank.ONYX, 70);
