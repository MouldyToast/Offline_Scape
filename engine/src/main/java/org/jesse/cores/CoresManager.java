...
public final class CoresManager {
    private static final Logger log = NearRealityLogger.getLogger(CoresManager.class);
    ...
    public static void init(
        ...
        worldThread = new WorldThread(
                "World Thread",
                !worldProfile.isDevelopment(),
                networkService
        );
        if (networkService != null) {
            networkService.setCommunicationThread(worldThread, true);
        }

        slowExecutor = new SlowThreadPoolExecutor(
