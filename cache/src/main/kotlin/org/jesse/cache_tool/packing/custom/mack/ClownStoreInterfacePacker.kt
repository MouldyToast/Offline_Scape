package org.jesse.cache_tool.packing.custom.mack

import org.jesse.cache.group
        ...
        assetsBase("assets/osnr/store_interface/") {
            ...
            "struct" {
                ...
                StructDefinitions(fileId).apply {
                    ...
                    when(fileId) {
                        12000 -> {
                            parameters[10_000] = "$5 DPin"
                            parameters[10_001] = ""
                            parameters[10_002] = "$4.99"
                        }
                        12001 -> {
                            parameters[10_000] = "$10 DPin"
                            parameters[10_001] = "+10 bonus credits"
                            parameters[10_002] = "$9.99"
                        }
                        12002 -> {
                            parameters[10_000] = "$25 DPin"
                            parameters[10_001] = "+25 bonus credits"
                            parameters[10_002] = "$24.99"
                        }
                        12003 -> {
                            parameters[10_000] = "$35 DPin"
                            parameters[10_001] = "+35 bonus credits"
                            parameters[10_002] = "$34.99"
                        }
                        12004 -> {
                            parameters[10_000] = "$50 DPin"
                            parameters[10_001] = "+70 bonus credits"
                            parameters[10_002] = "$49.99"
                        }
                        12005 -> {
                            parameters[10_000] = "$100 DPin"
                            parameters[10_001] = "+200 bonus credits"
                            parameters[10_002] = "$99.99"
                        }
                    }
                    pack()
