...
val map: Map<String, CustomDefinition> = mapOf(
    ...
    "rebirth_well_blue" to CustomDefinition.Model(modelId = 60402),
    "rebirth_well_green" to CustomDefinition.Model(modelId = 60403),
    "rebirth_universal_chest" to CustomDefinition.Model(modelId = 60404),
    "rebirth_mini_altar" to CustomDefinition.Model(modelId = 60405),
    "rebirth_hex_glass" to CustomDefinition.Model(modelId = 60406),
    "rebirth_mini_pool" to CustomDefinition.Model(modelId = 60407),
    "rebirth_townboard" to CustomDefinition.Model(modelId = 60408),
    "rebirth_decant_table" to CustomDefinition.Model(modelId = 60409),
    "rebirth_ge_straight_wall" to CustomDefinition.Model(modelId = 60410),
    "rebirth_ge_corner" to CustomDefinition.Model(modelId = 60411),
    "rebirth_slayer_helm_stand_empty" to CustomDefinition.Model(modelId = 60412),
