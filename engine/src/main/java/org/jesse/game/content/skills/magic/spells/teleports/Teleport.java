...
import static org.jesse.game.world.region.area.wilderness.WildernessArea.isWithinWilderness;
...
public interface Teleport {
	...
	default void teleport(final Player player, final boolean alwaysWarnForDeepWilderness) {
		try {
			if(isWithinWilderness(this.destination()) && (alwaysWarnForDeepWilderness || !player.getBooleanAttribute("NO_WILDERNESS_TELEPORT_WARNING"))) {
