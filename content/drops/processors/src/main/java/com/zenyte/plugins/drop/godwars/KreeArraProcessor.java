...
public class KreeArraProcessor extends DropProcessor {
    ...
    public void attach() {
        //Armour
        appendDrop(new DisplayedDrop(11826, 1, 1, 75));
        appendDrop(new DisplayedDrop(11828, 1, 1, 75));
        appendDrop(new DisplayedDrop(11830, 1, 1, 75));
        //Armadyl hilt
        appendDrop(new DisplayedDrop(11810, 1, 1, 100));
        //Godsword shards
    ...
    public Item drop(final NPC npc, final Player killer, final Drop drop, final Item item) {
        if (!drop.isAlways()) {
            ...
            if ((random = randomDrop(killer, 225)) < 3) {
