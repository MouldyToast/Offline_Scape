package org.jesse.game.model.polls;

import org.jesse.cores.CoresManager;
import org.jesse.cores.ScheduledExternalizable;
import org.jesse.game.model.polls.AnsweredPoll.AnsweredPollQuestion;
...
public final class PollManager implements ScheduledExternalizable {
	private static final Logger log = NearRealityLogger.getLogger(PollManager.class);
