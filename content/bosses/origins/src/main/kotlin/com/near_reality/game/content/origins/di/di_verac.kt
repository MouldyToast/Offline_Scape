...
class DiVeracDroptable : NPCDropTableScript() {
    ...
    init {
        ...
        buildTable {
            Main(denominator = 512) {
                ...
                // the 12
                VERACS_HELM quantity 1 rarity 2
                VERACS_BRASSARD quantity 1 rarity 2
                VERACS_PLATESKIRT quantity 1 rarity 2
                VERACS_FLAIL quantity 1 rarity 2
