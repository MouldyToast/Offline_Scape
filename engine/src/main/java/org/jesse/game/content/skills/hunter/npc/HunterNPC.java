package org.jesse.game.content.skills.hunter.npc;

import org.jesse.ContentConstants;
import org.jesse.game.content.skills.hunter.HunterUtils;
import org.jesse.game.content.skills.hunter.PreyInteractState;
import org.jesse.game.content.skills.hunter.TrapState;
import org.jesse.game.content.skills.hunter.node.HunterPrey;
import org.jesse.game.content.skills.hunter.node.TrapInteractType;
...
abstract class HunterNPC extends NPC {
     ...
     * All classes implementing {@link org.jesse.game.world.entity.npc.Spawnable} must inherit this fixed-type constructor.
    ...
    protected static double successProbability(Player player, final int level, @NotNull final HunterPrey prey) {
        ...
        final float successPerLevel = adjustmentPercentage / ((float) prey.neverFailLevel() - baseRequirement);
