    ...
    public void handle() {
        bind("Read", (player, item, container, slotId) -> player.getDialogueManager().start(new Dialogue(player) {
            ...
            public void buildDialogue() {
                item(item, "Reading the tome will grant you fifteen minutes of 50% bonus experience in anything you do.<br>This bonus experience will stack with the global bonus experience.");
