...
import org.jesse.game.content.chambersofxeric.npc.combat.tekton.TektonCombatScript;
import org.jesse.game.content.chambersofxeric.npc.combat.tekton.TektonEngageScript;
import org.jesse.game.content.chambersofxeric.npc.combat.tekton.TektonRetreatScript;
import org.jesse.game.content.chambersofxeric.npc.combat.tekton.TektonSmithScript;
import org.jesse.game.content.chambersofxeric.room.TektonRoom;
...
public final class Tekton extends RaidNPC<TektonRoom> {
    ...
    public void sendDeath() {
        ...
        getRaid().getPlayers().forEach(p -> p.putBooleanAttribute("firstElderMaulSpecOnTekton", true));
