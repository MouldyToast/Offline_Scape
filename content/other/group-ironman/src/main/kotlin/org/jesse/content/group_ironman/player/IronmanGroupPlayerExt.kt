...
import org.jesse.content.group_ironman.IronmanGroupStorage
import org.jesse.content.group_ironman.IronmanGroupType
import org.jesse.content.group_ironman.onDeath
import org.jesse.game.world.entity.player.hardcoreIronGroupDeathHandlingOverride
...
fun Player.sendChatChannelSettingsPacket(group: IronmanGroup) {
    packetDispatcher.sendClanChannelSettingsFull(ChatChannelType.GIM, group.channel.toSettingsPacket())
}
...
fun Player.sendChatChannelPacket(group: IronmanGroup) {
    packetDispatcher.sendClanChannelUpdateFull(ChatChannelType.GIM, group.channel.toUpdatePacket())
}
...
fun Player.correctXpRates() {
    if (skillingXPRate != 20 || combatXPRate != 20) {
        ...
        for (skill in 0 until SkillConstants.COUNT) {
            ...
            skills.level[skill] = Skills.getLevelForXP(newExperience.toInt())
        }
