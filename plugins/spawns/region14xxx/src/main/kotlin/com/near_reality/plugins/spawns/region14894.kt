...
class Region14894 : NPCSpawnsScript() {

    init {
        MONKEY_1038(3716, 3005, 0, SOUTH, 8)
        JUNGLE_HORROR_1046(3721, 3005, 0, SOUTH, 10)
        JUNGLE_HORROR_1045(3723, 2986, 0, SOUTH, 12)
        MONKEY_1038(3724, 2953, 0, SOUTH, 8)
        SNAKE(3725, 3005, 0, SOUTH, 4)
        SNAKE(3730, 2954, 0, SOUTH, 4)
        JUNGLE_HORROR(3733, 2957, 0, SOUTH, 10)
        SNAKE(3734, 2959, 0, SOUTH, 4)
        SNAKE(3735, 2989, 0, SOUTH, 4)
        MONKEY_1038(3738, 2953, 0, SOUTH, 8)
        JUNGLE_HORROR_1044(3744, 2947, 0, SOUTH, 11)
        JUNGLE_HORROR_1044(3744, 3002, 0, SOUTH, 11)
        SNAKE(3744, 3004, 0, SOUTH, 4)
        SNAKE(3746, 2950, 0, SOUTH, 4)
        CAVEY_DAVEY(3749, 2972, 0, SOUTH, 3)
        MONKEY_1038(3750, 2975, 0, SOUTH, 8)
        SNAKE(3752, 2946, 0, SOUTH, 4)
