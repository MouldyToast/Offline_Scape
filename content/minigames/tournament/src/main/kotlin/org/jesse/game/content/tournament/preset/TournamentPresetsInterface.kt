...
import org.jesse.game.world.entity.player.canOverrideSecurity
...
class TournamentPresetsInterface : Interface() {
    ...
    override fun open(player: Player) {
        if (player.area !is TournamentLobbyArea && !player.canOverrideSecurity()) {
        ...
        with(player.packetDispatcher) {
            sendClientScript(10599, 1, TournamentPreset.entries.joinToString("|"))
            ...
            sendComponentSettings(getInterface(), getComponent("Search"), 0, 10, AccessMask.CLICK_OP1)
