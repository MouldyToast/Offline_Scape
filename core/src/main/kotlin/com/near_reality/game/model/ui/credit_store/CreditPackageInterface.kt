...
sealed class CreditPackage(val id: Int, val component: Int, val amount: Int, val bonusCredits: Int, val cost: Float) {
    data object FiveHundred : CreditPackage(0, 7, 5, 0, 4.99F)
    data object OneThousand : CreditPackage(1, 8, 10, 0, 9.99F)
    data object TwoThousand : CreditPackage(2, 9, 25, 0, 24.99F)
    data object FiveThousand : CreditPackage(3, 10, 35, 0, 34.99F)
    data object TenThousand : CreditPackage(4, 11, 50, 0, 49.99F)
    data object TwentyFiveThousand : CreditPackage(5, 12, 100, 0, 99.99F);
    companion object {
        @JvmStatic
        val values by lazy {
            arrayOf(
