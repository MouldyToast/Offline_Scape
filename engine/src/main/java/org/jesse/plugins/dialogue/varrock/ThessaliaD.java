package org.jesse.plugins.dialogue.varrock;
...
import static org.jesse.game.GameInterface.CHARACTER_DESIGN;
...
public class ThessaliaD extends Dialogue {
	...
	public void buildDialogue() {
		if (talk) {
			...
			npc("It costs nothing now, imagine that! Tired of always wearing the<br>same old outfit, day in, day out? This is the service for<br> you!");
