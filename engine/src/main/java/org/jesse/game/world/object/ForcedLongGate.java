...
public class ForcedLongGate<T extends Entity> {
    ...
    public ForcedLongGate(@NotNull final T entity, @NotNull final WorldObject object) {
        ...
        final org.jesse.game.world.object.WorldObject other = Objects.requireNonNull(Gate.getOtherGate(object));
    ...
    private void handleSub(final Optional<Predicate<T>> predicate) {
        ...
        final org.jesse.game.world.object.WorldObject first = gatePair.getFirst();
        final org.jesse.game.world.object.WorldObject second = gatePair.getSecond();
        final org.jesse.game.world.object.WorldObject innerMapGate = Gate.getInnerMapGate(first, second);
        final org.jesse.game.world.object.WorldObject outerMapGate = first == innerMapGate ? second : first;
        final org.jesse.game.world.entity.Location[] tiles = Gate.getOpenLocations(innerMapGate);
