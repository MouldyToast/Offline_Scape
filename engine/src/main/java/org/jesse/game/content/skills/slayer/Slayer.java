package org.jesse.game.content.skills.slayer;
...
import org.jesse.game.content.slayer.SlayerTask;
import org.jesse.game.world.PlayerEvent.SlayerTaskCompleted;
...
import org.jesse.game.world.region.area.Keldagrim;
...
public class Slayer {
    ...
    private org.jesse.game.content.slayer.Assignment assignment;
    public Int2ObjectOpenHashMap<org.jesse.game.content.slayer.RegularTask> bannedTasks;
    private org.jesse.game.content.slayer.SlayerMaster master;
    private transient Player partner;
    private transient Player player;
    private String lastAssignmentName;
    private org.jesse.game.content.slayer.Assignment storedAssignment;

    public void setAssignment(final org.jesse.game.content.slayer.Assignment assignment) {
    ...
    void confirmTaskStore() {
        ...
        final org.jesse.game.content.slayer.SlayerMaster master = assignment.getMaster();
        if (master.equals(org.jesse.game.content.slayer.SlayerMaster.KRYSTILIA)) {
            player.sendMessage("You can't store a Wilderness task.");
            return;
        }

        removeSlayerPoints(POINTS_REQUIRED_FOR_STORE_TASK);
        storedAssignment = new org.jesse.game.content.slayer.Assignment();
    ...
    void confirmTaskBlock() {
        ...
        org.jesse.game.content.slayer.RegularTask task;
        if (assignment.getTask() instanceof org.jesse.game.content.slayer.BossTask) {
            task = org.jesse.game.content.slayer.RegularTask.BOSS;
        } else {
            task = (org.jesse.game.content.slayer.RegularTask) assignment.getTask();
        }
    ...
    public void finishAssignment(NPC npc) {
        ...
        if (master.equals(org.jesse.game.content.slayer.SlayerMaster.KONAR_QUO_MATEN) && DiaryUtil.eligibleFor(DiaryReward.RADAS_BLESSING4, player)) {
            pointsPerTask = 20;
        }
    ...
    public List<org.jesse.game.content.slayer.RegularTask> getAvailableAssignments(final org.jesse.game.content.slayer.SlayerMaster master) {
        return SlayerHelper.INSTANCE.getAvailableAssignments(player, master);
    }

    public List<org.jesse.game.content.slayer.BossTask> getAvailableBossAssignments() {
        final ArrayList<org.jesse.game.content.slayer.BossTask> possibleTasks = new ArrayList<>((int) (org.jesse.game.content.slayer.BossTask.VALUES.length / 2.0F));
        possibleTasks.addAll(Arrays.asList(org.jesse.game.content.slayer.BossTask.VALUES));
        return possibleTasks;
    }

    public org.jesse.game.content.slayer.Assignment generateTask(final org.jesse.game.content.slayer.SlayerMaster master) {
        return SlayerHelper.INSTANCE.generateTask(player, master);
    }

    public org.jesse.game.content.slayer.SlayerMaster getAdvisedMaster() {
        final Skills skills = player.getSkills();
        for (int i = org.jesse.game.content.slayer.SlayerMaster.getEntries().size() - 1; i >= 0; i--) {
            final org.jesse.game.content.slayer.SlayerMaster master = org.jesse.game.content.slayer.SlayerMaster.getEntries().get(i);
        ...
        return org.jesse.game.content.slayer.SlayerMaster.TURAEL;
    }
    ...
    public org.jesse.game.content.slayer.Assignment getTzTokJadAssignment(final org.jesse.game.content.slayer.SlayerMaster master) {
        final int amount = player.getCombatAchievements().hasTierCompleted(CATierType.GRANDMASTER) ? 3 : 1;
        return new org.jesse.game.content.slayer.Assignment(player, this, org.jesse.game.content.slayer.RegularTask.TZTOK_JAD, org.jesse.game.content.slayer.RegularTask.TZTOK_JAD.getEnumName(), amount, amount, master);
    }

    public org.jesse.game.content.slayer.Assignment getTzKalZukAssignment(final org.jesse.game.content.slayer.SlayerMaster master) {
        final int amount = player.getCombatAchievements().hasTierCompleted(CATierType.GRANDMASTER) ? 3 : 1;
        return new org.jesse.game.content.slayer.Assignment(player, this, org.jesse.game.content.slayer.RegularTask.TZKAL_ZUK, org.jesse.game.content.slayer.RegularTask.TZKAL_ZUK.getEnumName(), amount, amount, master);
    }
    ...
    public boolean isAssignable(final SlayerTask task, final org.jesse.game.content.slayer.SlayerMaster master) {
        final Skills skills = player.getSkills();
    ...
    public void sendTaskInformation() {
        ...
        if (assignment.getMaster().equals(org.jesse.game.content.slayer.SlayerMaster.KONAR_QUO_MATEN) && area != null) {
    ...
    public org.jesse.game.content.slayer.Assignment generateSpecificBossTask(final org.jesse.game.content.slayer.SlayerMaster master, BossTask task) {
        return new org.jesse.game.content.slayer.Assignment(player, this, task, task.getEnumName(), 0, 0, master);
    }
    ...
    void refreshBlockedTasks() {
        ...
        for (int i = 0; i < BANNED_SLOT_VARBITS.length; i++) {
            final org.jesse.game.content.slayer.RegularTask task = bannedTasks.get(i);
    ...
    public org.jesse.game.content.slayer.Assignment getAssignment() {
        return assignment;
    }

    public org.jesse.game.content.slayer.SlayerMaster getMaster() {
        return master;
    }

    public void setMaster(org.jesse.game.content.slayer.SlayerMaster master) {
        this.master = master;
    }
    ...
    public org.jesse.game.content.slayer.Assignment getAssignment(@NotNull org.jesse.game.content.slayer.RegularTask task) {
