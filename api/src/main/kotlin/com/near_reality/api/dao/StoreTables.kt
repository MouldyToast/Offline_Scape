...
object BundleItems : IntIdTable("bundle_items") {
    val bundleId = integer("bundle_id")
    val itemId = integer("item_id")
    val amount = integer("amount")
}

class BundleItemEntity(id: EntityID<Int>) : IntEntity(id) {
    companion object : IntEntityClass<BundleItemEntity>(BundleItems)
    var bundleId by BundleItems.bundleId
    var itemId by BundleItems.itemId
    var amount by BundleItems.amount
    fun toApiModel() = CreditStoreBundleItem(
        bundle = bundleId,
        itemId = itemId,
        amount = amount
    )
