...
class Ropeswing : AgilityCourseObstacle(BarbarianOutpostCourse::class.java, 1) {
    ...
    companion object {
        private val START_LOC = Location(2551, 3554, 0)
        private val SWINGING_ANIM = Animation(751)
        private val ROPE_ANIM = Animation(497)
        private val FORCE_MOVEMENT: ForceMovement =
            ForceMovement(Location(2551, 3553, 0), 30, Location(2551, 3549, 0), 60, ForceMovement.SOUTH)
    }
}
