...
public interface SpecialAttackScript {
	...
	Projectile DAWNBRINGER_PROJ = new Projectile(1544, 92, 60, 51, 23, 25, 64, 5);
	Projectile DESCENT_OF_DRAGONS_FIRST_PROJ = new Projectile(1099, 120, 80, 40, 20, 18, 0, 5);
	Projectile DESCENT_OF_DRAGONS_SECOND_PROJ = new Projectile(1099, 120, 80, 40, 30, 3, 0, 5);
	Projectile DESCENT_OF_DARKNESS_FIRST_PROJ = new Projectile(1101, 120, 80, 40, 20, 18, 0, 5);
	Projectile DESCENT_OF_DARKNESS_SECOND_PROJ = new Projectile(1101, 120, 80, 40, 30, 3, 0, 5);
	Projectile SNAPSHOT_FIRST_PROJ = new Projectile(249, 168, 120, 21, 15, 3, 0, 5);
	Projectile SNAPSHOT_SECOND_PROJ = new Projectile(249, 168, 120, 66, 15, 0, 0, 5);
	Projectile ARMADYL_EYE_PROJ = new Projectile(301, 168, 120, 40, 15, 10, 64, 5);
	Projectile SNIPE_PROJ = new Projectile(698, 168, 120, 40, 15, 10, 64, 5);
	Projectile ANNIHILATE_PROJ = new Projectile(698, 168, 120, 40, 15, 10, 64, 5);
	Projectile SOULSHOT_PROJ = new Projectile(473, 168, 120, 40, 5, 3, 0, 5);
    Projectile CHAINHIT_PROJ = new Projectile(258, 160, 144, 41, 0, 5, 11, 5);
    Projectile HAMSTRING_PROJ = new Projectile(1625, 168, 120, 40, 15, 3, 64, 5);
    Projectile PHANTOM_STRIKE_PROJ = new Projectile(1622, 168, 120, 40, 15, 3, 64, 5);
    Projectile CHAINHIT_CHAIN_PROJ = new Projectile(258, 160, 144, 61, 0, 8, 11, 5);
	Projectile MOMENTUM_THROW_PROJ = new Projectile(1318, 136, 120, 40, 15, 3, 64, 5);
	Projectile TOXIC_SIPHON_PROJ = new Projectile(1043, 140, 144, 32, 21, 0, 105, 7);
	Projectile DUALITY_REGULAR_PROJ = new Projectile(699, 160, 144, 25, 21, 0, 11, 5);
	Projectile DUALITY_POISONOUS_PROJ = new Projectile(1629, 160, 144, 25, 21, 0, 11, 5);
	...
	ForceTalk SANCTUARY_FORCETALK = new ForceTalk("No More Glabay!");
