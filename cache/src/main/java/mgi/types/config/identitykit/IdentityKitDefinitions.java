...
public final class IdentityKitDefinitions implements Definitions {
    ...
    public static Int2ObjectOpenHashMap<IdentityKitDefinitions> modelIdToDefinitions = new Int2ObjectOpenHashMap<>();
    ...
    private static final List<Integer> bootStyle = new ArrayList<>(12);
    private static final List<Integer> gloveStyle = new ArrayList<>(12);
    ...
    public static int getBootstyle(final int index) {
        if (index < 0 || index >= bootStyle.size()) {
            return 0;
        }
        return bootStyle.get(index);
    }


    public static int getGlovestyle(final int index) {
        if (index < 0 || index >= gloveStyle.size()) {
            return 0;
        }
        return gloveStyle.get(index);
    }
