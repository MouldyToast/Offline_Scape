...
class Region10908 : NPCSpawnsScript() {

    init {
        KURASK(2694, 9995, 0, SOUTH, 7)
        KURASK_411(2694, 9999, 0, SOUTH, 4)
        KURASK(2698, 9992, 0, SOUTH, 7)
        KURASK(2699, 10001, 0, SOUTH, 7)
        JELLY(2699, 10029, 0, SOUTH, 6)
        KURASK(2701, 9996, 0, SOUTH, 7)
        JELLY_438(2701, 10023, 0, SOUTH, 3)
        JELLY_441(2701, 10027, 0, SOUTH, 6)
        JELLY_442(2703, 10025, 0, SOUTH, 6)
        JELLY_438(2703, 10031, 0, SOUTH, 3)
        JELLY_442(2704, 10028, 0, SOUTH, 6)
        JELLY_439(2706, 10029, 0, SOUTH, 3)
        JELLY_441(2708, 10024, 0, SOUTH, 6)
        ...
        BASILISK(2738, 10008, 0, SOUTH, 6)
        BASILISK(2740, 10003, 0, SOUTH, 6)
        BASILISK(2740, 10014, 0, SOUTH, 6)
        BASILISK(2742, 10008, 0, SOUTH, 6)
        BASILISK(2743, 10018, 0, SOUTH, 6)
        BASILISK(2745, 10002, 0, SOUTH, 6)
        BASILISK(2746, 10006, 0, SOUTH, 6)
        BASILISK(2746, 10015, 0, SOUTH, 6)
