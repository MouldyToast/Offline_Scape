...
import com.near_reality.game.content.wilderness.king_black_dragon.KingBlackDragon
...
/**
 * Represents the King black dragon npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaKingBlackDragon(override val config: PvmArenaNpc.SpawnConfig) :
    KingBlackDragon(KING_BLACK_DRAGON, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
