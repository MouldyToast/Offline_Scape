...
/**
 * Represents the Dagannoth rex npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaDagannothRex(override val config: PvmArenaNpc.SpawnConfig) :
    DagannothKing(DAGANNOTH_REX, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
