...
import org.jesse.game.content.chambersofxeric.greatolm.FireWallNPC;
...
import org.jesse.game.content.skills.magic.spells.EntitySpell;
import org.jesse.game.content.skills.magic.spells.arceuus.*;
...
import org.jesse.game.world.entity.player.action.combat.magic.spelleffect.*;
...
import static org.jesse.game.content.skills.magic.Spellbook.ANCIENT;
import static org.jesse.game.content.skills.magic.Spellbook.NORMAL;
import static org.jesse.game.world.entity.player.action.combat.CombatUtilities.ANCIENT_MULTI_CAST;
...
public enum CombatSpell implements EntitySpell {
	...
	WIND_STRIKE(NORMAL, 2, 5.5, new Animation(1162),
            ...
            new Projectile(91, 172, 124, 51, 23, -5, 64, 10)),
	...
	WATER_STRIKE(NORMAL, 4, 7.5, new Animation(1162),
            ...
            new Projectile(94, 172, 124, 51, 23, -5, 64, 10)),
	...
	EARTH_STRIKE(NORMAL, 6, 9.5, new Animation(1162),
            ...
            new Projectile(97, 172, 124, 51, 23, -5, 64, 10)),
	...
	FIRE_STRIKE(NORMAL, 8, 11.5, new Animation(1162),
            ...
            new Projectile(100, 172, 124, 51, 23, -5, 64, 10)),
	...
	WIND_BOLT(NORMAL, 9, 13.5, new Animation(1162),
            ...
            new Projectile(118, 172, 124, 51, 23, -5, 64, 10)),
	...
	WATER_BOLT(NORMAL, 10, 16.5, new Animation(1162),
            ...
            new Projectile(121, 172, 124, 51, 23, -5, 64, 10)),
	...
	EARTH_BOLT(NORMAL, 11, 19.5, new Animation(1162),
            ...
            new Projectile(124, 172, 124, 51, 23, -5, 64, 10)),
	...
	FIRE_BOLT(NORMAL, 12, 22.5, new Animation(1162),
            ...
            new Projectile(127, 172, 124, 51, 23, -5, 64, 10)),
    ...
    WIND_BLAST(NORMAL, 13, 25.5, new Animation(1162),
            ...
            new Projectile(133, 172, 124, 51, 23, -5, 64, 10)),
	...
	FIRE_BLAST(NORMAL, 16, 34.5, new Animation(1162),
            ...
            new Projectile(130, 172, 124, 51, 23, -5, 64, 10)),
    ...
    WIND_WAVE(NORMAL, 17, 36, new Animation(1167),
            ...
            new Projectile(159, 172, 124, 51, 23, -5, 64, 10)),
	...
	WATER_WAVE(NORMAL, 18, 37.5, new Animation(1167),
            ...
            new Projectile(162, 172, 124, 51, 23, -5, 64, 10)),
	...
	EARTH_WAVE(NORMAL, 19, 40, new Animation(1167),
            ...
            new Projectile(165, 172, 124, 51, 23, -5, 64, 10)),
	...
	FIRE_WAVE(NORMAL, 20, 42.5, new Animation(727),
            ...
            new Projectile(156, 172, 124, 51, 23, -5, 64, 10)),
    ...
    WIND_SURGE(NORMAL, 21, 44, new Animation(7855),
            ...
            new Projectile(1456, 172, 124, 51, 23, -5, 64, 10)),
	...
	WATER_SURGE(NORMAL, 22, 46, new Animation(7855),
            ...
            new Projectile(1459, 172, 124, 51, 23, -5, 64, 10)),
	...
	EARTH_SURGE(NORMAL, 23, 48, new Animation(7855),
            ...
            new Projectile(1462, 172, 124, 51, 23, -5, 64, 10)),
	...
	FIRE_SURGE(NORMAL, 24, 61, new Animation(7855),
            ...
            new Projectile(1465, 172, 124, 51, 23, -5, 64, 10)),
    ...
    CONFUSE(NORMAL, 0, 13, new Animation(1163),
            ...
            new Projectile(103, 144, 124, 61, 23, -15, 64, 10),
    ...
    WEAKEN(NORMAL, 0, 21, new Animation(1164),
            ...
            new Projectile(106, 144, 124, 44, 23, 2, 64, 10),
	...
	CURSE(NORMAL, 0, 29, new Animation(1165),
            ...
            new Projectile(109, 172, 124, 51, 23, -5, 64, 10),
    ...
    BIND(NORMAL, 0, 30, new Animation(1161),
            ...
            new Projectile(178, 180, 0, 75, 23, -29, 64, 10),
    ...
    VULNERABILITY(NORMAL, 0, 76, new Animation(718),
            ...
            new Projectile(168, 144, 124, 34, 23, 12, 64, 10),
    ...
    ENFEEBLE(NORMAL, 0, 83, new Animation(728),
            ...
            new Projectile(171, 144, 124, 48, 23, -2, 64, 10),
    ...
    STUN(NORMAL, 0, 90, new Animation(729),
            ...
            new Projectile(174, 144, 124, 52, 23, -6, 64, 10),
	...
	CRUMBLE_UNDEAD(NORMAL, 15, 24.5, new Animation(724),
            ...
            new Projectile(146, 124, 124, 46, 23, 0, 64, 5)) {
		@Override
		public boolean canCast(final Player player, final Entity target) {
	...
	ICE_RUSH(ANCIENT, 16, 34, new Animation(1978),
            ...
            new Projectile(360, 172, 0, 51, 23, -5, 64, 10),
            new BindEffect(8)),
	...
	ICE_BURST(ANCIENT, 22, 40, ANCIENT_MULTI_CAST,
            ...
            new Projectile(366, 172, 0, 51, 23, -5, 64, 10),
            new BindEffect(16)),
    ...
    SMOKE_BARRAGE(ANCIENT, 27, 48, new Animation(1979),
            ...
            new Projectile(390, 172, 124, 51, 23, -5, 64, 10),
            new SmokeEffect(4)),
    ...
    TRIDENT_OF_THE_SEAS(null, 20, 0, new Animation(1167),
            ...
            new Projectile(1252, 92, 60, 51, 23, 10, 64, 5)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
	...
	TRIDENT_OF_THE_SWAMP(null, 23, 0, new Animation(1167),
            ...
            new SoundEffect(178, 0, 0), new SoundEffect(1460, 10, -1),
            new Projectile(1040, 92, 60, 51, 23, 25, 64, 5)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
            if (target instanceof Player && WildernessArea.isWithinWilderness(target.getX(), target.getY())) {
    ...
    SANGUINESTI_STAFF(null, 24, 0, new Animation(1167),
            ...
            new SoundEffect(178, 0, 0), new SoundEffect(1460, 10, -1),
            new Projectile(1539, 92, 60, 51, 23, 25, 64, 5), (player, target, damage) -> {
    ...
    DAWNBRINGER(null, 24, 0, new Animation(1167),
            ...
            new SoundEffect(178, 0, 0), new SoundEffect(1460, 10, -1),
            new Projectile(1544, 92, 60, 51, 23, 25, 64, 5)) {
        @Override
        public boolean canCast(final Player player, final Entity target) {
    ...
    GHOSTLY_GRASP(Spellbook.ARCEUUS, 12, 22.5, new Animation(8972),
            ...
            new Projectile(-1, 172, 124, 0, 23, 30, 64, 0),
    ...
    DARK_LURE(Spellbook.ARCEUUS, 0, 60.0, new Animation(8974),
            ...
            new Projectile(1883, 124, 124, 46, 8, 0, 64, 10),
            new DarkLureEffect()) {
        @Override
    ...
    INFERIOR_DEMONBANE(Spellbook.ARCEUUS, 16, 27.0, new Animation(8977),
            ...
            new Projectile(-1, 172, 124, 0, 23, 60, 64, 0)) {
        @Override
        public boolean canCast(Player player, Entity target) {
    ...
    THAMMARONS_SCEPTRE(null, 25, 0, new Animation(1167),
            ...
            new SoundEffect(5046, 10, 0), new SoundEffect(5041, 10, -1),
            new Projectile(2340, 124, 124, 51, 23, -5, 64, 10)
    ),

    ACCURSED_SCEPTRE(null, 27, 0, new Animation(1167),
            null, new Graphics(292, -1, 0),
            new SoundEffect(5046, 10, 0), new SoundEffect(5041, 10, -1),
            new Projectile(2337, 124, 124, 51, 23, -5, 64, 10)
    ),

    WARPED_SCEPTRE(null, 24, 0, new Animation(10501),
            new Graphics(2567, 0, 0), new Graphics(2568, 100, 64),
            new SoundEffect(178, 10, 0), new SoundEffect(472, 10, -1),
            new Projectile(2569, 200, 124, 56, 23, -5, 64, 10)
    ),
	...
	private static Projectile spellProjectile(final int id) {
	    return new Projectile(id, 172, 124, 51, 23, -5, 64, 10);
    }
