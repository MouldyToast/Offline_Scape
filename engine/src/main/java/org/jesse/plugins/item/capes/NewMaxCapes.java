...
import org.jesse.game.content.skills.magic.spells.teleports.ItemTeleport;
...
import static org.jesse.game.content.skills.magic.spells.teleports.ItemTeleport.*;
...
public class NewMaxCapes extends ItemPlugin {
    ...
    private static final ItemTeleport[] TELEPORTS = {
        MAX_CAPE_WARRIORS_GUILD,
        MAX_CAPE_FISHING_GUILD,
        MAX_CAPE_CRAFTING_GUILD,
        MAX_CAPE_FARMING_GUILD,
        MAX_CAPE_OTTOS_GROTTO
    };
...
//        bind("Farm Teleport", (player, item, slotId) -> ArdougneCloak.ardougneFarmTeleport(player, item));
...
//        });
    ...
    public static void sendSpellbookDialogue(final Player player) {
    ...
    public static void sendPOHPortalTeleports(final Player player) {
