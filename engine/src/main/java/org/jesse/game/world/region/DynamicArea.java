...
public abstract class DynamicArea extends PolygonRegionArea implements RandomEventRestrictionPlugin, DropPlugin {
    private static final Logger log = NearRealityLogger.getLogger(DynamicArea.class);
    ...
    public Location getStaticLocation(final int x, final int y, final int height) {
        return getStaticLocation(new Location(x, y, height));
    }
