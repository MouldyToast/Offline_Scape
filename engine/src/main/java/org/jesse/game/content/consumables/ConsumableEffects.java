...
import static org.jesse.game.world.entity.player.SkillConstants.*;
...
public final class ConsumableEffects {
    ...
    public static void applyAntifire(final Player player, final int ticks) {
        ...
        player.getVarManager().sendBitInstant(ANTIFIRE_REFRESHES_REMAINING, 0);
        player.getVarManager().sendBitInstant(ANTIFIRE_REFRESHES_REMAINING, (ticks / 30));
    }
    ...
    public static void applySuperAntifire(final Player player, final int ticks) {
        ...
        player.getVarManager().sendBitInstant(SUPER_ANTIFIRE_REFRESHES_REMAINING, 0);
        player.getVarManager().sendBitInstant(SUPER_ANTIFIRE_REFRESHES_REMAINING, (ticks / 20));
    }
