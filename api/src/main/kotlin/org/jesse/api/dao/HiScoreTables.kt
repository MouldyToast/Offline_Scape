...
object UserSkillStats : IntIdTable("hiscores_skills") {
    val user = reference("username", Users.username).uniqueIndex()
    val totalExperience = long("total_experience").default(Skill.defaultTotalExperience.toLong())
