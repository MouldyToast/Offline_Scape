...
import org.jesse.game.world.entity.npc.impl.slayer.DemonicGorilla
    ...
    PvmArenaNpc
{
    ...
    override fun checkAggressivity(): Boolean =
        superCheckAggressivity() // Demonic gorilla overrides this, bad design, but it is what it is.
}
