...
//    VERACS_PLATESKIRT_25(DegradeType.TICKS, 4997, 4998, 22500, 0),
    ...
    VESTAS_HELM(DegradeType.OUTGOING_HIT, ItemId.VESTAS_HELM, -1, 1500, 0),
...
//    ICE_GLOVES(DegradeType.USE, 1580, -1, 150, 0),
    ...
    DIZANAS_QUIVER_L(DegradeType.OUTGOING_HIT, ItemId.DIZANAS_QUIVER_L, ItemId.DIZANAS_QUIVER_UNCHARGED_L, 20_000, 0,
            item -> new Item[]{new Item(ItemId.SUNFIRE_SPLINTERS, item.getCharges())}
    ),
    ;
