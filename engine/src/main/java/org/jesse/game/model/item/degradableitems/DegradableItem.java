package org.jesse.game.model.item.degradableitems;

import org.jesse.game.content.crystal.recipes.chargeable.CrystalArmour;
...
import org.jesse.game.content.tombsofamascut.TOAConstants;
import org.jesse.game.item.Item;
import org.jesse.game.item.ids.ItemId;
import org.jesse.plugins.item.BloodEssence;
import org.jesse.plugins.item.TomeOfFire;
import org.jesse.plugins.itemonitem.SerpentineHelmetChargingAction;
...
//    VERACS_PLATESKIRT_25(DegradeType.TICKS, 4997, 4998, 22500, 0),
    ...
    CORRUPTED_BOW_BASIC(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_BOW_BASIC, -1, 100_000, 0),
    CORRUPTED_BOW_ATTUNED(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_BOW_ATTUNED, -1, 100_000, 0),
    CORRUPTED_BOW_PERFECTED(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_BOW_PERFECTED, -1, 100_000, 0),
    CRYSTAL_BOW_NEW(DegradeType.OUTGOING_HIT, 4212, 4214, 2500, 2499),
    CRYSTAL_BOW_10(DegradeType.OUTGOING_HIT, 4214, 4215, 2499, 2250),
    ...
    IMBUED_CRYSTAL_BOW_NEW(DegradeType.OUTGOING_HIT, 11748, 11749, 2500, 2499),
    IMBUED_CRYSTAL_BOW_10(DegradeType.OUTGOING_HIT, 11749, 11750, 2499, 2250),
    ...
    MORRIGANS_COIF(DegradeType.OUTGOING_HIT, ItemId.MORRIGANS_COIF, -1, 1500, 0),
    MORRIGANS_LEATHER_BODY(DegradeType.OUTGOING_HIT, ItemId.MORRIGANS_LEATHER_BODY, -1, 1500, 0),
    MORRIGANS_LEATHER_CHAPS(DegradeType.OUTGOING_HIT, ItemId.MORRIGANS_LEATHER_CHAPS, -1, 1500, 0),
    VESTAS_CHAINBODY(DegradeType.OUTGOING_HIT, ItemId.VESTAS_CHAINBODY, -1, 1500, 0),
    VESTAS_PLATESKIRT(DegradeType.OUTGOING_HIT, ItemId.VESTAS_PLATESKIRT, -1, 1500, 0),
    STATIUSS_FULL_HELM(DegradeType.OUTGOING_HIT, ItemId.STATIUSS_FULL_HELM, -1, 1500, 0),
    STATIUSS_PLATEBODY(DegradeType.OUTGOING_HIT, ItemId.STATIUSS_PLATEBODY, -1, 1500, 0),
    STATIUSS_PLATELEGS(DegradeType.OUTGOING_HIT, ItemId.STATIUSS_PLATELEGS, -1, 1500, 0),
    ZURIELS_HOOD(DegradeType.OUTGOING_HIT, ItemId.ZURIELS_HOOD, -1, 1500, 0),
    ZURIELS_ROBE_TOP(DegradeType.OUTGOING_HIT, ItemId.ZURIELS_ROBE_TOP, -1, 1500, 0),
    ZURIELS_ROBE_BOTTOM(DegradeType.OUTGOING_HIT, ItemId.ZURIELS_ROBE_BOTTOM, -1, 1500, 0),
    ...
    ACCURSED_SCEPTRE(DegradeType.OUTGOING_HIT, ItemId.ACCURSED_SCEPTRE,  ItemId.ACCURSED_SCEPTRE_U, 17000, 0),
    ACCURSED_SCEPTRE_A(DegradeType.OUTGOING_HIT, ItemId.ACCURSED_SCEPTRE_A, ItemId.ACCURSED_SCEPTRE_AU, 17000, 0),
...
//    ICE_GLOVES(DegradeType.USE, 1580, -1, 150, 0),
    ...
    //WARPED_SCEPTRE(DegradeType.USE, 28585, 28583, 0, 0, item -> {
    //    final int chaos = item.getNumericAttribute("warpedSceptreChaos").intValue();
    //    final int earth = item.getNumericAttribute("warpedSceptreEarth").intValue();
    //    return new Item[]{new Item(557, earth), new Item(562, chaos)};    }),
    WARPED_SCEPTRE(DegradeType.TRIDENT, ItemId.WARPED_SCEPTRE, ItemId.WARPED_SCEPTRE_UNCHARGED, 20_000, 0),
    ...
    CORRUPTED_VOIDWAKER(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_VOIDWAKER, -1, 100, 0),
    CORRUPTED_DRAGON_CLAWS(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_DRAGON_CLAWS, -1, 100, 0),
    CORRUPTED_AGS(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_ARMADYL_GODSWORD, -1, 100, 0),
    CORRUPTED_SCYTHE_OF_VITUR(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_SCYTHE_OF_VITUR, -1, 1000, 0),

    CORRUPTED_VOLLY(DegradeType.SPELL, ItemId.CORRUPTED_VOLATILE_NIGHTMARE_STAFF, -1, 100, 0),
    CORRUPTED_THUMEKEN_SHADOW(DegradeType.TRIDENT, ItemId.CORRUPTED_TUMEKENS_SHADOW, -1, 1000, 0),
    CORRUPTED_TWISTED_BOW(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_TWISTED_BOW, -1, 1000, 0),
    CORRUPTED_DARK_BOW(DegradeType.OUTGOING_HIT, ItemId.CORRUPTED_DARK_BOW, -1, 100, 0),

    ECHO_BOOTS(DegradeType.RECOIL, ItemId.ECHO_BOOTS, ItemId.ECHO_BOOTS, 60_000, 0),
    DIZANAS_QUIVER(DegradeType.OUTGOING_HIT, ItemId.DIZANAS_QUIVER, ItemId.DIZANAS_QUIVER_UNCHARGED, 20_000, 0,
            item -> new Item[]{new Item(ItemId.SUNFIRE_SPLINTERS, item.getCharges())}
    ),
    DIZANAS_QUIVER_L(DegradeType.OUTGOING_HIT, ItemId.DIZANAS_QUIVER_L, ItemId.DIZANAS_QUIVER_L_UNCHARGED, 20_000, 0,
            item -> new Item[]{new Item(ItemId.SUNFIRE_SPLINTERS, item.getCharges())}
    ),
    ;
