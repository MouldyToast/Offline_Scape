package org.jesse.game.content.skills.magic;

import org.jesse.game.content.skills.magic.resources.*;
...
public final class SpellState {
	...
	private static final int[] BLIGHTED_SACKS = new int[] { 24613, 24615, 24607, 24621, 26705, 26704 };
	...
	static {
		...
		BLIGHTED_SACKS_MAP.put("bind", 24613);
		BLIGHTED_SACKS_MAP.put("snare", 24613);
		...
		ALT_RUNES = new Int2ObjectOpenHashMap<>(7);
