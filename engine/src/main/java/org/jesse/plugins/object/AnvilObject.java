...
import org.jesse.plugins.dialogue.skills.AncientForgeD;
import org.jesse.plugins.dialogue.skills.BarbarianSmithingD;
import org.jesse.plugins.dialogue.skills.BluriteSmithingD;
import org.jesse.plugins.interfaces.SmithingInterface;

import static org.jesse.game.world.entity.player.privilege.MemberRank.TOPAZ;
...
public class AnvilObject implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (player.getMemberRank().equalToOrGreaterThan(TOPAZ) && object.getLocation().equals(3358, 8156, 2)) {
            skipLevelCheck = true;
        }
