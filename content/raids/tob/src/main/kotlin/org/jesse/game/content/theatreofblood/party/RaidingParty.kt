package org.jesse.game.content.theatreofblood.party
...
import org.jesse.game.content.theatreofblood.interfaces.PartiesOverviewInterface
...
internal data class RaidingParty(val id: Int, val originalLeader: Player) {
    ...
    fun Player.updateInformation() {
        if (area is TheatreRoom) {
            logger.warn("Tried opening tob information while inside raid.", Exception("Stack trace"))
            return
        }
