...
/**
 * @author Kris | 8. juuli 2018 : 20:25:54
 * @see <a href="https://www.rune-server.ee/members/kris/">Rune-Server profile</a>}
 * @see <a href="https://rune-status.net/members/kris.354/">Rune-Status profile</a>}
 */
public final class ChargeFireOrb implements ObjectSpell {
	...
	public boolean spellEffect(final Player player, final WorldObject object) {
        if (!object.getName().equals("Obelisk of Fire")) {
            player.sendMessage("Nothing interesting happens.");
            return false;
        }
		player.getDialogueManager().start(new ChargeOrbSpellD(player, ChargeOrbSpellData.CHARGE_FIRE_ORB, this));
		return false;
	}
