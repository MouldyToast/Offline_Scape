...
import static org.jesse.game.content.skills.fishing.FishingTool.*;
...
public enum SpotDefinitions {
    ...
    NET(870330, new int[] {1530, 7947, 1544, 1517, 1514, 1518, 1521, 1523, 1524, 1532, 1525, 7155, 1528, 7467, 7462, 1517, 3913, 1530, 7459, 7468, 7469, 7948, 10513}, new String[] {"Net", "Small Net"}, SMALL_FISHING_NET, FishDefinitions.SHRIMPS, FishDefinitions.ANCHOVIES),
    ...
    CAGE(116129, new int[] {1533, 1510, 2146, 1519, 1522, 7460, 7465, 7199, 3914, 3657, 1535, 7470, 5820, 10515}, new String[] {"Cage"}, LOBSTER_POT, FishDefinitions.LOBSTER),
    BASIC_HARPOON(257770, new int[] {1533, 2146, 1510, 1519, 1522, 7460, 7465, 7199, 3914, 3657, 7470, 5820, 4316, 10515}, new String[] {"Harpoon"}, HARPOON, FishDefinitions.TUNA, FishDefinitions.SWORDFISH),
    ...
    BIG_NET(1147827, new int[] {1511, 5821, 1534, 1520, 7200, 7466, 3915, 7461, 4477, 4476, 5233, 3419, 10514}, new String[] {"Net", "Big Net"}, BIG_FISHING_NET, FishDefinitions.MACKERAL, FishDefinitions.COD, FishDefinitions.BASS),
    SHARK_HARPOON(82243, new int[] {1511, 1534, 7200, 1520, 7466, 3915, 7461, 4477, 4476, 5233, 3419, 10514}, new String[] {"Harpoon"}, HARPOON, FishDefinitions.SHARK),
