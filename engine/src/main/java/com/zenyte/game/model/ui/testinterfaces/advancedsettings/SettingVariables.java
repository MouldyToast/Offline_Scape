...
public class SettingVariables {
    ...
    public static final int MAX_HIT_HITSPLATS_VARBIT_ID = 14196;
    ...
    public static final int AMMO_PICKING_BEHAVIOUR_VARBIT_ID = 5697;
    public static final int RUNE_PICKING_BEHAVIOUR_VARBIT_ID = 5698;

    private static final Map<Integer, Integer> SLIDER_SETTING_VARBITS = ImmutableMap.<Integer, Integer>builder().put(SettingStructs.INTERFACE_SCALING_STRUCT_ID, INTERFACE_SCALING_VARBIT_ID).build();

    private static final Map<Integer, Integer> DROPDOWN_SETTING_VARBITS = ImmutableMap.<Integer, Integer>builder().put(SettingStructs.LAST_MAN_STANDING_FOG_COLOUR_STRUCT_ID, LAST_MAN_STANDING_FOG_COLOUR_VARBIT_ID).put(SettingStructs.MUSIC_AREA_MODE_STRUCT_ID, MUSIC_AREA_MODE_VARBIT_ID).put(SettingStructs.FRIEND_LOGINLOGOUT_MESSAGES_STRUCT_ID, FRIEND_LOGINLOGOUT_MESSAGES_VARBIT_ID).put(SettingStructs.CHAT_TIMESTAMPS_STRUCT_ID, CHAT_TIMESTAMPS_VARBIT_ID).put(SettingStructs.SELECT_FUNCTIONMODE_STRUCT_ID, SELECT_FUNCTIONMODE_VARBIT_ID).put(SettingStructs.CHAT_BOX_SCROLLBAR_POSITION_STRUCT_ID, CHAT_BOX_SCROLLBAR_POSITION_VARBIT_ID).put(SettingStructs.MODERN_LAYOUT_SIDE_PANEL_VISUAL_APPEARANCE_STRUCT_ID, MODERN_LAYOUT_SIDE_PANEL_VISUAL_APPEARANCE_VARBIT_ID).put(SettingStructs.NUMBER_OF_MODIFIED_STATS_TO_SHOW_STRUCT_ID, NUMBER_OF_MODIFIED_STATS_TO_SHOW_VARBIT_ID).put(SettingStructs.WOODCUTTING_RESPAWN_TIMER_STRUCT_ID, WOODCUTTING_RESPAWN_TIMER_VARBIT_ID).put(SettingStructs.ORE_RESPAWN_TIMER_STRUCT_ID, ORE_RESPAWN_TIMER_VARBIT_ID).put(SettingStructs.ANTI_DRAG_ENABLE_KEY_STRUCT_ID, ANTI_DRAG_ENABLE_KEY_VARBIT_ID).put(SettingStructs.CTRLCLICK_TO_INVERT_RUN_MODE_STRUCT_ID, CTRLCLICK_TO_INVERT_RUN_MODE_VARBIT_ID).put(SettingStructs.ANTI_DRAG_DISABLE_KEY_STRUCT_ID, ANTI_DRAG_DISABLE_KEY_VARBIT_ID).put(SettingStructs.QUEST_LIST_TEXT_SIZE_STRUCT_ID, QUEST_LIST_TEXT_SIZE_VARBIT_ID).put(SettingStructs.QUEST_LIST_SORTING_STRUCT_ID, QUEST_LIST_SORTING_VARBIT_ID).put(SettingStructs.SHOW_QUESTS_YOU_LACK_THE_REQUIREMENTS_FOR_STRUCT_ID, SHOW_QUESTS_YOU_LACK_THE_REQUIREMENTS_FOR_VARBIT_ID).put(SettingStructs.SHOW_QUESTS_YOU_LACK_THE_RECOMMENDED_STATS_FOR_STRUCT_ID, SHOW_QUESTS_YOU_LACK_THE_RECOMMENDED_STATS_FOR_VARBIT_ID).build();

    private static final Map<Integer, Integer> DROPDOWN_SETTING_VARPS = ImmutableMap.<Integer, Integer>builder().put(SettingStructs.PLAYER_ATTACK_OPTIONS_STRUCT_ID, PLAYER_ATTACK_OPTIONS_VARP_ID).put(SettingStructs.NPC_ATTACK_OPTIONS_STRUCT_ID, NPC_ATTACK_OPTIONS_VARP_ID).build();

    private static final Map<Integer, Integer> KEYBIND_SETTING_VARBITS = ImmutableMap.<Integer, Integer>builder().put(SettingStructs.COMBAT_TAB_KEYBIND_STRUCT_ID, COMBAT_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.PRAYER_TAB_KEYBIND_STRUCT_ID, PRAYER_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.SETTINGS_TAB_KEYBIND_STRUCT_ID, SETTINGS_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.SKILLS_TAB_KEYBIND_STRUCT_ID, SKILLS_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.MAGIC_TAB_KEYBIND_STRUCT_ID, MAGIC_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.EMOTES_TAB_KEYBIND_STRUCT_ID, EMOTES_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.JOURNAL_TAB_KEYBIND_STRUCT_ID, JOURNAL_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.FRIENDS_LIST_KEYBIND_STRUCT_ID, FRIENDS_LIST_KEYBIND_VARBIT_ID).put(SettingStructs.FRIENDS_CHAT_TAB_KEYBIND_STRUCT_ID, FRIENDS_CHAT_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.INVENTORY_TAB_KEYBIND_STRUCT_ID, INVENTORY_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.ACCOUNT_MANAGEMENT_TAB_KEYBIND_STRUCT_ID, ACCOUNT_MANAGEMENT_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.MUSIC_TAB_KEYBIND_STRUCT_ID, MUSIC_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.EQUIPMENT_TAB_KEYBIND_STRUCT_ID, EQUIPMENT_TAB_KEYBIND_VARBIT_ID).put(SettingStructs.LOGOUT_TAB_KEYBIND_STRUCT_ID, LOGOUT_TAB_KEYBIND_VARBIT_ID).build();

    private static final Map<Integer, Integer> KEYBIND_SETTING_VARPS = ImmutableMap.<Integer, Integer>builder().build();

    private static final Map<Integer, Integer> COLOUR_SETTING_VARBITS = ImmutableMap.<Integer, Integer>builder().build();

    private static final Map<Integer, Integer> COLOUR_SETTING_VARPS = ImmutableMap.<Integer, Integer>builder().put(SettingStructs.OPAQUE_PUBLIC_CHAT_STRUCT_ID, OPAQUE_PUBLIC_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_PUBLIC_CHAT_STRUCT_ID, TRANSPARENT_PUBLIC_CHAT_VARP_ID).put(SettingStructs.OPAQUE_PRIVATE_CHAT_STRUCT_ID, OPAQUE_PRIVATE_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_PRIVATE_CHAT_STRUCT_ID, TRANSPARENT_PRIVATE_CHAT_VARP_ID).put(SettingStructs.SPLIT_PRIVATE_CHAT_STRUCT_ID, SPLIT_PRIVATE_CHAT_VARP_ID).put(SettingStructs.OPAQUE_AUTO_CHAT_STRUCT_ID, OPAQUE_AUTO_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_AUTO_CHAT_STRUCT_ID, TRANSPARENT_AUTO_CHAT_VARP_ID).put(SettingStructs.OPAQUE_BROADCAST_STRUCT_ID, OPAQUE_BROADCAST_VARP_ID).put(SettingStructs.TRANSPARENT_BROADCAST_STRUCT_ID, TRANSPARENT_BROADCAST_VARP_ID).put(SettingStructs.SPLIT_BROADCAST_STRUCT_ID, SPLIT_BROADCAST_VARP_ID).put(SettingStructs.OPAQUE_FRIEND_CHAT_STRUCT_ID, OPAQUE_FRIEND_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_FRIEND_CHAT_STRUCT_ID, TRANSPARENT_FRIEND_CHAT_VARP_ID).put(SettingStructs.OPAQUE_CLAN_CHAT_STRUCT_ID, OPAQUE_CLAN_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_CLAN_CHAT_STRUCT_ID, TRANSPARENT_CLAN_CHAT_VARP_ID).put(SettingStructs.OPAQUE_INCOMING_TRADE_REQUEST_STRUCT_ID, OPAQUE_INCOMING_TRADE_REQUEST_VARP_ID).put(SettingStructs.TRANSPARENT_INCOMING_TRADE_REQUEST_STRUCT_ID, TRANSPARENT_INCOMING_TRADE_REQUEST_VARP_ID).put(SettingStructs.OPAQUE_INCOMING_CHALLENGE_REQUEST_STRUCT_ID, OPAQUE_INCOMING_CHALLENGE_REQUEST_VARP_ID).put(SettingStructs.TRANSPARENT_INCOMING_CHALLENGE_REQUEST_STRUCT_ID, TRANSPARENT_INCOMING_CHALLENGE_REQUEST_VARP_ID).put(SettingStructs.OPAQUE_GUEST_CLAN_CHAT_STRUCT_ID, OPAQUE_GUEST_CLAN_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_GUEST_CLAN_CHAT_STRUCT_ID, TRANSPARENT_GUEST_CLAN_CHAT_VARP_ID).put(SettingStructs.TILE_HIGHLIGHT_COLOUR_STRUCT_ID, TILE_HIGHLIGHT_COLOUR_VARP_ID).put(SettingStructs.HIGHLIGHT_HOVERED_TILE_COLOUR_STRUCT_ID, HIGHLIGHT_HOVERED_TILE_COLOUR_VARP_ID).put(SettingStructs.HIGHLIGHT_CURRENT_TILE_COLOUR_STRUCT_ID, HIGHLIGHT_CURRENT_TILE_COLOUR_VARP_ID).put(SettingStructs.HIGHLIGHT_DESTINATION_TILE_COLOUR_STRUCT_ID, HIGHLIGHT_DESTINATION_TILE_COLOUR_VARP_ID).put(SettingStructs.OPAQUE_IRON_GROUP_BROADCASTS_STRUCT_ID, OPAQUE_IRON_GROUP_BROADCASTS_VARP_ID).put(SettingStructs.TRANSPARENT_IRON_GROUP_BROADCASTS_STRUCT_ID, TRANSPARENT_IRON_GROUP_BROADCASTS_VARP_ID).put(SettingStructs.TRANSPARENT_IRON_GROUP_CHAT_STRUCT_ID, TRANSPARENT_IRON_GROUP_CHAT_VARP_ID).put(SettingStructs.TRANSPARENT_CLAN_BROADCASTS_STRUCT_ID, TRANSPARENT_CLAN_BROADCASTS_VARP_ID).put(SettingStructs.OPAQUE_CLAN_BROADCASTS_STRUCT_ID, OPAQUE_CLAN_BROADCASTS_VARP_ID).put(SettingStructs.OPAQUE_IRON_GROUP_CHAT_STRUCT_ID, OPAQUE_IRON_GROUP_CHAT_VARP_ID).put(SettingStructs.COMPLETED_QUEST_TEXT_COLOUR_STRUCT_ID, COMPLETED_QUEST_TEXT_COLOUR_VARP_ID).put(SettingStructs.UNAVAILABLE_QUEST_TEXT_COLOUR_STRUCT_ID, UNAVAILABLE_QUEST_TEXT_COLOUR_VARP_ID).put(SettingStructs.UNSTARTED_QUEST_TEXT_COLOUR_STRUCT_ID, UNSTARTED_QUEST_TEXT_COLOUR_VARP_ID).put(SettingStructs.IN_PROGRESS_QUEST_TEXT_COLOUR_STRUCT_ID, IN_PROGRESS_QUEST_TEXT_COLOUR_VARP_ID).build();

    public static final List<Map<Integer, Integer>> ALL_VARP_SETTINGS = List.of(DROPDOWN_SETTING_VARPS, KEYBIND_SETTING_VARPS, COLOUR_SETTING_VARPS);

    public static final List<Map<Integer, Integer>> ALL_VARBIT_SETTINGS = List.of(
        SLIDER_SETTING_VARBITS,
        DROPDOWN_SETTING_VARBITS,
        KEYBIND_SETTING_VARBITS,
        COLOUR_SETTING_VARBITS
    );

    private static final SettingStructResolver TOGGLE_SETTING_VARPS_RESOLVER = new SettingStructResolvableMap<>(ToggleSettingVarps.values);
    private static final SettingStructResolver TOGGLE_SETTING_VARBITS_RESOLVER = new SettingStructResolvableMap<>(ToggleSettingVarBits.values);

    private static final SettingStructResolver SLIDER_SETTING_VARPS_RESOLVER = new SettingStructResolvableMap<>(SliderSettingVarps.values);
    private static final SettingStructResolver SLIDER_SETTING_VARBITS_RESOLVER = new IntIntMapStructResolver(SLIDER_SETTING_VARBITS);

    private static final SettingStructResolver DROPDOWN_SETTING_VARPS_RESOLVER = new IntIntMapStructResolver(DROPDOWN_SETTING_VARPS);
    private static final SettingStructResolver DROPDOWN_SETTING_VARBITS_RESOLVER = new IntIntMapStructResolver(DROPDOWN_SETTING_VARBITS);

    private static final SettingStructResolver KEYBIND_SETTING_VARPS_RESOLVER = new IntIntMapStructResolver(KEYBIND_SETTING_VARPS);
    private static final SettingStructResolver KEYBIND_SETTING_VARBITS_RESOLVER = new IntIntMapStructResolver(KEYBIND_SETTING_VARBITS);

    private static final SettingStructResolver COLOUR_SETTING_VARPS_RESOLVER = new IntIntMapStructResolver(COLOUR_SETTING_VARPS);
    private static final SettingStructResolver COLOUR_SETTING_VARBITS_RESOLVER = new IntIntMapStructResolver(COLOUR_SETTING_VARBITS);

    public static int getVariableValue(Setting setting, Player player) {
        final SettingType type = setting.getType();
        return switch (type) {
            case TOGGLE -> getVariableValue(setting, player, TOGGLE_SETTING_VARPS_RESOLVER, TOGGLE_SETTING_VARBITS_RESOLVER);
            case SLIDER -> getVariableValue(setting, player, SLIDER_SETTING_VARPS_RESOLVER, SLIDER_SETTING_VARBITS_RESOLVER);
            case DROPDOWN -> getVariableValue(setting, player, DROPDOWN_SETTING_VARPS_RESOLVER, DROPDOWN_SETTING_VARBITS_RESOLVER);
            case KEYBIND -> getVariableValue(setting, player, KEYBIND_SETTING_VARPS_RESOLVER, KEYBIND_SETTING_VARBITS_RESOLVER);
            case COLOUR -> getVariableValue(setting, player, COLOUR_SETTING_VARPS_RESOLVER, COLOUR_SETTING_VARBITS_RESOLVER);
            default -> throw new IllegalArgumentException("Setting '" + setting.getId() + "' uses unsupported type '" + type + "'.");
        };
    }
    ...
    public static void setVariableValue(Setting setting, Player player, int value) {
        final SettingType type = setting.getType();
        switch (type) {
            case TOGGLE -> setVariableValue(setting, player, value, TOGGLE_SETTING_VARPS_RESOLVER, TOGGLE_SETTING_VARBITS_RESOLVER);
            case SLIDER -> setVariableValue(setting, player, value, SLIDER_SETTING_VARPS_RESOLVER, SLIDER_SETTING_VARBITS_RESOLVER);
            case DROPDOWN -> setVariableValue(setting, player, value, DROPDOWN_SETTING_VARPS_RESOLVER, DROPDOWN_SETTING_VARBITS_RESOLVER);
            case KEYBIND -> setVariableValue(setting, player, value, KEYBIND_SETTING_VARPS_RESOLVER, KEYBIND_SETTING_VARBITS_RESOLVER);
            case COLOUR -> setVariableValue(setting, player, value, COLOUR_SETTING_VARPS_RESOLVER, COLOUR_SETTING_VARBITS_RESOLVER);
            default -> throw new IllegalArgumentException("Setting '" + setting.getId() + "' uses unsupported type '" + type + "'.");
        }
    }

    private static int getVariableValue(Setting setting, Player player, SettingStructResolver varps, SettingStructResolver varbits) {
        ...
        if (varbit == null) throw new IllegalStateException("Setting '" + setting.getId() + "' does not define a variable.");
        return player.getVarManager().getBitValue(varbit);
    }

    private static void setVariableValue(Setting setting, Player player, int value, SettingStructResolver varps, SettingStructResolver varbits) {
        final Integer varp = varps.forStruct(setting.getStructId());
        if (varp != null) {
