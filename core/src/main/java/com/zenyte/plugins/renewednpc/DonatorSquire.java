    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                if (!player.getMemberRank().equalToOrGreaterThan(MemberRank.SAPPHIRE)) {
                ...
                options(6, "Choose a location",
                        ContentConstants.SERVER_NAME + " Home",
                    "Mage's Bank",
                    "Forex Enclave",
                    "Donator Island",
                    "Next")
    ...
    public void changeTeleport(Player player, int option) {
        ...
        player.getDialogueManager().start(new Dialogue(player, 16060) {
            ...
            public void buildDialogue() {
                ...
                options("Change home teleport to " + tp.getName() + "?",
                    "Yes, switch my home teleport.",
