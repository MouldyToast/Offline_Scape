...
private const val EMBLEM_RATE: Int = 400
private const val TOTEM_RATE: Int = 500
private const val STATUE_RATE: Int = 600
private const val MEDALLION_RATE: Int = 700
private const val EFFIGY_RATE: Int = 800
private const val RELIC_RATE: Int = 900
private const val CRYSTAL_RATE: Int = 250
private const val AMULET_RATE: Int = 1100
private const val VIGGORAS_RATE: Int = 2850
private const val CRAWS_RATE: Int = 2850
private const val THAMMARONS_RATE: Int = 2850
private const val PRIMAL_RATE: Int = 2850


@Suppress("unused")
class RevenantPyrefiendProcessor : DropProcessor() {
    ...
    override fun ids(): IntArray {
        return intArrayOf(NpcId.REVENANT_PYREFIEND)
    }
