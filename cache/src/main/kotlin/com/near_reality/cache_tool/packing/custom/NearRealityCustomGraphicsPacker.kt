    ...
    fun pack() {
        assetsBase("assets/osnr/custom_graphics/") {
            ...
            SpotAnimationDefinition.get(1199).copy(6001).apply {
                widthScale = 56
                heightScale = 56
                modelId = "copy_kreearra_proj".model()
                animationId = 25000
                pack()
            }
            // Snow ball rolling with long snow patch removed
            packGfx(1222,6003, modelId = "snowball_gfx".model())

            packGfx(16,6004, modelId = "arma_arrow_gfx".model(), scale = 0.75) // armadyl arrow projectile
            packGfx(25,6005, modelId = "arma_arrow_gfx".model(), scale = 0.75) // armadyl arrow drawback
            packGfx(16,6006, modelId = "bandos_arrow_gfx".model(), scale = 0.75) // bandos arrow projectile
            packGfx(25,6007, modelId = "bandos_arrow_gfx".model(), scale = 0.75) // bandos arrow drawback
            packGfx(16,6008, modelId = "sara_arrow_gfx".model(), scale = 0.75) // saradomin arrow projectile
            packGfx(25,6009, modelId = "sara_arrow_gfx".model(), scale = 0.75) // saradomin arrow drawback
            packGfx(16,6010, modelId = "zamorak_arrow_gfx".model(), scale = 0.75) // zamorak arrow projectile
            packGfx(25,6011, modelId = "zamorak_arrow_gfx".model(), scale = 0.75) // zamorak arrow drawback
            ...
            SpotAnimationDefinition.get(1211).copy(6013).apply {
                recolorTo = shortArrayOf(0)
                pack()
            }
        }
