...
public enum WildernessTeleportCommand {
	CORP("corp", "Teleport to a wilderness location.", create(new Location(2967, 4383, 2))),
	FORTY_FOUR("44s", "Teleport to a wilderness location.", create(new Location(2976, 3867))),
	FIFTY("50s", "Teleport to a wilderness location.", create(new Location(3285, 3919))),
	WESTS("wests", "Teleport to a wilderness location.", create(new Location(2979, 3595))),
	EASTS("easts", "Teleport to a wilderness location.", create(new Location(3346, 3666))),
	MB("mb", "Teleport to a wilderness location.", create(new Location(2539, 4716))),
	REVS("revs", "Teleport to a wilderness location.", create(new Location(3079, 3653))),
	...
	CHINS("chins", "Teleport to a wilderness location.", create(new Location(3144, 3770)));


	WildernessTeleportCommand(String command, String description, Teleport teleport) {
		new GameCommands.Command(PlayerPrivilege.PLAYER, command, description, (p, args) -> {
			if (p.isLocked()) {
				return;
			}
			teleport.teleport(p);
