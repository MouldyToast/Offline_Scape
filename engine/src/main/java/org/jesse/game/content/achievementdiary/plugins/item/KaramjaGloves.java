package org.jesse.game.content.achievementdiary.plugins.item;

import org.jesse.game.content.achievementdiary.plugins.DiaryItem;
...
public class KaramjaGloves extends DiaryItem {
    ...
    public void handle() {
        ...
        bind("Slayer Master", (player, item, slotId) -> TeleportCollection.KARAMJA_GLOVES_DURADEL.teleport(player));
    }
