...
class Region13102 : NPCSpawnsScript() {
    ...
    init {
        ...
        DESERT_SNAKE(3271, 2967, 0, SOUTH, 3)
        BANDIT_695(3272, 2977, 0, SOUTH, 9)
        DESERT_SNAKE(3279, 2957, 0, SOUTH, 3)
        BANDIT_695(3280, 2957, 0, SOUTH, 9)
        DESERT_SNAKE(3280, 2975, 0, SOUTH, 3)
        BANDIT_695(3281, 2969, 0, SOUTH, 9)
        DESERT_SNAKE(3284, 2959, 0, SOUTH, 3)
        BANDIT_695(3293, 2959, 0, SOUTH, 9)
        DESERT_SNAKE(3294, 2964, 0, SOUTH, 3)
        DESERT_SNAKE(3295, 2978, 0, SOUTH, 3)
