...
import com.near_reality.game.item.CustomObjectId.DONATOR_OBELISK
...
class DonatorPortalAction : ObjectAction {
    ...
    override fun getObjects(): Array<Any> =
        arrayOf(OBELISK, DONATOR_OBELISK)
    ...
    private fun teleport(location: Location): Teleport {
        return object : Teleport {
            ...
            override fun destination(): Location = location
    ...
    companion object {
        const val OBELISK: Int = DONATOR_OBELISK
        const val OBELISK_2: Int = DONATOR_OBELISK
    }
}
