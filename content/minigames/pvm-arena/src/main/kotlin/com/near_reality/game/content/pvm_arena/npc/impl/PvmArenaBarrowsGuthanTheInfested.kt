...
import com.zenyte.game.content.minigame.barrows.wights.GuthanTheInfested
...
/**
 * Represents the Guthan the Infested npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaBarrowsGuthanTheInfested(override val config: PvmArenaNpc.SpawnConfig):
    GuthanTheInfested(GUTHAN_THE_INFESTED, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaNpc
{
    init {
