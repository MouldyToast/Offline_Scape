...
public enum ItemMapping
{
    // Barrows equipment
    ITEM_AHRIMS_HOOD(
            AHRIMS_HOOD, AHRIMS_HOOD_25, AHRIMS_HOOD_50, AHRIMS_HOOD_75, AHRIMS_HOOD_100,
            ECHO_AHRIMS_HOOD, ECHO_AHRIMS_HOOD_25, ECHO_AHRIMS_HOOD_50, ECHO_AHRIMS_HOOD_75, ECHO_AHRIMS_HOOD_100
    ),
    ITEM_AHRIMS_ROBETOP(
            AHRIMS_ROBETOP, AHRIMS_ROBETOP_25, AHRIMS_ROBETOP_50, AHRIMS_ROBETOP_75, AHRIMS_ROBETOP_100,
            ECHO_AHRIMS_ROBETOP, ECHO_AHRIMS_ROBETOP_25, ECHO_AHRIMS_ROBETOP_50, ECHO_AHRIMS_ROBETOP_75, ECHO_AHRIMS_ROBETOP_100
    ),
    ITEM_AHRIMS_ROBEBOTTOM(
            AHRIMS_ROBESKIRT, AHRIMS_ROBESKIRT_25, AHRIMS_ROBESKIRT_50, AHRIMS_ROBESKIRT_75, AHRIMS_ROBESKIRT_100,
            ECHO_AHRIMS_ROBESKIRT, ECHO_AHRIMS_ROBESKIRT_25, ECHO_AHRIMS_ROBESKIRT_50, ECHO_AHRIMS_ROBESKIRT_75, ECHO_AHRIMS_ROBESKIRT_100
    ),
    ITEM_AHRIMS_STAFF(
            AHRIMS_STAFF, AHRIMS_STAFF_25, AHRIMS_STAFF_50, AHRIMS_STAFF_75, AHRIMS_STAFF_100,
            ECHO_AHRIMS_STAFF, ECHO_AHRIMS_STAFF_25, ECHO_AHRIMS_STAFF_50, ECHO_AHRIMS_STAFF_75, ECHO_AHRIMS_STAFF_100
    ),
    ...
    ITEM_HOLY_SANGUINESTI_STAFF(HOLY_SANGUINESTI_STAFF_UNCHARGED, HOLY_SANGUINESTI_STAFF),
    ITEM_SCYTHE_OF_VITUR(SCYTHE_OF_VITUR_UNCHARGED, SCYTHE_OF_VITUR),
    ITEM_HOLY_SCYTHE_OF_VITUR(HOLY_SCYTHE_OF_VITUR_UNCHARGED, HOLY_SCYTHE_OF_VITUR),
    ITEM_SANGUINE_SCYTHE_OF_VITUR(SANGUINE_SCYTHE_OF_VITUR_UNCHARGED, SANGUINE_SCYTHE_OF_VITUR),
    ITEM_HOLY_GHRAZI_RAPIER(GHRAZI_RAPIER, HOLY_GHRAZI_RAPIER),
    ...
    ITEM_INFINITY_TOP(INFINITY_TOP, DUMMY_MAGICTRAINING_INFINITYTOP, INFINITY_TOP_20574, DARK_INFINITY_TOP, LIGHT_INFINITY_TOP),
    ...
    ITEM_BLACK_MASK(
            ...
            GREEN_SLAYER_HELMET, GREEN_SLAYER_HELMET_I, TURQUOISE_SLAYER_HELMET, TURQUOISE_SLAYER_HELMET_I, HYDRA_SLAYER_HELMET, HYDRA_SLAYER_HELMET_I, VAMPYRIC_SLAYER_HELMET,
            VAMPYRIC_SLAYER_HELMET_I, TZTOK_SLAYER_HELMET, TZTOK_SLAYER_HELMET_I, TZKAL_SLAYER_HELMET, TZKAL_SLAYER_HELMET_I),

    // Pharaoh's Sceptres
    ITEM_PHARAOHS_SCEPTRE_1(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_9048),
    ITEM_PHARAOHS_SCEPTRE_2(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_9046),
    ITEM_PHARAOHS_SCEPTRE_4(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_13078),
    ITEM_PHARAOHS_SCEPTRE_5(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_13077),
    ITEM_PHARAOHS_SCEPTRE_6(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_13076),
    ITEM_PHARAOHS_SCEPTRE_7(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_13075),
    ITEM_PHARAOHS_SCEPTRE_8(PHARAOHS_SCEPTRE_9050, PHARAOHS_SCEPTRE_13074),
