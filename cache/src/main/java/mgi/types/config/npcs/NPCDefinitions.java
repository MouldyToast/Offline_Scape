...
public final class NPCDefinitions implements Definitions, Cloneable, TransmogrifiableType, RenderType {
    ...
    public static class NPCDefinitionsBuilder {
         ...
         * @return {@code this}.
         */
        public NPCDefinitions.NPCDefinitionsBuilder rotateLeftAnimation(final int field3568) {
         ...
         * @return {@code this}.
         */
        public NPCDefinitions.NPCDefinitionsBuilder rotateRightAnimation(final int field3580) {
