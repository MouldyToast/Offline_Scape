package org.jesse.game.content.treasuretrails.rewards;
...
public enum BroadcastedTreasure {
    ...
    GILDED_DHIDE_VAMBS(ItemId.GILDED_DHIDE_VAMBRACES),
    ...
    private static final IntSet itemIds = IntOpenHashSet.of();

    static {
        Arrays.stream(values()).mapToInt(BroadcastedTreasure::getId).forEach(itemIds::add);
    }

    public static boolean isBroadcasted(final int id) {
