...
import org.jesse.game.content.godwars.instance.*;
...
public enum GodwarsInstancePortal {
    //@formatter:off
    ARMADYL(Colour.LIGHT_GRAY.wrap("Armadyl"), InstanceConstants.INSTANCE_COST, 4674, 26365, ArmadylInstance.class, new ImmutableLocation(1194, 4243, 0),
            new ImmutableLocation(1197, 4233, 0), GodType.ARMADYL),
    BANDOS(Colour.RS_GREEN.wrap("Bandos"), InstanceConstants.INSTANCE_COST, 4675, 26366, BandosInstance.class, new ImmutableLocation(1189, 4312, 0),
            new ImmutableLocation(1196, 4303, 0), GodType.BANDOS),
    ZAMORAK(Colour.RS_RED.wrap("Zamorak"), InstanceConstants.INSTANCE_COST, 4676, 26363, ZamorakInstance.class, new ImmutableLocation(1206, 4397, 0),
            new ImmutableLocation(1198, 4374, 0), GodType.ZAMORAK),
    SARADOMIN(Colour.BLUE.wrap("Saradomin"), InstanceConstants.INSTANCE_COST, 4677, 26364, SaradominInstance.class, new ImmutableLocation(1199, 4426, 0),
            new ImmutableLocation(1182, 4433, 0), GodType.SARADOMIN),
    ANCIENT(Colour.RS_PURPLE.wrap("Nex"),
            InstanceConstants.ZAROS_INSTANCE_COST,
            11345,
            42965,
            "org.jesse.game.content.boss.nex.NexGodwarsInstance",
    ...
    private final int instanceRegionId, altarId;
    ...
    GodwarsInstancePortal(String displayName, int cost, int instanceRegionId, int altarId,
                          String instanceClass, Location portalLocation,
    ...
    GodwarsInstancePortal(String displayName, int cost, int instanceRegionId, int altarId, Class<?
            extends GodwarsInstance> instanceClass, Location portalLocation,
                          Location altarTeleportLocation, GodType god) {
        this.displayName = displayName;
        this.cost = cost;
        this.instanceRegionId = instanceRegionId;
