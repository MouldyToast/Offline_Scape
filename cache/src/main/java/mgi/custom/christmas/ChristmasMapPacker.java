...
import static mgi.tools.parser.TypeParser.packMapPre209;
 ...
 *
 *  This will need it's IDs updated for models if it's ever used again
 *  The models can be found under the retired model directory in the cache assets
 *  -Kry 7/13/2025
 */
public class ChristmasMapPacker {
    ...
    public static int modelId = 65000;
    public static int npcId = 15000;
    public static int itemId = 30100;
    public static int graphicsId = 12500;
    public static int soundEffectId = 17506;
    ...
    private void packAnimationBase(@NotNull final AnimationBase base, final int[] anims) throws IOException {
        for (int anim : anims) {
            ...
            final AnimationDefinitions definitions = new AnimationDefinitions(anim, new ByteBuffer(FileUtils.readFileToByteArray(file)), AnimationDefinitions.AnimFormat.OLDEST);
    ...
    private static void packAmbientSounds() throws IOException {
        TypeParser.packSound(7501, IOUtils.toByteArray(new FileInputStream("assets/christmas/sound effects/ambient sounds/7501 - cupboard, radius 7.dat")));
        TypeParser.packSound(7502, IOUtils.toByteArray(new FileInputStream("assets/christmas/sound effects/ambient sounds/7502 - fountain, radius 10.dat")));
        TypeParser.packSound(7503, IOUtils.toByteArray(new FileInputStream("assets/christmas/sound effects/ambient sounds/7503 - wind whoosh, radius 10.dat")));
        TypeParser.packSound(7504, IOUtils.toByteArray(new FileInputStream("assets/christmas/sound effects/ambient sounds/7504 - burning, radius 1-2.dat")));
        TypeParser.packSound(7505, IOUtils.toByteArray(new FileInputStream("assets/christmas/sound effects/ambient sounds/7505 - clock, radius 2.dat")));
    }

    private void packJingles() throws IOException {
        CacheManager.getCache().getArchive(ArchiveType.JINGLES).addGroup(new Group(1000, new mgi.tools.jagcached.cache.File(new ByteBuffer(IOUtils.toByteArray(new FileInputStream("assets/christmas/jingles/dramatic jingle.dat"))))));
    }

    private static void packMusic() throws IOException {
        CacheManager.getCache().getArchive(ArchiveType.MUSIC).addGroup(new Group(2500, new mgi.tools.jagcached.cache.File(new ByteBuffer(IOUtils.toByteArray(new FileInputStream("assets/christmas/music/Silent Knight soundtrack.dat"))))));
        CacheManager.getCache().getArchive(ArchiveType.MUSIC).addGroup(new Group(2501, new mgi.tools.jagcached.cache.File(new ByteBuffer(IOUtils.toByteArray(new FileInputStream("assets/christmas/music/Smorgasbord soundtrack.dat"))))));
    }

    private void packSoundEffects() throws IOException {
    ...
    private static void bellsSwayAnimation() {
    ...
    private static void frozenNPCBaseAnimation() {
    ...
    private static void lanternSwayAnimation() {
    ...
    private static void stagsAnimation() {
    ...
    private static void fountainAnimation() {
    ...
    private static void grandfathersClockAnimation() {
    ...
    private static void scourgesBedAnimation() {
    ...
    private static void candleTableAnimation() {
    ...
    private static void santaAnimation() {
