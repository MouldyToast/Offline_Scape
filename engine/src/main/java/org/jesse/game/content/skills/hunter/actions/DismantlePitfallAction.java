...
public class DismantlePitfallAction extends BuiltHunterTrapAction {
    /**
     * The animation played by the {@link org.jesse.game.world.entity.player.Player} when dismantling this pitfall trap. If the trap has prey in it, the player is rewarded correspondingly.
     */
