...
private const val EMBLEM_RATE: Int = 375
private const val TOTEM_RATE: Int = 475
private const val STATUE_RATE: Int = 575
private const val MEDALLION_RATE: Int = 675
private const val EFFIGY_RATE: Int = 775
private const val RELIC_RATE: Int = 875
private const val CRYSTAL_RATE: Int = 250
private const val AMULET_RATE: Int = 1050
private const val VIGGORAS_RATE: Int = 2800
private const val CRAWS_RATE: Int = 2800
private const val THAMMARONS_RATE: Int = 2800
private const val PRIMAL_RATE: Int = 2800

@Suppress("unused")
class RevenantHobgoblinProcessor : DropProcessor() {
    ...
    override fun ids(): IntArray {
        return intArrayOf(NpcId.REVENANT_HOBGOBLIN)
    }
