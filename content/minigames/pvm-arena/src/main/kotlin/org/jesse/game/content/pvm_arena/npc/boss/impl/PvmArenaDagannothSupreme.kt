...
/**
 * Represents the Dagannoth supreme npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaDagannothSupreme(override val config: PvmArenaNpc.SpawnConfig) :
    DagannothKing(DAGANNOTH_SUPREME, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
        hitBar = PvmArenaNpcHealthBar(this)
        setBypassSpecificStyleReq(true)
