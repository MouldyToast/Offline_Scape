...
import static com.near_reality.cache_tool.packing.custom.CustomEnumId.REMNANT_ITEM_IDS;
import static com.near_reality.cache_tool.packing.custom.CustomEnumId.REMNANT_ITEM_PRICES;
...
public class RemnantExchangeValuePacker {
    ...
    private void generateEnums() {
        EnumDefinitions ids = new EnumDefinitions(REMNANT_ITEM_IDS,  ScriptVarType.INTEGER,  ScriptVarType.NAMEDOBJ);
        ids.setDefaultInt(-1);
        EnumDefinitions values = new EnumDefinitions(REMNANT_ITEM_PRICES, ScriptVarType.INTEGER,  ScriptVarType.INTEGER);
