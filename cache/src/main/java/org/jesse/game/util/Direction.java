...
public enum Direction {
    ...
    public boolean isDiagonal() {
        return this == SOUTH_WEST || this == NORTH_WEST || this == NORTH_EAST || this == SOUTH_EAST;
    }
    ...
    public static Direction[] diagonalComponents(Direction direction) {
        return switch (direction) {
            ...
            default -> throw new IllegalArgumentException("Must provide a diagonal direction.");
        };
    }

    @NotNull
    public static Direction fromJagAngle(int jagAngle) {
        return Direction.values[jagAngle / 256];
    }
