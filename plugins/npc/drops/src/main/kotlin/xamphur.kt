...
class XamphurDroptable : NPCDropTableScript() {
    ...
    object Commons : StandaloneDropTableBuilder({
        ...
        static {
            ...
            RUBY_BOLTS_E quantity 100 rarity 1
    ...
    object Rares : StandaloneDropTableBuilder({
        ...
        static {
            ...
            AMULET_OF_FURY quantity 1 rarity 100
            CRYSTAL_KEY quantity 1 rarity 100
            PRIMAL_COMPONENTS quantity (1..2) rarity 25
        }
    })
    ...
    object SuperRares : StandaloneDropTableBuilder({
        limit = 64
        static {
            LIME_WHIP quantity 1 rarity 10 announce everywhere
            IMBUED_HEART quantity 1 rarity 10 announce everywhere
            DONATOR_PIN_10 quantity 1 rarity 10 announce everywhere
            DEATH_CAPE quantity 1 rarity 10 announce everywhere
            DRAGON_KITE quantity 1 rarity 10 announce everywhere
            PRIMAL_FULL_HELM quantity 1 rarity 2 announce everywhere
            PRIMAL_PLATEBODY quantity 1 rarity 2 announce everywhere
            PRIMAL_PLATELEGS quantity 1 rarity 2 announce everywhere
            PRIMAL_PLATESKIRT quantity 1 rarity 2 announce everywhere
            PRIMAL_BOOTS quantity 1 rarity 2 announce everywhere
            PRIMAL_GAUNTLETS quantity 1 rarity 2 announce everywhere
            PRIMAL_CHAINBODY quantity 1 rarity 2 announce everywhere
        }
    })
