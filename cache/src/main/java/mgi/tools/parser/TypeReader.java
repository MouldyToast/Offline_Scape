...
public interface TypeReader {
    ...
    default ArrayList<Definitions> read(final ObjectMapper mapper, final JsonNode tree) throws NoSuchFieldException, IllegalAccessException, CloneNotSupportedException {
        return new ArrayList<>();
    }
    ...
    static void setFields(final Definitions definitions, final Map<String, Object> properties) throws IllegalAccessException, NoSuchFieldException {
        ...
        for (final Field field : clazz.getDeclaredFields()) {
            ...
            if (field.getType() == String.class) {
                ...
                //throw new RuntimeException("Unhandled field type: " + field.getType() + " for def " + definitions);
            }
        }
    }
