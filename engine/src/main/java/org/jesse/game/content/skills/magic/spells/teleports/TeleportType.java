...
import org.jesse.game.content.skills.magic.spells.teleports.structures.*;
...
public enum TeleportType {
	...
	HOME_TELEPORT(new RegularStructure()),
	...
	ANCIENT_TELEPORT(new AncientStructure()),
	LUNAR_TELEPORT(new LunarStructure()),
