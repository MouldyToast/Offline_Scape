...
import org.jesse.game.content.treasuretrails.clues.emote.*;
...
public enum EmoteClue implements Clue {
    ...
    EMOTE_65(ClueLevel.MASTER, emotes(Emote.JUMP_FOR_JOY), true,
            ...
            get(new int[][]{
                    ...
                    { 2218, 3041 },
                    { 2218, 3070 }
            }), item(DRAGON_2H_SWORD), any("Bandos boots", item(BANDOS_BOOTS), item(GUARDIAN_BOOTS), item(ECHO_BOOTS)), item(OBSIDIAN_CAPE)),
