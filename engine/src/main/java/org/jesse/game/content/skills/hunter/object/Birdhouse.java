package org.jesse.game.content.skills.hunter.object;
...
public class Birdhouse {
    ...
    public int getLengthInMinutes() {
        ...
        if (memberRank.equalToOrGreaterThan(MemberRank.DRAGONSTONE)) {
            return 20;
        } else if (memberRank.equalToOrGreaterThan(MemberRank.DIAMOND)) {
            return 25;
