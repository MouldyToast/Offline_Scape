...
public class DiaryUtil {
    ...
    public static boolean isKaramjaGlovesEquipped(final Player player) {
        return isEquipped(DiaryReward.KARAMJA_GLOVES1, player) ||
            isEquipped(DiaryReward.KARAMJA_GLOVES2, player) ||
            isEquipped(DiaryReward.KARAMJA_GLOVES3, player) ||
            isEquipped(DiaryReward.KARAMJA_GLOVES4, player);
    }

    public static boolean isKaramjaGlovesTier3PlusEquipped(final Player player) {
        return isEquipped(DiaryReward.KARAMJA_GLOVES3, player) || isEquipped(DiaryReward.KARAMJA_GLOVES4, player);
    }
