...
public enum Seedling {
    ...
    TEAK(21486, 21469, 21473, 21477),
    MAHOGANY(21488, 21471, 21475, 21480),
    CELASTRUS(22869, 22848, 22852, 22856),
    REDWOOD(22871, 22850, 22854, 22859),
    DRAGONFRUIT(22877, 22862, 22864, 22866);
