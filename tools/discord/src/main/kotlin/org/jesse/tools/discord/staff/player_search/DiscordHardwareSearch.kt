package org.jesse.tools.discord.staff.player_search

import org.jesse.tools.HardwareInfoModule
import org.jesse.tools.WealthScanner
import org.jesse.tools.discord.DiscordServer
...
fun main() {
    ...
    DiscordStaffBot.init(
        DiscordServer.Staff,
        token = "OTk4MzUxNjM5ODU1NTA5NTg2.GB7otV.kqeSjIbP_ecjc__G2o7KDeLBboxUuDDmiYb2yE"
    )
    HardwareInfoModule.onServerLaunched(ServerLaunchEvent(null, null))
    while (true) {
        Thread.sleep(1000L)
    }
}
