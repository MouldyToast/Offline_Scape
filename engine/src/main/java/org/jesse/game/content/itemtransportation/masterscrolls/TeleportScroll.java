package org.jesse.game.content.itemtransportation.masterscrolls;
...
import static org.jesse.game.item.ids.ItemId.GUTHIXIAN_TEMPLE_TELEPORT;
import static org.jesse.game.item.ids.ItemId.SPIDER_CAVE_TELEPORT;
...
public enum TeleportScroll implements Teleport {
    ...
    SPIDY_CAVE(new Item(SPIDER_CAVE_TELEPORT), new Location(3658, 3404, 0))
    ;
