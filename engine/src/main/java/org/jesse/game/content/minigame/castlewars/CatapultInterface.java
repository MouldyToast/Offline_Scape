...
public class CatapultInterface extends Interface {
    ...
    private void refreshDigits(@NotNull final Player player) {
        ...
        player.getPacketDispatcher().sendComponentModel(getId(), getComponent("First horizontal digit"), getModel(firstHorizontalDigit));
        player.getPacketDispatcher().sendComponentModel(getId(), getComponent("Second horizontal digit"), getModel(secondHorizontalDigit));
        player.getPacketDispatcher().sendComponentModel(getId(), getComponent("First vertical digit"), getModel(firstVerticalDigit));
        player.getPacketDispatcher().sendComponentModel(getId(), getComponent("Second vertical digit"), getModel(secondVerticalDigit));
    }
    ...
    private void refreshCross(@NotNull final Player player) {
        ...
        player.getPacketDispatcher().sendComponentPosition(getId(), getComponent("Cross"), startX + (horizontalClicks * multiplier), startY + (verticalClicks * multiplier));
    }
