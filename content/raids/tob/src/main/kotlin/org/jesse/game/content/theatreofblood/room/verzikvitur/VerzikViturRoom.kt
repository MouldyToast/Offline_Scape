...
import org.jesse.game.content.theatreofblood.*
...
import org.jesse.game.content.theatreofblood.room.verzikvitur.first.SupportingPillar
import org.jesse.game.item.ids.*
import org.jesse.game.obj.ids.TREASURE_ROOM
...
internal class VerzikViturRoom(raid: TheatreOfBloodRaid, area: AllocatedArea, room: TheatreRoomType) :
    ...
    override val entranceLocation: Location = getLocation(3168, 4302, 0)
    ...
    override fun onComplete() {
        ...
        raid.enterTick = WorldThread.getCurrentCycle() - raid.enterTick
        raid.completed = true
    ...
    override fun onTheatreEnter(player: Player) {
        ...
        WorldTasksManager.schedule {
            if (entered.add(player)) {
                ...
                player.addWalkSteps(Direction.NORTH, 3, -1, false)
