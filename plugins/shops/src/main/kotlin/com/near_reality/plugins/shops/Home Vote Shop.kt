...
class HomeVoteShop : ShopScript() {
    ...
    init {
        "Vote Shop"(1009, VOTE_POINTS, STOCK_ONLY) {
            ...
            UnivShopItem(6570, buyPrice=10, ironmanRestricted = true).invoke()
            UnivShopItem(8850, buyPrice=3, ironmanRestricted = true).invoke()
            UnivShopItem(12954, buyPrice=15, ironmanRestricted = true).invoke()
            ...
            UnivShopItem(13226, buyPrice=8, ironmanRestricted = true).invoke()
            UnivShopItem(13639, buyPrice=8).invoke()
            UnivShopItem(12020, buyPrice=8).invoke()
            UnivShopItem(12791, buyPrice=10).invoke()
            UnivShopItem(11738, buyPrice=1, ironmanRestricted = true).invoke()
