...
public class FightCaves extends DynamicArea implements LogoutRestrictionPlugin, DeathPlugin, CycleProcessPlugin, CannonRestrictionPlugin {
    private static final Logger log = NearRealityLogger.getLogger(FightCaves.class);
    ...
    public void leave() {
        ...
        final boolean boosted = player.getMemberRank().equalToOrGreaterThan(MemberRank.TOPAZ);
