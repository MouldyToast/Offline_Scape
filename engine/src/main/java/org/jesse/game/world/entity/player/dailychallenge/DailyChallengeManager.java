...
public class DailyChallengeManager {
    ...
    private void check(final DailyChallenge challenge) {
        ...
        if (progress.getProgress() == challenge.getLength()) {
            player.sendMessage("<col=ce8500><shad=000000>Daily Challenge complete: " + challenge.getName() + "! Return to the Townboard in Edgeville to claim your reward!");
        } else {
    ...
    public boolean claim(final DailyChallenge challenge) {
        ...
        if (!player.getBooleanTemporaryAttribute("daily_challenge_claimable")) {
            player.sendMessage("I should review the townboard at home to claim this.");
            return false;
        }
    ...
    public void notifyUnclaimedChallenges() {
        ...
        if (unclaimedChallenges > 0) {
            player.sendMessage("<col=ce8500>You seem to have one or more completed challenges. Return to the townboard in Edgeville to claim your rewards!");
        }
    }
