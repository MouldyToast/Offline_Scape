...
import org.jesse.plugins.itemonitem.SlayerHelmItemCreation;
...
public class SlayerHelm extends ItemPlugin {
	...
	public enum SlayerHelmRecolour {
		...
		ARAXXOR(ItemId.ARAXYTE_HEAD, ItemId.ARAXYTE_SLAYER_HELMET, ItemId.ARAXYTE_SLAYER_HELMET_I, "Eye see you");
