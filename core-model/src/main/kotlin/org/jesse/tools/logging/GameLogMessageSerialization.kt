...
import org.jesse.tools.logging.GameLogMessage.Command
import org.jesse.tools.logging.GameLogMessage.Death
import org.jesse.tools.logging.GameLogMessage.Duel
import org.jesse.tools.logging.GameLogMessage.GrandExchangeOffer
import org.jesse.tools.logging.GameLogMessage.GrandExchangeTransaction
import org.jesse.tools.logging.GameLogMessage.GroundItem
import org.jesse.tools.logging.GameLogMessage.Login
import org.jesse.tools.logging.GameLogMessage.Logout
import org.jesse.tools.logging.GameLogMessage.Message
import org.jesse.tools.logging.GameLogMessage.RareDrop
import org.jesse.tools.logging.GameLogMessage.Sanction
import org.jesse.tools.logging.GameLogMessage.Trade
import org.jesse.tools.logging.GameLogMessage.*
import org.jesse.game.content.grandexchange.ExchangeType
import org.jesse.game.content.grandexchange._ExchangeOffer
...
import org.jesse.game.world.entity.player.container._Container
...
object ExchangeOfferSerializer : KSerializer<_ExchangeOffer<_Item, _Container<_Item>>> {
        ...
        decoder.decodeStructure(descriptor) {
            ...
            while (true) {
                when(val index = decodeElementIndex(descriptor)) {
                    ...
                    9 -> dbUsername = decodeStringElement(descriptor, 9)
                    CompositeDecoder.DECODE_DONE -> break
                    else -> error("Unexpected index: $index")
                }
            }
            ...
            _ExchangeOffer<_Item, _Container<_Item>>(username, dbUsername, item, container, slot, price, type).apply {
                this.amount = amount
    ...
    override fun serialize(encoder: Encoder, value: _ExchangeOffer<_Item, _Container<_Item>>) =
        encoder.encodeStructure(descriptor) {
            ...
            encodeStringElement(descriptor, 9, value.dbUsername)
        }
}
