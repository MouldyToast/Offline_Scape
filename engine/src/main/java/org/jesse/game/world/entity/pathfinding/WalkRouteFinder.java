...
public class WalkRouteFinder {
    ...
    private static final int QUEUE_SIZE = (GRAPH_SIZE * GRAPH_SIZE) >> 2;
    ...
    protected static synchronized RouteResult findRoute(final int srcX, final int srcY, final int srcZ,
        ...
        try {
            ...
            for (int x = 0; x < GRAPH_SIZE; x++) {
                int[] dirs = directions[x];
                int[] dists = distances[x];
            ...
            fillTime = System.nanoTime() - fillTime;
