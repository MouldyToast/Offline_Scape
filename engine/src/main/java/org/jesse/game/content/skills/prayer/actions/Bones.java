package org.jesse.game.content.skills.prayer.actions;
...
import org.jesse.game.world.region.area.wilderness.LavaDragonIsle;
...
public enum Bones {
	...
	public static void bury(final Player player, final Bones bone, final Item item, final int slot) {
		...
		final org.jesse.game.content.skills.prayer.ectofuntus.Bonecrusher.CrusherType crusherType = Bonecrusher.CrusherType.get(player);
		if (crusherType != null) {
