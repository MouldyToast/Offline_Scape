...
class Region9524 : NPCSpawnsScript() {

    init {
        GIANT_SPIDER_3017(2369, 3374, 0, SOUTH, 10)
        GIANT_SPIDER_3017(2372, 3379, 0, SOUTH, 10)
        GOBLIN_3045(2373, 3333, 0, SOUTH, 22)
        GIANT_SPIDER_3017(2378, 3366, 0, SOUTH, 10)
        WOLF(2379, 3344, 0, SOUTH, 6)
        GIANT_SPIDER_3017(2379, 3378, 0, SOUTH, 10)
        GOBLIN_3045(2385, 3339, 0, SOUTH, 22)
        GIANT_SPIDER_3017(2387, 3370, 0, SOUTH, 10)
        GRIZZLY_BEAR(2387, 3376, 0, SOUTH, 11)
        GOBLIN_3045(2394, 3334, 0, SOUTH, 22)
        GIANT_SPIDER_3017(2394, 3365, 0, SOUTH, 10)
        WOLF(2395, 3340, 0, SOUTH, 6)
