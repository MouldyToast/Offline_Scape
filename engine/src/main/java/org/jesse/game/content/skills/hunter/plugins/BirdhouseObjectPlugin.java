...
import org.jesse.game.content.skills.hunter.BirdHousePosition;
import org.jesse.game.content.skills.hunter.Hunter;
import org.jesse.game.content.skills.hunter.node.BirdHouseState;
...
import org.jesse.game.content.skills.woodcutting.actions.BirdNests;
...
public class BirdhouseObjectPlugin implements ItemOnObjectAction, ObjectAction {
    ...
    private void build(@NotNull final Player player, @NotNull final Item item, @NotNull final OptionalInt slot, final WorldObject object) {
    ...
    private void dismantleWithWarning(@NotNull final Player player, @NotNull final Birdhouse birdhouse) {
        player.getDialogueManager().start(new Dialogue(player) {
    ...
    private void dismantle(@NotNull final Player player, @NotNull final Birdhouse birdhouse) {
