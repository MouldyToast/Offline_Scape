...
public enum WorldType {
    REGULAR(1, "127.0.0.1", 43594, 2, "Main World", "Canada", 1), REGULAR_2(2, "127.0.0.1", 43593, 1, "Main world - Members", "Canada", 1), DEVELOPMENT(3, "127.0.0.1", 0, 1, "Development world", "Canada", 1);
