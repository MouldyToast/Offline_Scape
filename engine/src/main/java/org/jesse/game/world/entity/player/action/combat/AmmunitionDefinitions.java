...
public enum AmmunitionDefinitions implements AmmunitionDefinition {
    ...
    BROAD_ARROW(new int[]{4160}, false, true, new Graphics(23, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1384, 40, 36, 41, 21, 5, 11, 5), 861, 859, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.CORRUPTED_DARK_BOW, ItemId.CORRUPTED_TWISTED_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),
    ...
    AMETHYST_ARROW(new int[] { 21326, 21328, 21332, 21334, 21336 }, false, true, new Graphics(1385, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1384, 40, 36, 41, 21, 5, 11, 5), 861, 12788, 10284, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.CORRUPTED_DARK_BOW, ItemId.CORRUPTED_TWISTED_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),

    DRAGON_ARROW(new int[] { 11212, 11217, 11227, 11228, 11229 }, false, true, new Graphics(1116, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1120, 40, 36, 41, 21, 5, 11, 5), 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.CORRUPTED_DARK_BOW, ItemId.CORRUPTED_TWISTED_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),
    ...
    LIT_MITHRIL_ARROW(2537, false, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 849, 853, 857, 861, 12788, 10280, 10282, 10284, 847, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),

    LIT_ADAMANT_ARROW(2539, false, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 853, 857, 861, 12788, 10282, 10284, 851, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),

    LIT_RUNE_ARROW(2541, false, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 857, 861, 12788, 10282, 10284, 855, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),

    LIT_AMETHYST_ARROW(21330, false, true, new Graphics(26, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(17, 40, 36, 41, 21, 5, 11, 5), 861, 12788, 10284, 859, 6724, 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),

    LIT_DRAGON_ARROW(11222, false, true, new Graphics(1116, 0, 96), new SoundEffect(2693, 0, 0),
            new Projectile(1121, 40, 36, 41, 21, 5, 11, 5), 12424, 11235, 12765, 12766, 12767, 12768, DARK_BOW_BH, SCORCHING_BOW, ItemId.TWISTED_BOW, ItemId.VENATOR_BOW, ItemId.VENATOR_BOW_UNCHARGED),
