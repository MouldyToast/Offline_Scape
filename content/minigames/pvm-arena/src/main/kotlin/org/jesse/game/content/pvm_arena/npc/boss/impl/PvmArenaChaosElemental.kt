...
import org.jesse.game.world.entity.npc.impl.wilderness.ChaosElemental
import org.jesse.game.world.entity.player.Player
import org.jesse.plugins.SkipPluginScan

/**
 * Represents the Chaos elemental npc in the PvM Arena activity.
 *
 * @author Stan van der Bend
 */
@SkipPluginScan
internal class PvmArenaChaosElemental(override val config: PvmArenaNpc.SpawnConfig) :
    ChaosElemental(CHAOS_ELEMENTAL_6505, config.team.area.randomSpawnLocation(), Direction.SOUTH, 2),
    PvmArenaBoss
{
    init {
        hitBar = PvmArenaNpcHealthBar(this)
        setCanTeleportPlayers(false)
        setCanAttackMultipleTarget(true)
    }
