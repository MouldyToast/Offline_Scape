...
enum class AraxxorNormalDropTable(
    ...
    DRAGON_MACE(org.jesse.game.item.ids.DRAGON_MACE, 2, 2, 19.17),
    ...
    // Resources
    COAL(org.jesse.game.item.ids.COAL+1, 120, 120, 28.75),
    ...
    EARTH_ORB(org.jesse.game.item.ids.EARTH_ORB+1, 45, 45, 19.17),
    VENOM_SACK_1(ARAXYTE_VENOM_SAC, 6, 6, 23.0),
    ...
    VENOM_SACK_2(ARAXYTE_VENOM_SAC, 12, 12, 57.5),
