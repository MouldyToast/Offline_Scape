package org.jesse.game.content.skills.hunter.node;
...
import static org.jesse.game.content.skills.hunter.node.PreyObject.*;
import static org.jesse.game.content.skills.hunter.node.TrapType.*;
import static org.jesse.game.content.skills.hunter.node.TrapType.BIRD_SNARE;
import static org.jesse.game.content.skills.hunter.node.TrapType.BOX_TRAP;
...
public enum TrapPrey implements HunterPrey {
    ...
    SPINED_LARUPIA(145, 68, 2908, 31, 180, PITFALL, null, new ImmutableItem(BIG_BONES), new ImmutableItem(10093), new ImmutableItem(10095)),
